class AppI18n {
  ...
  static const Map<String, String> _extraEn = <String, String>{
    ...
    'toolbox.sound.piano.aggressiveOneHand': 'Aggressive one-hand mode (320-390dp)',
    'toolbox.sound.piano.dualMode': 'Dual keyboard mode',
    'toolbox.sound.piano.gestureSwitching': 'Gesture window switching',
    'toolbox.sound.piano.compactKeyboardModeDesc': 'Shrink key height and show more octaves to reduce frequent range switching.',
    'toolbox.sound.piano.aggressiveOneHandDesc': 'On narrow phones, enlarge black-key hit zones, reduce control density, and prefer a single keyboard.',
    'toolbox.sound.piano.sensitivityTip': 'Lower values are more sensitive, higher values are steadier. Fine-tune on a real device.',
    'toolbox.sound.piano.dualModeDesc': 'Show two adjacent ranges and play on both keyboards with two fingers.',
    'toolbox.sound.piano.gestureSwitchingDesc': 'Swipe up or down with two fingers to switch ranges quickly. Disable if conflict occurs.',
    'toolbox.sound.piano.duetModeDesc': 'In dual mode, two people can play on high and low keyboards simultaneously.',
    'toolbox.sound.piano.verticalKeyboardPhoneDesc': 'Phone layout prioritizes one-hand taps and glissando before exposing the dual keyboard.',
    'toolbox.sound.piano.verticalKeyboardDesc': 'The keyboard now expands down the phone height instead of being crushed horizontally.',
    'toolbox.sound.piano.glissTip': 'Gliss with one finger; shift range with two.',
    'toolbox.sound.piano.glissTipWide': 'Gliss with one finger; use two fingers to shift range.',
    'toolbox.sound.piano.glissandoGuide': 'Single-finger glissando is supported, while two-finger vertical drags jump registers and horizontal drags switch windows.',
    'toolbox.sound.piano.glissandoGuideCompact': 'Use one finger for glissando, two fingers to change range, and tap once to switch high or low rows in phone dual mode.',
    ...
    'toolbox.sound.piano.studioUprightDesc': 'Dryer wood resonance and cleaner attacks, closer to a real upright piano.',
    'toolbox.sound.piano.brightStageDesc': 'Sharper hammer edge for lead lines and brighter attacks.',
    'toolbox.sound.piano.feltRoomDesc': 'Softer felt body for intimate and quiet playing.',
    'toolbox.sound.piano.concertHallDesc': 'Balanced sustain and room feel for all-purpose playing.',
    ...
    'toolbox.sound.piano.octaveSpanDesc': 'The vertical stage currently shows {octaveSpan} octaves and supports quick range switching and wrapped rows.',
    'toolbox.sound.piano.touch': 'Touch {percent}%',
    'toolbox.sound.piano.space': 'Space {percent}%',
    'toolbox.sound.piano.decay': 'Decay {value}x',
    'toolbox.sound.piano.gestureSensitivity': 'Two-finger range sensitivity {percent}%',
  };
  ...
  static const Map<String, String> _extraZh = <String, String>{
    ...
    'toolbox.sound.piano.verticalKeyboardPhoneDesc': '手机布局优先保证单手点击和滑奏，再按需切换双键盘。',
    ...
    'toolbox.sound.piano.glissandoGuideCompact': '单指可连续滑奏；双指上下或左右滑动可切换音域窗口；窄屏优先单键盘。',
    ...
    'toolbox.sound.piano.octaveSpanDesc': '当前纵向舞台一次显示 {octaveSpan} 个八度，支持快速切换音域与分行展示窗口。',
  ...
  static const Map<String, String> _toolboxEn = <String, String>{
    ...
    'toolbox.sound.locator.page_subtitle': 'Use the phone microphone, move through several positions, and confirm the source area step by step.',
    ...
    'toolbox.sound.locator.guidance_idle': 'Start listening, keep the target sound active, then record this position.',
    'toolbox.sound.locator.guidance_mono': 'Mono is still usable: record this spot, then move left, right, or forward and sample again.',
    'toolbox.sound.locator.guidance_reverb': 'Reverb risk is high. Move closer to the source, avoid corners, or lower background noise.',
    'toolbox.sound.locator.guidance_low_snr': 'SNR is low. In multi-source scenes, keep the target source continuous before locking.',
    'toolbox.sound.locator.guidance_normal': 'Direction is updating. Record multiple positions so strength, SNR, and bearing stability can confirm the area.',
    ...
    'toolbox.sound.locator.confirm_locked': 'Source area confirmed from multiple positions. For complex environments, taking one more opposite-side sample is still recommended.',
    'toolbox.sound.locator.confirm_tracking': 'Source area is converging. Keep the target sound active and add one more position.',
    'toolbox.sound.locator.confirm_tentative': 'Early clues found, but at least 3 positions are needed before a stable confirmation.',
    'toolbox.sound.locator.confirm_unconfirmed': 'Record your current position first, then move in different directions to continue sampling.',
    'toolbox.sound.locator.cue_step_0': 'Step 1: stay here, point the phone toward the suspected area, and record once.',
    'toolbox.sound.locator.cue_stay': 'Next: keep the target active and record this spot once more.',
    'toolbox.sound.locator.cue_left': 'Next: step left, keep the phone facing the same way, then record.',
    'toolbox.sound.locator.cue_right': 'Next: step right, keep the phone facing the same way, then record.',
    'toolbox.sound.locator.cue_forward': 'Next: move one step toward the target area, then record.',
    'toolbox.sound.locator.cue_back': 'Next: step back for a comparison sample, then record.',
    ...
    'toolbox.sound.locator.try_stereo_subtitle': 'If the platform returns mono or fails to start, turn this off for stable activity checks.',
    'toolbox.sound.locator.mic_sufficient': 'The built-in phone mic is enough for movement confirmation: one static point is weak, but several positions can converge on the source area.',
    'toolbox.sound.locator.source_candidates': 'Source candidates',
    'toolbox.sound.locator.no_stable_source': 'No stable source yet. Keep the target source active for 1-2 seconds.',
    ...
    'toolbox.sound.locator.odas_description': 'External synchronized mics are not required. ODAS stays optional: if a dedicated array exists, its output can be merged into this confirmation model.',
    'toolbox.sound.locator.odas_default_path': 'The default path is phone movement sampling; advanced mode can read ODAS tracked-source JSON as extra evidence.',
    'toolbox.sound.locator.requirement_1': 'Phone mic permission and stable PCM capture',
    'toolbox.sound.locator.requirement_2': 'At least 3 movement samples from different positions',
    'toolbox.sound.locator.requirement_3': 'Target sound remains active while sampling',
    'toolbox.sound.locator.requirement_4': 'Optional ODAS or array output as advanced evidence',
    'toolbox.sound.locator.error_mic_denied': 'Microphone permission was denied.',
    'toolbox.sound.locator.error_no_frame': 'No usable audio frame yet. Start listening and keep the target sound active.',

    'toolbox.sound.soothing.page_title': 'Soothing music',
    'toolbox.sound.soothing.page_subtitle': 'Curated calming loops with breathing light effects, local tracks, and a mobile-first immersive layout.',
    'toolbox.sound.soothing.browse_modes_title': 'Browse modes',
    'toolbox.sound.soothing.browse_modes_subtitle': 'Selecting a mode closes the menu and keeps the current mode clearly highlighted.',
    ...
    'toolbox.sound.soothing.empty_mode_title_favorites': 'No favorite modes yet',
    'toolbox.sound.soothing.empty_mode_title_recent': 'No recent modes yet',
    'toolbox.sound.soothing.empty_mode_subtitle_favorites': 'Mark modes you use often and they will appear here for quick switching.',
    'toolbox.sound.soothing.empty_mode_subtitle_recent': 'Once you switch or play a few modes, your recent history will appear here.',
    ...
    'toolbox.sound.soothing.arrangement_not_configured': 'Arrangement (not configured)',
    'toolbox.sound.soothing.arrangement_template': 'Arrangement \u00b7 {name}',
    'toolbox.sound.soothing.arrangement_steps': 'Arrangement \u00b7 {steps} steps',
    'toolbox.sound.soothing.arrangement_progress': 'Step {current}/{total} \u00b7 {mode} \u00b7 {track} \u00b7 {repeat}/{max}',
    ...
    'toolbox.sound.soothing.save_arrangement_subtitle': 'Save the current arrangement for quick reuse.',
    'toolbox.sound.soothing.save_arrangement_hint': 'For example: Wind-down 20m',
    ...
    'toolbox.sound.soothing.playback_order_desc': 'Single loop is the default. Switch to arrangement mode to auto-advance across themes and tracks.',
    'toolbox.sound.soothing.arrangement_not_saved': 'Current arrangement not saved',
    'toolbox.sound.soothing.arrangement_steps_info': '{steps} steps \u00b7 {templates} saved',
    ...
    'toolbox.sound.bowls.page_subtitle': 'Eleven nature-tuned frequencies and four bowl voices, shaped for a softer, longer listening session.',
    'toolbox.sound.bowls.voices_section_title': 'Voices',
    'toolbox.sound.bowls.voices_section_subtitle': 'Four harmonic profiles to rotate through',
    ...
    'toolbox.sound.bowls.today_suggestion_body': 'At night, try Deep with Om / Earth or 174 Hz. For lighter daytime reset sessions, Crystal with Harmony, 528 Hz, or 639 Hz feels gentler.',
    ...
    'toolbox.sound.bowls.haptics_subtitle': 'Add a light pulse on manual strike',
    ...
    'toolbox.sound.bowls.sheet_subtitle': 'Pick a frequency, choose a voice, and tap at your own slow rhythm.',
    ...
    'toolbox.sound.bowls.sheet_haptics_subtitle': 'Add a light pulse on manual strike',
    ...
    'toolbox.sound.bowls.tap_hint': 'Tap the bowl and let it bloom, spread, and settle.',
    ...
    'toolbox.sound.flute.brighter_lead_tone_with_stronger': 'Brighter lead tone with stronger presence for melodic phrases.',
    ...
    'toolbox.sound.flute.gentler_attacks_and_a_more': 'Gentler attacks and a more bamboo-like body for calm pentatonic phrases.',
    ...
    'toolbox.sound.flute.microphone_permission_unavailable': 'Microphone permission unavailable',
    'toolbox.sound.flute.microphone_permission_unavailable_touch_play': 'Microphone permission unavailable. Touch play is still available.',
    'toolbox.sound.flute.mixolydian': 'Mixolydian',
    'toolbox.sound.flute.natural_breathy_tone_for_gentle': 'Natural breathy tone for gentle and flowing play.',
    ...
    'toolbox.sound.flute.rebuild_the_flute_body_finger': 'Rebuild the flute body, finger holes, and note rail for portrait phones.',
    ...
    'toolbox.sound.flute.threshold_current': 'Threshold {pct}% \u00b7 Current {current}%',
    'toolbox.sound.flute.threshold_current_holes': 'Threshold {pct}% \u00b7 Current {current}% \u00b7 Holes {holes}',
    ...
    'toolbox.sound.flute.warmer_midrange_and_softer_tail': 'Warmer midrange and softer tail for calm backing layers.',
    ...
    'toolbox.sound.guitar.clear_steelcore_tone_tuned_for': 'Clear steel-core tone tuned for rhythmic strumming.',
    'toolbox.sound.guitar.guitar_settings': 'Guitar settings',
    'toolbox.sound.guitar.guitar_stage': 'Guitar stage',
    'toolbox.sound.guitar.longer_shimmer_and_overtones_for': 'Longer shimmer and overtones for ambient layers.',
    ...
    'toolbox.sound.guitar.pick_a_chord_pluck_or': 'Pick a chord, pluck or sweep the strings, and move the capo to lift the voicing.',
    'toolbox.sound.guitar.pick_position': 'Pick position {value}%',
    'toolbox.sound.guitar.resonance': 'Resonance {value}%',
    'toolbox.sound.guitar.resonance_shapes_body_response_and': 'Resonance shapes body response and pick position shifts brightness.',
    'toolbox.sound.guitar.rounder_and_softer_for_slow': 'Rounder and softer for slow arpeggios and finger picking.',
    'toolbox.sound.guitar.shortens_sustain_and_tightens_upper': 'Shortens sustain and tightens upper harmonics for rhythmic strokes.',
    ...
    'toolbox.sound.guitar.swipe_vertically_to_strum_tap': 'Swipe vertically to strum; tap a string to pluck single notes.',
    ...
    'toolbox.sound.guitar.phone_layout_sub': 'The phone layout keeps the strum surface primary and moves harmony controls into compact rows.',
    'toolbox.sound.guitar.desktop_layout_sub': 'The strum surface stays primary while chords, capo, and tone controls sit around it.',
    ...
    'toolbox.sound.harp.balanced_sustain_for_melodic_passages': 'Balanced sustain for melodic passages.',
    ...
    'toolbox.sound.harp.clear_attack_for_active_strum': 'Clear attack for active strum.',
    ...
    'toolbox.sound.harp.damping_sweep_deadzone_and_chord': 'Damping, sweep deadzone, and chord root.',
    ...
    'toolbox.sound.harp.more_body_and_slower_tail': 'More body and slower tail.',
    ...
    'toolbox.sound.harp.pedalharp_like_balance_and_sustain': 'Pedal-harp like balance and sustain.',
    ...
    'toolbox.sound.harp.round_body_with_controlled_hall': 'Round body with controlled hall tail.',
    'toolbox.sound.harp.round_body_with_light_transient': 'Round body with light transient.',
    ...
    'toolbox.sound.harp.soft_fingerpluck_with_gentle_bloom': 'Soft finger-pluck with gentle bloom.',
    'toolbox.sound.harp.sound_on': 'Sound on',
    'toolbox.sound.harp.steel': 'Steel',
    'toolbox.sound.harp.steel_studio': 'Steel Studio',
    'toolbox.sound.harp.stronger_core_and_brighter_attack': 'Stronger core and brighter attack.',
    'toolbox.sound.harp.sus2': 'Sus2',
    'toolbox.sound.harp.sus4': 'Sus4',
    'toolbox.sound.harp.sweep_deadzone_px': 'Sweep deadzone {value} px',
    'toolbox.sound.harp.tap_a_note_then_glide': 'Tap a note, then glide across strings to sweep.',
    'toolbox.sound.harp.tap_for_single_note_swipe': 'Tap for single note, swipe for sweep.',
    'toolbox.sound.harp.theme_timbre': 'Theme & Timbre',
    'toolbox.sound.harp.thin_body_and_sparkling_top': 'Thin body and sparkling top.',
    'toolbox.sound.harp.tight_transient_and_clear_note': 'Tight transient and clear note separation.',
    'toolbox.sound.harp.timbre': 'Timbre',
    'toolbox.sound.harp.timbre_scale_chord_and_feel': 'Timbre, scale, chord, and feel live in the sheet.',
    ...
    'toolbox.sound.triangle.balanced_brightness_and_decay_close': 'Balanced brightness and decay close to orchestral behavior.',
    'toolbox.sound.triangle.brass': 'Brass',
    'toolbox.sound.triangle.bright_ring': 'Bright ring',
    'toolbox.sound.triangle.brighter_attack_and_stronger_ring': 'Brighter attack and stronger ring to mark accents.',
    'toolbox.sound.triangle.damping': 'Damping {value}%',
    'toolbox.sound.triangle.left_is_softer_right_is': 'Left is softer, right is brighter; roll mode creates tight repeated accents.',
    'toolbox.sound.triangle.left_softer': 'Left softer',
    'toolbox.sound.triangle.material_shapes_overtones_while_strike': 'Material shapes overtones while strike point and damping control attack and tail.',
    'toolbox.sound.triangle.orchestral_ring': 'Orchestral ring',
    'toolbox.sound.triangle.presets_move_tone_material_and': 'Presets move tone, material, and default ring length together.',
    ...
    'toolbox.sound.triangle.softer_highs_and_a_shorter': 'Softer highs and a shorter tail for gentle rhythm support.',
    ...
    'toolbox.sound.triangle.tap_directly_on_the_triangle': 'Tap directly on the triangle: left is softer, right is brighter, and the mode changes the gesture output.',
    ...
    'toolbox.sound.violin.balanced_solo_tone_for_melodic': 'Balanced solo tone for melodic glides.',
    'toolbox.sound.violin.bow_and_space': 'Bow and space',
    'toolbox.sound.violin.bow_tone': 'Bow {pct}% \u00b7 Tone {tone} \u00b7 {variant}',
    'toolbox.sound.violin.brighter_harmonics_with_a_cleaner': 'Brighter harmonics with a cleaner edge for airy textures.',
    'toolbox.sound.violin.chromatic': 'Chromatic',
    'toolbox.sound.violin.expose_bow_pressure_and_reverb': 'Expose bow pressure and reverb separately for better solo and room control.',
    ...
    'toolbox.sound.violin.softer_bow_pressure_with_a': 'Softer bow pressure with a longer tail for lyrical lines.',
    'toolbox.sound.violin.solo': 'Solo',
    'toolbox.sound.violin.solo_bow': 'Solo bow',
    'toolbox.sound.violin.strings': 'Strings',
    'toolbox.sound.violin.two_fingers_enable_doublestop': 'Two fingers enable double-stop',
    'toolbox.sound.violin.use_scale_categories_and_position': 'Use scale categories and position windows to keep the fingerboard playable on phones.',
    'toolbox.sound.violin.variant_a_is_woodier_and': 'Variant A is woodier and fuller for natural solo phrases.',
    'toolbox.sound.violin.variant_b_is_brighter_and': 'Variant B is brighter and more forward for cutting solo lines.',
    ...
    'toolbox.sound.violin.phone_subtitle': 'Tap to start the bow, slide for pitch, and release to stop on phones.',
    'toolbox.sound.violin.desktop_subtitle': 'Slide horizontally for pitch, vertically for strings, and now start instantly on tap.',

    // B4: focus beats (sound)
    'toolbox.sound.focus.controlTempo': 'Tempo',
    'toolbox.sound.focus.controlTempoDesc': 'Adjust BPM with quick step buttons.',
    'toolbox.sound.focus.controlMeter': 'Time signature',
    'toolbox.sound.focus.controlMeterDesc': 'Sets strong/weak beat structure and subdivision density.',
    'toolbox.sound.focus.controlTimbre': 'Beat timbre',
    'toolbox.sound.focus.controlTimbreDesc': 'Choose the sound character for each beat click.',
    'toolbox.sound.focus.controlArrangement': 'Beat pattern',
    'toolbox.sound.focus.controlArrangementDesc': 'Group bars into phrases for rhythmic variety.',
    'toolbox.sound.focus.singleBarLoop': 'Single bar',
    'toolbox.sound.focus.controlMix': 'Mix & haptics',
    'toolbox.sound.focus.controlMixDesc': 'Adjust accent, regular, subdivision, and vibration levels.',
    'toolbox.sound.focus.controlMixDesc2': 'Fine-tune accent, regular, subdivision beats and vibration.',
    ...
    'toolbox.sound.focus.controlTapHint': 'Tap to start or stop — stay in flow.',
    ...
    'toolbox.sound.focus.immersiveControlsDesc': 'Tap the bottom edge to bring up controls while staying fullscreen.',
    ...
    'toolbox.sound.focus.meterDesc': 'Time signature sets strong/weak beats; subdivision splits each beat internally.',
    'toolbox.sound.focus.meterSubDiv': 'Sub ×{div}',
    'toolbox.sound.focus.styleDesc': 'Animation and timbre are paired by default. Switch freely to mix and match.',
    ...
    'toolbox.sound.focus.arrangementDesc': 'Group bars into phrases to create stronger section feel across a cycle.',
    ...
    'toolbox.sound.focus.mixHapticDesc': 'Subtle vibration on accents and section changes.',

    // --- toolbox hub (B2: main hub page, sections, entries, quick panel) ---
    'toolbox.hub.page.title': 'Toolbox',
    'toolbox.hub.page.subtitle': 'Browse, configure, and personalize your wellness toolkit.',
    'toolbox.hub.page.section_title': 'Available tools',
    'toolbox.hub.intro.title_idle': 'Your wellness toolkit',
    'toolbox.hub.intro.summary_idle': 'Quick access to sleep, focus, sound, and calm tools.',
    'toolbox.hub.intro.details_idle': 'Tap any tool to open it. Drag entries onto the Quick panel for one-tap access.',
    'toolbox.hub.intro.title_editing': 'Customize your toolbox',
    'toolbox.hub.intro.summary_editing': 'Hide tools you rarely use, reorder your favorites, and pin shortcuts.',
    'toolbox.hub.intro.details_editing': 'Tap the eye icon to hide or restore. Drag the handle to reorder. Pinned entries appear at the top.',
    'toolbox.hub.intro.highlight_edit': 'Hide or show tools to match your daily routine.',
    'toolbox.hub.intro.highlight_reorder': 'Drag-and-drop reordering for quick access.',
    'toolbox.hub.intro.highlight_shortcuts': 'Pin your most-used tools to the Quick entry panel.',
    'toolbox.hub.intro.highlight_restorable': 'Hidden tools are hidden, not deleted — one tap restores them.',
    ...
    'toolbox.hub.edit.confirm_remove_desc': 'This tool will be hidden from the toolbox. You can restore it anytime from the edit panel.',
    ...
    'toolbox.hub.edit.layout_instructions': 'Tap the eye icon to hide or show a tool. Drag the handle to reorder.',
    ...
    'toolbox.hub.edit.empty_desc_no_hidden': 'All available tools are currently visible. To hide a tool, tap the eye icon next to its name.',
    'toolbox.hub.edit.empty_desc_has_hidden': 'Some tools are currently hidden. Use the hidden section below to restore them.',
    ...
    'toolbox.hub.edit.restore_notice': 'Tap the eye icon to restore a hidden tool.',
    'toolbox.hub.edit.restore_action': 'Restore',

    'toolbox.hub.section.sleep.title': 'Sleep',
    'toolbox.hub.section.sleep.subtitle': 'Assessment, logging, wind-down, and night rescue guides.',
    'toolbox.hub.section.games.title': 'Mini Games',
    'toolbox.hub.section.games.subtitle': 'Light cognitive activities to shift focus and unwind.',
    'toolbox.hub.section.tests.title': 'Human Tests',
    'toolbox.hub.section.tests.subtitle': 'Self-assessment tools for cognitive and behavioral patterns.',
    'toolbox.hub.section.sound.title': 'Sound & Music',
    'toolbox.hub.section.sound.subtitle': 'Soothing audio, singing bowls, harp, guitar, flute, and more.',
    'toolbox.hub.section.focus.title': 'Focus & Attention',
    'toolbox.hub.section.focus.subtitle': 'Schulte grid, breathing exercises, and attention training.',
    'toolbox.hub.section.calm.title': 'Calm & Meditation',
    'toolbox.hub.section.calm.subtitle': 'Mindful beads, finger sand art, and meditation tools.',
    'toolbox.hub.section.life.title': 'Life Tools',
    'toolbox.hub.section.life.subtitle': 'Practical daily utilities and lifestyle helpers.',
    'toolbox.hub.section.crypto.title': 'Crypto & Security',
    'toolbox.hub.section.crypto.subtitle': 'Encryption, hashing, and security utilities.',
    'toolbox.hub.section.decision.title': 'Decision Helper',
    'toolbox.hub.section.decision.subtitle': 'Turn daily dilemmas into light, replayable choices.',

    'toolbox.hub.entry.sleep_assistant.title': 'Sleep Assistant',
    'toolbox.hub.entry.sleep_assistant.subtitle': 'Personalized assessment, plans, and nightly guidance.',
    'toolbox.hub.entry.games.title': 'Mini Games',
    'toolbox.hub.entry.games.subtitle': 'Quick cognitive mini-games for focus shifting.',
    'toolbox.hub.entry.tests.title': 'Human Tests',
    'toolbox.hub.entry.tests.subtitle': 'Cognitive and behavioral self-assessments.',
    'toolbox.hub.entry.soothing.title': 'Soothing Music',
    'toolbox.hub.entry.soothing.subtitle': 'Curated calming loops with breathing light effects.',
    'toolbox.hub.entry.harp.title': 'Harp & Strings',
    'toolbox.hub.entry.harp.subtitle': 'Play harp, guitar, violin, flute, and triangle sounds.',
    'toolbox.hub.entry.bowls.title': 'Singing Bowls',
    'toolbox.hub.entry.bowls.subtitle': 'Eleven nature-tuned frequencies and four bowl voices.',
    'toolbox.hub.entry.locator.title': 'Sound Locator',
    'toolbox.hub.entry.locator.subtitle': 'Use the phone mic to find and confirm sound sources.',
    'toolbox.hub.entry.beats.title': 'Focus Beats',
    'toolbox.hub.entry.beats.subtitle': 'Rhythmic audio cues for timed focus sessions.',
    'toolbox.hub.entry.woodfish.title': 'Cyber Woodfish',
    'toolbox.hub.entry.woodfish.subtitle': 'A digital wooden fish for mindful tapping and stress relief.',
    'toolbox.hub.entry.schulte.title': 'Schulte Grid',
    'toolbox.hub.entry.schulte.subtitle': 'Classic attention training with speed and accuracy tracking.',
    'toolbox.hub.entry.breathing.title': 'Breathing Guide',
    'toolbox.hub.entry.breathing.subtitle': 'Guided breathing exercises with visual pacing.',
    'toolbox.hub.entry.beads.title': 'Mindful Beads',
    'toolbox.hub.entry.beads.subtitle': 'Gently slide each bead and settle your mind in a calming rhythm.',
    'toolbox.hub.entry.zen.title': 'Finger Sand Art',
    'toolbox.hub.entry.zen.subtitle': 'Draw with your fingertip on sand — a pocket-sized moment of calm.',
    'toolbox.hub.entry.life.title': 'Life Tools',
    'toolbox.hub.entry.life.subtitle': 'Practical utilities for daily routines.',
    'toolbox.hub.entry.crypto.title': 'Crypto Security',
    'toolbox.hub.entry.crypto.subtitle': 'Encryption, hashing, and data security tools.',
    'toolbox.hub.entry.decision.title': 'Daily Decision',
    'toolbox.hub.entry.decision.subtitle': 'Turn everyday indecision into randomized, editable, reviewable choices.',

    'toolbox.hub.quick.title': 'Quick Access',
    'toolbox.hub.quick.release_hint': 'Drop here to pin',
    'toolbox.hub.quick.manage': 'Manage',
    'toolbox.hub.quick.empty_hint': 'Drag tools here for one-tap access. Tap "Manage" to pick your shortcuts.',
    'toolbox.hub.quick.choose_title': 'Choose quick entries',
    'toolbox.hub.quick.choose_desc': 'Select the tools you want to appear in the Quick panel.',
    ...
    'toolbox.sleep.core.disabledHint': 'Enable the sleep module in settings to access this feature.',
    ...
    'toolbox.sleep.assist.locatorPlanHint': 'Track your current action plan and progress.',
    'toolbox.sleep.assist.locatorLoop': 'Sleep loop',
    'toolbox.sleep.assist.locatorLoopHint': 'Quick actions for tonight and tomorrow morning.',
    'toolbox.sleep.assist.locatorMore': 'More actions',
    'toolbox.sleep.assist.locatorMoreHint': 'Tools, advice, and deeper adjustments.',
    'toolbox.sleep.assist.locatorAdvice': 'Direct advice',
    'toolbox.sleep.assist.locatorAdviceHint': 'Personalized suggestions based on your data.',
    'toolbox.sleep.assist.locatorTrend': '7-day trend',
    'toolbox.sleep.assist.locatorTrendHint': 'See your sleep patterns over the past week.',
    'toolbox.sleep.assist.locatorScience': 'Science cards',
    'toolbox.sleep.assist.locatorScienceHint': 'Evidence-based sleep knowledge and tips.',
    'toolbox.sleep.assist.subtitle': 'Your personal sleep guide — assessment, tracking, and nightly support.',
    ...
    'toolbox.sleep.assist.morningSavedWorse': 'Morning check-in saved — take it easy today.',
    'toolbox.sleep.assist.morningSavedBetter': 'Morning check-in saved — great start!',
    'toolbox.sleep.assist.recentRescue': 'Recent night rescue',
    'toolbox.sleep.assist.leftBedRecorded': 'Left-bed event recorded.',
    'toolbox.sleep.assist.tinyRoutineUsed': 'Tiny wind-down routine used recently.',
    'toolbox.sleep.assist.lateScreenClue': 'Late screen exposure detected in recent logs.',
    ...
    'toolbox.sleep.assist.darkModeHint': 'Dim the screen and reduce blue light for evening use.',
    'toolbox.sleep.assist.currentPlan': 'Current plan',
    'toolbox.sleep.assist.currentPlanHint': 'Your active sleep improvement track.',
    'toolbox.sleep.assist.sleepLoop': 'Sleep loop',
    'toolbox.sleep.assist.sleepLoopSub': 'Tonight and tomorrow morning in one flow.',
    'toolbox.sleep.assist.moreActions': 'More actions',
    'toolbox.sleep.assist.moreActionsHint': 'Tools, reports, and deeper settings.',
    ...
    'toolbox.sleep.assist.directAdviceSub': 'Personalized suggestions from your sleep data.',
    'toolbox.sleep.assist.trend7': '7-day trend',
    'toolbox.sleep.assist.trend7Sub': 'How your sleep has changed over the past week.',
    'toolbox.sleep.assist.setDirection': 'Set direction',
    'toolbox.sleep.assist.setDirectionHint': 'Choose a sleep goal and get a personalized plan.',
    'toolbox.sleep.assist.windDown': 'Wind-down routine',
    'toolbox.sleep.assist.windDownHint': 'A step-by-step evening routine to prepare for sleep.',
    'toolbox.sleep.assist.nightRescue': 'Night rescue',
    'toolbox.sleep.assist.nightRescueHint': 'What to do when you wake up in the middle of the night.',
    'toolbox.sleep.assist.dayAnchor': 'Day anchor',
    'toolbox.sleep.assist.dayAnchorHint': 'Morning light and activity to stabilize your rhythm.',
    'toolbox.sleep.assist.tinyLog': 'Tiny log',
    'toolbox.sleep.assist.tinyLogHint': 'A 30-second nightly sleep log with minimal effort.',
    'toolbox.sleep.assist.weeklyReview': 'Weekly review',
    'toolbox.sleep.assist.weeklyReviewHint': 'Look back at your sleep patterns and adjust.',
    'toolbox.sleep.assist.scienceCard': 'Science',
    'toolbox.sleep.assist.scienceCardSub': 'Evidence-based knowledge about sleep.',
    'toolbox.sleep.assist.assessmentCard': 'Assessment',
    'toolbox.sleep.assist.assessmentCardSub': 'Evaluate your sleep concerns and risk factors.',
    'toolbox.sleep.assist.logCard': 'Daily log',
    'toolbox.sleep.assist.logCardSub': 'Track each night with a structured sleep diary.',
    'toolbox.sleep.assist.routineCard': 'Wind-down',
    'toolbox.sleep.assist.routineCardSub': 'Build and run your evening wind-down routine.',
    'toolbox.sleep.assist.rescueCard': 'Night rescue',
    'toolbox.sleep.assist.rescueCardSub': 'Guided support when you wake up at night.',
    'toolbox.sleep.assist.rhythmCard': 'Day rhythm',
    'toolbox.sleep.assist.rhythmCardSub': 'A 7-day program to stabilize your circadian rhythm.',
    'toolbox.sleep.assist.reportCard': 'Report',
    'toolbox.sleep.assist.reportCardSub': 'Visualize trends and patterns over time.',
    'toolbox.sleep.assist.collect3': 'Collect 3 nights of data to unlock personalized patterns.',
    ...
    'toolbox.sleep.assist.assessmentIntro': 'A short 2-minute questionnaire to understand your sleep situation and get personalized guidance.',
    ...
    'toolbox.sleep.assist.continueRoutineHint': 'Your evening routine is already set up. Pick up where you left off.',
    ...
    'toolbox.sleep.assist.nightModeDesc': 'Keep stimulation low. Avoid screens, clocks, and bright lights.',
    ...
    'toolbox.sleep.assist.startTinyRoutineHint': 'A minimal 3-step routine you can do even when exhausted.',
    ...
    'toolbox.sleep.assist.dayAnchorScenarioHint': 'Expose yourself to natural or bright light within 30 minutes of waking to anchor your circadian rhythm.',
    ...
    'toolbox.sleep.assist.minimalLogDesc': 'A quick 30-second log entry to capture the essentials of last night.',
    ...
    'toolbox.sleep.assist.controlOneVarDesc': 'Calculate your personal caffeine cutoff time based on your typical bedtime.',
    ...
    'toolbox.sleep.assist.nextCycleDesc': 'Based on 90-minute sleep cycles, see the best times to go to bed or wake up.',
    ...
    'toolbox.sleep.assist.noLogsHint': 'Start logging your sleep to see trends and get personalized advice.',
    ...
    'toolbox.sleep.assist.jumpDesc': 'Jump directly to what you need right now.',
    'toolbox.sleep.assist.noInputStarts': 'No-input start',
    'toolbox.sleep.assist.noInputStartsHint': 'Just tap and go — no setup needed.',
    ...
    'toolbox.sleep.assist.noPlanHint': 'Complete the sleep assessment to get a personalized plan.',
    ...
    'toolbox.sleep.assessment.moduleDisabled': 'Sleep module is disabled. Enable it in settings to access this feature.',
    'toolbox.sleep.assessment.title': 'Sleep assessment',
    'toolbox.sleep.assessment.intro': 'A short questionnaire to understand your sleep patterns and get personalized guidance.',
    ...
    'toolbox.sleep.assessment.goalHint': 'e.g., Fall asleep faster, wake up less, feel more rested',
    ...
    'toolbox.sleep.assessment.digestiveDiscomfort': 'Digestive discomfort at night',
    ...
    'toolbox.sleep.log.intro': 'A structured sleep diary to track each night in detail.',
    ...
    'toolbox.sleep.log.log30secHint': 'Quick entry with presets for common patterns.',
    ...
    'toolbox.sleep.log.intenseExerciseHint': 'Intense exercise within 3 hours of sleep',
    'toolbox.sleep.log.hotBathHint': 'Hot bath or shower within 2 hours of sleep',
    ...
    'toolbox.sleep.rhythm.intro': 'A 7-day program to stabilize your circadian rhythm through morning light, caffeine timing, and evening habits.',
    ...
    'toolbox.sleep.rhythm.needOneLog': 'You need at least one sleep log entry to start the rhythm program.',
    ...
    'toolbox.sleep.rescue.intro': 'What to do when you wake up in the middle of the night. Choose your state and get step-by-step guidance.',
    'toolbox.sleep.rescue.chooseState': 'Choose your state',
    'toolbox.sleep.rescue.currentGuidance': 'Current guidance',
    'toolbox.sleep.rescue.chooseFirst': 'Choose your current state first to get tailored guidance.',
    ...
    'toolbox.sleep.low.tonightGoalHint': 'e.g., In bed by 11, no screens after 10',
    ...
    'toolbox.sleep.low.bedtimeSceneHint': 'Dim lights, quiet space, phone on dark mode.',
    ...
    'toolbox.sleep.low.imTiredHint': 'Let\'s get you to bed with minimal effort.',
    ...
    'toolbox.sleep.routine.intro': 'Build your personalized evening wind-down routine.',
    ...
    'toolbox.sleep.winddown.intro': 'A guided evening routine to prepare your body and mind for sleep.',
    'toolbox.sleep.winddown.templates': 'Templates',
    'toolbox.sleep.winddown.templatesHint': 'Choose a pre-built routine or create your own.',
    ...
    'toolbox.sleep.support.mode_body.brief': 'You woke briefly and want to fall back asleep quickly.',
    'toolbox.sleep.support.mode_body.fully_awake': 'You are wide awake and unable to fall back asleep.',
    'toolbox.sleep.support.mode_body.racing_thoughts': 'Your mind is busy and keeps spinning.',
    'toolbox.sleep.support.mode_body.body_activated': 'Your body feels tense, restless, or activated.',
    'toolbox.sleep.support.mode_body.temperature': 'You feel too hot or too cold.',
    ...
    'toolbox.sleep.support.program_body.rhythm_7': 'A 7-day program to stabilize your sleep-wake rhythm through light exposure and schedule anchoring.',
    'toolbox.sleep.support.program_body.reset_14': 'A two-week comprehensive sleep reset with daily guidance and habit tracking.',
    'toolbox.sleep.support.program_body.starter': 'A gentle 5-step starter program for managing occasional insomnia.',
    ...
    'toolbox.sleep.support.template_step.tiny1': 'Dim only the lights you can reach',
    ...
    'toolbox.sleep.support.template_step.tiny5': 'Get into bed without adding tasks',
    ...
    'toolbox.sleep.support.factor_hint.stress': 'How much stress impacts your sleep',
    'toolbox.sleep.support.factor_hint.screen': 'How screen use affects your bedtime',
    'toolbox.sleep.support.factor_hint.late_work': 'How often work keeps you up late',
    'toolbox.sleep.support.factor_hint.late_exercise': 'How often you exercise close to bedtime',
    'toolbox.sleep.support.factor_hint.pain': 'How much pain interferes with sleep',
    'toolbox.sleep.support.factor_hint.snoring': 'Whether snoring or breathing pauses occur',
    ...
    'toolbox.sleep.support.daily_hint.caffeine': 'Coffee, tea, or energy drinks after your cutoff',
    'toolbox.sleep.support.daily_hint.screens': 'Phone, tablet, or computer late in the evening',
    'toolbox.sleep.support.daily_hint.alcohol': 'Any alcohol consumed close to bedtime',
    'toolbox.sleep.support.daily_hint.morning_light': 'Got natural or bright light within 30 minutes of waking',
    'toolbox.sleep.support.daily_hint.clock': 'Checked the clock repeatedly during the night',
    'toolbox.sleep.support.daily_hint.white_noise': 'Used white noise, fan, or ambient sound',

    // --- toolbox sleep report (B4 continued) ---
    'toolbox.sleep.report.title': 'Sleep report',
    'toolbox.sleep.report.intro': 'Visualize your sleep trends and patterns over time.',
    'toolbox.sleep.report.noData': 'No data yet',
    'toolbox.sleep.report.noDataHint': 'Log at least one night to see your sleep report.',
    ...
    'toolbox.sleep.report.sleepDurationTrendHint': 'How your total sleep time has changed.',
    'toolbox.sleep.report.efficiencyTrend': 'Efficiency trend',
    'toolbox.sleep.report.efficiencyTrendHint': 'How your sleep efficiency has changed.',
    ...
    'toolbox.sleep.report.wakeBurdenHint': 'Total time spent awake during the night.',
    'toolbox.sleep.report.lateCaffeineDays': 'Late caffeine days',
    'toolbox.sleep.report.lateCaffeineDaysHint': 'Nights where caffeine was consumed after cutoff.',
    'toolbox.sleep.report.lateScreenDays': 'Late screen days',
    'toolbox.sleep.report.lateScreenDaysHint': 'Nights with screen exposure close to bedtime.',
    'toolbox.sleep.report.morningLightDays': 'Morning light days',
    'toolbox.sleep.report.morningLightDaysHint': 'Mornings where you got natural bright light.',
    'toolbox.sleep.report.envIssueDays': 'Environment issues',
    'toolbox.sleep.report.envIssueDaysHint': 'Nights with bedroom environment problems.',
    'toolbox.sleep.report.nextCycleAdvice': 'Check 90-min cycle windows for tonight.',

    // --- toolbox sleep science ---
    'toolbox.sleep.science.title': 'Sleep science',
    'toolbox.sleep.science.intro': 'Evidence-based sleep knowledge, references, and practical principles.',
    'toolbox.sleep.science.disclaimer': 'This information is for educational purposes and does not replace medical advice. Consult a healthcare professional for persistent sleep issues.',
    'toolbox.sleep.science.anchorRhythm': 'Anchor your rhythm',
    'toolbox.sleep.science.anchorRhythmBody': 'Morning light within 30 minutes of waking is the strongest signal for setting your internal clock. Even 10 minutes outdoors makes a measurable difference.',
    'toolbox.sleep.science.keepBedForSleep': 'Keep bed for sleep',
    'toolbox.sleep.science.keepBedForSleepBody': 'If you lie awake for 20+ minutes, get up and do something low-stimulation until sleepy. This re-strengthens the bed-sleep association.',
    'toolbox.sleep.science.logLightly': 'Log lightly',
    'toolbox.sleep.science.logLightlyBody': 'A 30-second sleep diary entry is enough to reveal patterns over time. Perfection is not needed — consistency matters more.',
    ...
    'toolbox.sleep.science.refGroupCbtiBody': 'Stimulus control, sleep restriction, and cognitive techniques for chronic insomnia.',
    'toolbox.sleep.science.refGroupRhythm': 'Circadian science',
    'toolbox.sleep.science.refGroupRhythmBody': 'Light exposure, melatonin timing, and body clock fundamentals.',
    'toolbox.sleep.science.refGroupMedical': 'Medical screening',
    'toolbox.sleep.science.refGroupMedicalBody': 'When to consider sleep apnea screening, RLS, or specialist referral.',
    'toolbox.sleep.science.refGroupPopular': 'Popular evidence summaries',
    'toolbox.sleep.science.refGroupPopularBody': 'Translations of research for everyday sleep habits.',
    'toolbox.sleep.science.riskFirst': 'Rule out medical issues first',
    'toolbox.sleep.science.riskFirstBody': 'Some sleep problems may have underlying medical causes. Look out for key warning signs before self-treatment.',
    'toolbox.sleep.science.riskSnoring': 'Loud snoring with witnessed breathing pauses',
    'toolbox.sleep.science.riskMental': 'Sleep disturbance tied to mood episodes or trauma',
    'toolbox.sleep.science.riskMedical': 'Restless legs, chronic pain, or medication side effects',
    'toolbox.sleep.science.dayAnchors': 'Day anchors stabilize nights',
    'toolbox.sleep.science.dayAnchorsBody': 'Stable wake time, morning light, and consistent meal timing anchor your circadian rhythm.',
    'toolbox.sleep.science.fixWakeTime': 'Fix wake-up time within a 30-minute window every day',
    'toolbox.sleep.science.caffeineRule': 'No caffeine after 2pm (or 8-10 hours before bed)',
    'toolbox.sleep.science.napRule': 'Naps under 20 minutes before 3pm, or skip entirely',
    'toolbox.sleep.science.windDownSm': 'The small wind-down matters',
    'toolbox.sleep.science.windDownSmBody': 'Even a tiny 3-step routine signals your brain that the day is ending. Consistency matters more than ritual complexity.',
    'toolbox.sleep.science.windDownDetail1': 'Dim lights 30-60 minutes before bed',
    'toolbox.sleep.science.windDownDetail2': 'Put screens away or switch to dark/night mode',
    'toolbox.sleep.science.windDownDetail3': 'One quiet activity: reading, stretching, or breathing',
    'toolbox.sleep.science.nightWaking': 'Night waking is normal',
    'toolbox.sleep.science.nightWakingBody': 'Brief awakenings between sleep cycles are normal. The problem is how we react — clock-checking and frustration prolong wakefulness.',
    'toolbox.sleep.science.nightWakingDetail1': 'Avoid looking at clocks or your phone',
    'toolbox.sleep.science.nightWakingDetail2': 'If still awake after 20 minutes, leave the bed',
    'toolbox.sleep.science.nightWakingDetail3': 'Do something boring in dim light until sleepy',
    'toolbox.sleep.science.easyMisuse': 'Common misunderstandings',
    'toolbox.sleep.science.easyMisuseIntro': 'Popular sleep advice can be misapplied. Here are three common pitfalls.',
    'toolbox.sleep.science.eightHour': '"Everyone needs 8 hours" — normal sleep varies from 6-9 hours across individuals.',
    'toolbox.sleep.science.cycle90': '"Always wake at a cycle boundary" — sleep architecture is more complex than fixed 90-minute blocks.',
    'toolbox.sleep.science.hygiene': '"Sleep hygiene alone fixes insomnia" — chronic insomnia often needs structured CBT-I techniques.',

    // --- toolbox sleep tools ---
    'toolbox.sleep.tools.ambientNoise': 'Ambient sound',
    'toolbox.sleep.tools.ambientNoiseHint': 'Use white noise, rain, or ambient sounds to mask disturbances.',
    ...
    'toolbox.sleep.sheets.caffeineSuggestion': 'Based on your sensitivity and planned bedtime, cut off caffeine by {time}.',
    'toolbox.sleep.sheets.lightTimer': 'Light timer',
    'toolbox.sleep.sheets.lightTimerHint': 'Get {minutes} minutes of bright light exposure to anchor your rhythm.',
    'toolbox.sleep.core.cancel': 'Cancel',
    'toolbox.sleep.sheets.cyclePlan': '90-minute cycle plan',
    'toolbox.sleep.sheets.cyclePlanHint': 'Sleep cycles are roughly 90 minutes. Plan your schedule around cycle boundaries.',
    'toolbox.sleep.sheets.targetWake': 'Target wake-up time',
    'toolbox.sleep.sheets.settleBuffer': 'Settle buffer: {minutes} min to fall asleep',
    'toolbox.sleep.sheets.backPlanLightsOff': 'Plan: Lights off by {time}',
    'toolbox.sleep.sheets.backPlanHint': 'Working backwards from your target wake time with 5-6 cycles.',
    'toolbox.sleep.sheets.sleepNow': 'If you sleep now',
    'toolbox.sleep.sheets.sleepNowHint': 'Wake up around {time} with {cycles} complete cycles.',
    ...
    'toolbox.sleep.sheets.adviceUncomfortable': 'Check temperature, adjust bedding, try gentle stretch.',
    'toolbox.sleep.sheets.adviceAwake': 'Get up for 15-20 minutes, do a quiet activity, return when drowsy.',
    'toolbox.sleep.sheets.adviceBusy': 'Write down the thoughts, then do 4-7-8 breathing for 2 minutes.',
    'toolbox.sleep.sheets.adviceSleepy': 'Close your eyes, breathe slowly, and let yourself drift.',

    // --- toolbox sleep library (research) ---
    'toolbox.sleep.library.topic.light.title': 'Morning light and circadian anchoring',
    'toolbox.sleep.library.topic.light.summary': 'Bright light within 30 minutes of waking is the single strongest signal for your internal clock.',
    'toolbox.sleep.library.topic.light.detail': 'The suprachiasmatic nucleus (SCN) uses light detected by ipRGC cells in the retina to synchronize your circadian rhythm. Morning light advances your clock, making it easier to fall asleep at night. Even 10-15 minutes outdoors on a cloudy day provides enough lux to make a measurable difference.',
    'toolbox.sleep.library.topic.light.action_hint': 'Get outside within 30 minutes of waking. No sunglasses for the first 10 minutes.',
    'toolbox.sleep.library.source.light_1': 'Czeisler CA, et al. Stability, precision, and near-24-hour period of the human circadian pacemaker. Science (1999).',
    'toolbox.sleep.library.source.light_2': 'Duffy JF, Czeisler CA. Effect of light on human circadian physiology. Sleep Med Clin (2009).',
    'toolbox.sleep.library.source.light_3': 'Blume C, et al. Effects of light on human circadian rhythms, sleep and mood. Somnologie (2019).',
    'toolbox.sleep.library.topic.caffeine.title': 'Caffeine timing and adenosine blockade',
    'toolbox.sleep.library.topic.caffeine.summary': 'Caffeine works by blocking adenosine receptors. Its half-life is 3-7 hours, meaning a 2pm coffee can still affect sleep at midnight.',
    'toolbox.sleep.library.topic.caffeine.detail': 'Adenosine builds up during the day, creating "sleep pressure." Caffeine temporarily blocks adenosine receptors, masking sleepiness without reducing the underlying pressure. Genetic differences in CYP1A2 mean some people metabolize caffeine much slower than others.',
    'toolbox.sleep.library.topic.caffeine.action_hint': 'Set a personal caffeine cutoff 8-10 hours before your typical bedtime.',
    'toolbox.sleep.library.source.caffeine_1': 'Drake C, et al. Caffeine effects on sleep taken 0, 3, or 6 hours before going to bed. J Clin Sleep Med (2013).',
    'toolbox.sleep.library.source.caffeine_2': 'Landolt HP. Genotype-dependent differences in sleep, vigilance, and response to stimulants. Curr Pharm Des (2008).',
    'toolbox.sleep.library.source.caffeine_3': 'Roehrs T, Roth T. Caffeine: sleep and daytime sleepiness. Sleep Med Rev (2008).',
    'toolbox.sleep.library.topic.digital_sunset.title': 'Digital sunset and blue light',
    'toolbox.sleep.library.topic.digital_sunset.summary': 'Evening screen light, especially blue wavelengths, can suppress melatonin by activating the same ipRGC cells that respond to morning light.',
    'toolbox.sleep.library.topic.digital_sunset.detail': 'The melanopsin photopigment in ipRGC cells is most sensitive to ~480nm (blue) light. Evening exposure shifts the circadian clock later, making it harder to fall asleep. However, the effect size varies widely between individuals, and content arousal may matter as much as the light itself.',
    'toolbox.sleep.library.topic.digital_sunset.action_hint': 'Switch devices to night mode after sunset. Stop active screen use 30-60 minutes before bed.',
    'toolbox.sleep.library.source.digital_sunset_1': 'Chang AM, et al. Evening use of light-emitting eReaders negatively affects sleep. PNAS (2015).',
    'toolbox.sleep.library.source.digital_sunset_2': 'Cajochen C, et al. Evening exposure to a light-emitting diode (LED)-backlit computer screen affects circadian physiology. J Appl Physiol (2011).',
    'toolbox.sleep.library.source.digital_sunset_3': 'Exelmans L, Van den Bulck J. Bedtime mobile phone use and sleep in adults. Soc Sci Med (2016).',
    'toolbox.sleep.library.topic.stimulus_control.title': 'Stimulus control: bed = sleep',
    'toolbox.sleep.library.topic.stimulus_control.summary': 'One of the most effective CBT-I techniques: re-associate the bed with sleep only.',
    'toolbox.sleep.library.topic.stimulus_control.detail': 'When people spend time awake in bed (worrying, working, watching shows), the brain learns that bed is a place for wakefulness. Stimulus control therapy breaks this cycle by prescribing: only go to bed when sleepy, get up if awake for 20+ minutes, and use the bed only for sleep.',
    'toolbox.sleep.library.topic.stimulus_control.action_hint': 'If you lie awake for 20+ minutes, get up and do something boring in dim light.',
    'toolbox.sleep.library.source.stimulus_control_1': 'Bootzin RR, Epstein D, Wood JM. Stimulus control instructions. In: Case Studies in Insomnia (1991).',
    'toolbox.sleep.library.source.stimulus_control_2': 'Morin CM, et al. Psychological and behavioral treatment of insomnia: update of the recent evidence. Sleep (2006).',
    'toolbox.sleep.library.topic.diary_trends.title': 'The power of a simple sleep diary',
    'toolbox.sleep.library.topic.diary_trends.summary': 'A 30-second sleep log reveals patterns that even detailed sleep trackers miss.',
    'toolbox.sleep.library.topic.diary_trends.detail': 'Consumer sleep trackers estimate sleep stages from movement and heart rate, but their accuracy varies widely and they often overestimate sleep. A simple diary capturing bedtime, wake time, and subjective restfulness provides complementary data that highlights behavioral patterns trackers cannot see.',
    'toolbox.sleep.library.topic.diary_trends.action_hint': 'Log just 3 data points per night: bedtime, wake time, and how rested you feel.',
    'toolbox.sleep.library.source.diary_trends_1': 'Carney CE, et al. The consensus sleep diary: standardizing prospective sleep self-monitoring. Sleep (2012).',
    'toolbox.sleep.library.source.diary_trends_2': 'Baron KG, et al. Feeling validated yet? A scoping review of consumer wearable sleep technology. Sleep Med Rev (2018).',
    'toolbox.sleep.library.source.diary_trends_3': 'de Zambotti M, et al. The sleep of the ring: comparison of the ŌURA sleep tracker against polysomnography. Behav Sleep Med (2019).',
    'toolbox.sleep.library.topic.sleep_cycles.title': 'Sleep cycles and the 90-minute myth',
    'toolbox.sleep.library.topic.sleep_cycles.summary': 'Sleep cycles average about 90 minutes, but the range is 70-120 minutes, and they change across the night.',
    'toolbox.sleep.library.topic.sleep_cycles.detail': 'NREM-REM cycles do follow a roughly 90-minute rhythm, but the first cycle of the night is often shorter (~70 min) with more deep sleep, while later cycles are longer (~100-120 min) with more REM. Waking up naturally often occurs from REM and can feel restorative.',
    'toolbox.sleep.library.topic.sleep_cycles.action_hint': 'Use 90-minute windows as a rough guide, not a rigid rule. Consistency of wake time matters more.',
    'toolbox.sleep.library.source.sleep_cycles_1': 'Feinberg I, Floyd TC. Systematic trends across the night in human sleep cycles. Psychophysiology (1979).',
    'toolbox.sleep.library.source.sleep_cycles_2': 'Carskadon MA, Dement WC. Normal human sleep: an overview. In: Principles and Practice of Sleep Medicine (2011).',
    'toolbox.sleep.library.source.sleep_cycles_3': 'Achermann P, Borbély AA. Sleep homeostasis and models of sleep regulation. J Biol Rhythms (1999).',
    'toolbox.sleep.library.topic.worry_unload.title': 'Unloading worry before bedtime',
    'toolbox.sleep.library.topic.worry_unload.summary': 'A brief structured writing exercise before bed can reduce pre-sleep cognitive arousal.',
    'toolbox.sleep.library.topic.worry_unload.detail': 'Pre-sleep cognitive arousal—worrying, planning, replaying events—is a primary driver of sleep-onset insomnia. Structured "worry time" earlier in the evening plus a brief bedside unloading exercise (writing down the top concern and a gentle reframe) reduces the mental activation that delays sleep.',
    'toolbox.sleep.library.topic.worry_unload.action_hint': 'Write down your top worry and one gentler way to see it before turning off the light.',
    'toolbox.sleep.library.source.worry_unload_1': 'Harvey AG. A cognitive model of insomnia. Behav Res Ther (2002).',
    'toolbox.sleep.library.source.worry_unload_2': 'Espie CA, et al. The attention-intention-effort pathway in the development of psychophysiologic insomnia. Sleep Med Rev (2006).',
    'toolbox.sleep.library.topic.bedroom.title': 'Bedroom environment optimization',
    'toolbox.sleep.library.topic.bedroom.summary': 'Temperature, noise, and light are the three main environmental factors affecting sleep quality.',
    'toolbox.sleep.library.topic.bedroom.detail': 'The ideal bedroom temperature for sleep is 18-20°C (65-68°F). Core body temperature must drop by about 1°C to initiate and maintain sleep. A room that is too warm prevents this drop. Noise above 40dB can cause arousals even without full awakening.',
    'toolbox.sleep.library.topic.bedroom.action_hint': 'Keep the bedroom cool, dark, and quiet. Try a temperature of 18-20°C.',
    'toolbox.sleep.library.source.bedroom_1': 'Okamoto-Mizuno K, Mizuno K. Effects of thermal environment on sleep and circadian rhythm. J Physiol Anthropol (2012).',
    'toolbox.sleep.library.source.bedroom_2': 'Muzet A. Environmental noise, sleep and health. Sleep Med Rev (2007).',
    'toolbox.sleep.library.source.bedroom_3': 'van Maanen A, et al. The effects of light therapy on sleep problems. Sleep Med Rev (2016).',
    'toolbox.sleep.library.topic.temperature.title': 'Core body temperature and sleep onset',
    'toolbox.sleep.library.topic.temperature.summary': 'A drop in core body temperature of about 1°C is required to initiate and maintain sleep.',
    'toolbox.sleep.library.topic.temperature.detail': 'The body\'s thermoregulatory system is closely linked to sleep regulation. Vasodilation in hands and feet (which is why warm hands help sleep onset) facilitates heat loss. A warm bath 1-2 hours before bed paradoxically helps by drawing blood to the skin surface, triggering a rebound temperature drop.',
    'toolbox.sleep.library.topic.temperature.action_hint': 'Try a warm bath or shower 1-2 hours before bed. Keep the bedroom slightly cool.',
    'toolbox.sleep.library.source.temperature_1': 'Kräuchi K, et al. Warm feet promote the rapid onset of sleep. Nature (1999).',
    'toolbox.sleep.library.source.temperature_2': 'Raymann RJ, et al. Skin temperature and sleep-onset latency. Physiol Behav (2007).',
    'toolbox.sleep.library.topic.nap.title': 'Naps: strategic use and timing',
    'toolbox.sleep.library.topic.nap.summary': 'Short naps under 20 minutes can boost alertness without causing sleep inertia or disrupting nighttime sleep.',
    'toolbox.sleep.library.topic.nap.detail': 'The ideal nap window is 10-20 minutes (the "power nap") which stays in lighter NREM sleep stages before entering deep slow-wave sleep. Longer naps (30+ min) risk sleep inertia—grogginess on waking—and can reduce homeostatic sleep pressure, making it harder to fall asleep at night.',
    'toolbox.sleep.library.topic.nap.action_hint': 'Naps under 20 minutes, before 3pm. If you have insomnia, skip naps entirely.',
    'toolbox.sleep.library.source.nap_1': 'Milner CE, Cote KA. Benefits of napping in healthy adults. J Sleep Res (2009).',
    'toolbox.sleep.library.source.nap_2': 'Brooks A, Lack L. A brief afternoon nap following nocturnal sleep restriction. Sleep (2006).',
    'toolbox.sleep.library.topic.white_noise.title': 'White noise and auditory masking',
    'toolbox.sleep.library.topic.white_noise.summary': 'White noise can help by masking sudden environmental noises that cause micro-arousals.',
    'toolbox.sleep.library.topic.white_noise.detail': 'White noise raises the auditory threshold, making it harder for sudden sounds (door closing, traffic, neighbor noise) to trigger a waking response. The effect is most pronounced in environments with intermittent noise rather than continuous noise.',
    'toolbox.sleep.library.topic.white_noise.action_hint': 'Set white noise at a comfortable volume, just loud enough to mask background disturbances.',
    'toolbox.sleep.library.source.white_noise_1': 'Stanchina ML, et al. The influence of white noise on sleep in subjects exposed to ICU noise. Sleep Med (2005).',
    'toolbox.sleep.library.source.white_noise_2': 'Forquer LM, Johnson CM. Continuous white noise to reduce sleep latency and night wakings in college students. Sleep Hypn (2007).',
    'toolbox.sleep.library.topic.red_flags.title': 'When to see a doctor',
    'toolbox.sleep.library.topic.red_flags.summary': 'Some sleep symptoms warrant medical evaluation before self-guided approaches.',
    'toolbox.sleep.library.topic.red_flags.detail': 'Loud, habitual snoring with witnessed breathing pauses suggests possible sleep apnea, which affects 10-30% of adults and requires medical diagnosis. Restless legs, chronic pain disrupting sleep, and sleep disturbance tied to mood episodes also warrant professional evaluation.',
    'toolbox.sleep.library.topic.red_flags.action_hint': 'If you snore loudly and feel unrefreshed despite adequate sleep duration, ask your doctor about a sleep study.',
    'toolbox.sleep.library.source.red_flags_1': 'Young T, et al. The occurrence of sleep-disordered breathing among middle-aged adults. N Engl J Med (1993).',
    'toolbox.sleep.library.source.red_flags_2': 'Winkelman JW, et al. Clinical practice guideline for restless legs syndrome. J Clin Sleep Med (2016).',
    'toolbox.sleep.library.source.red_flags_3': 'Baglioni C, et al. Sleep and mental disorders: a meta-analysis of polysomnographic research. Psychol Bull (2016).',
    'toolbox.sleep.library.topic.references': 'References',
    'toolbox.sleep.library.advice_assessment_rhythm.title': 'Start a 7-day rhythm reset',
    'toolbox.sleep.library.advice_assessment_rhythm.body': 'Your assessment suggests an irregular sleep schedule. A structured rhythm program focusing on consistent wake time and morning light can stabilize your circadian rhythm.',
    'toolbox.sleep.library.advice_assessment_rhythm.reason': 'Irregular schedules weaken the circadian signal, making it harder to fall asleep and wake up predictably.',
    'toolbox.sleep.library.tag.rhythm': 'Rhythm',
    'toolbox.sleep.library.advice_assessment_wind_down.title': 'Build a tiny wind-down routine',
    'toolbox.sleep.library.advice_assessment_wind_down.body': 'Even a simple 3-step pre-bed routine can significantly reduce the time it takes to fall asleep by signaling to your brain that the day is ending.',
    'toolbox.sleep.library.advice_assessment_wind_down.reason': 'Racing thoughts and difficulty winding down respond well to a consistent behavioral routine.',
    'toolbox.sleep.library.tag.wind_down': 'Wind-down',
    'toolbox.sleep.library.advice_assessment_caffeine.title': 'Optimize your caffeine cutoff',
    'toolbox.sleep.library.advice_assessment_caffeine.body': 'Based on your sensitivity, set a firm caffeine cutoff 8-10 hours before your typical bedtime to protect your natural sleep pressure.',
    'toolbox.sleep.library.advice_assessment_caffeine.reason': 'Caffeine blocks adenosine receptors, masking the sleep pressure your brain needs to initiate sleep.',
    'toolbox.sleep.library.tag.behavior': 'Behavior',
    'toolbox.sleep.library.advice_assessment_environment.title': 'Optimize your bedroom environment',
    'toolbox.sleep.library.advice_assessment_environment.body': 'A cool, dark, and quiet bedroom supports the natural drop in core body temperature needed for sleep.',
    'toolbox.sleep.library.advice_assessment_environment.reason': 'Environmental factors can interfere with the physiological transition to sleep.',
    'toolbox.sleep.library.tag.environment': 'Environment',
    'toolbox.sleep.library.advice_assessment_temp.title': 'Use temperature to aid sleep onset',
    'toolbox.sleep.library.advice_assessment_temp.body': 'A warm bath 1-2 hours before bed, plus a cool bedroom, helps trigger the core temperature drop needed for sleep.',
    'toolbox.sleep.library.advice_assessment_temp.reason': 'Core body temperature must drop about 1°C to initiate and maintain sleep.',
    'toolbox.sleep.library.tag.temperature': 'Temperature',
    'toolbox.sleep.library.advice_assessment_risk.title': 'Consider a medical evaluation',
    'toolbox.sleep.library.advice_assessment_risk.body': 'Your assessment flagged potential risk factors that may benefit from professional evaluation alongside self-guided approaches.',
    'toolbox.sleep.library.advice_assessment_risk.reason': 'Some sleep symptoms have underlying medical causes that are best evaluated by a healthcare professional.',
    'toolbox.sleep.library.tag.risk': 'Health',
    'toolbox.sleep.library.advice_daily_minimal_log.title': 'Keep logging — consistency beats detail',
    'toolbox.sleep.library.advice_daily_minimal_log.body': 'Your daily log entries are building a dataset that reveals patterns. Keep going — even 30-second entries add up.',
    'toolbox.sleep.library.advice_daily_minimal_log.reason': 'Sleep diary data over multiple nights reveals patterns that single-night snapshots miss.',
    'toolbox.sleep.library.tag.log': 'Logging',
    'toolbox.sleep.library.advice_daily_caffeine.title': 'Watch the late caffeine pattern',
    'toolbox.sleep.library.advice_daily_caffeine.body': 'Your logs show caffeine consumption close to bedtime on some nights. Even when you can fall asleep, caffeine reduces deep sleep.',
    'toolbox.sleep.library.advice_daily_caffeine.reason': 'Caffeine after the cutoff can fragment sleep architecture even without delaying sleep onset.',
    'toolbox.sleep.library.advice_daily_light.title': 'Prioritize morning light',
    'toolbox.sleep.library.advice_daily_light.body': 'Your sleep quality correlates with morning light exposure. Try getting outside for 10-15 minutes within 30 minutes of waking.',
    'toolbox.sleep.library.advice_daily_light.reason': 'Morning light is the strongest zeitgeber for anchoring circadian rhythm.',
    'toolbox.sleep.library.advice_daily_screen.title': 'Try a digital sunset tonight',
    'toolbox.sleep.library.advice_daily_screen.body': 'Late screen use appears in your recent logs. Switching to night mode or putting devices away 30-60 minutes before bed can improve sleep quality.',
    'toolbox.sleep.library.advice_daily_screen.reason': 'Evening blue light can suppress melatonin and delay sleep onset.',
    'toolbox.sleep.library.advice_daily_worry.title': 'Try the worry unload exercise',
    'toolbox.sleep.library.advice_daily_worry.body': 'Pre-sleep worry or busy-mind patterns show in your data. A 2-minute writing exercise before bed can significantly reduce this cognitive arousal.',
    'toolbox.sleep.library.advice_daily_worry.reason': 'Pre-sleep cognitive arousal is a primary driver of sleep-onset difficulty.',
    'toolbox.sleep.library.tag.cognitive': 'Cognitive',
    'toolbox.sleep.library.advice_daily_rescue.title': 'Keep the night rescue tool handy',
    'toolbox.sleep.library.advice_daily_rescue.body': 'Night awakenings appear in your recent logs. Having a pre-planned low-stimulation response makes it easier to handle them calmly.',
    'toolbox.sleep.library.advice_daily_rescue.reason': 'A planned response to night waking reduces the anxiety and clock-checking that prolong wakefulness.',
    'toolbox.sleep.library.tag.rescue': 'Rescue',
    'toolbox.sleep.library.advice_daily_environment.title': 'Tweak your bedroom environment',
    'toolbox.sleep.library.advice_daily_environment.body': 'Your logs show environmental factors are affecting your sleep. Small adjustments to temperature, light, or noise can make a meaningful difference.',
    'toolbox.sleep.library.advice_daily_environment.reason': 'The bedroom environment directly impacts the body\'s ability to initiate and maintain sleep.',
    'toolbox.sleep.library.advice_daily_nap.title': 'Optimize your nap strategy',
    'toolbox.sleep.library.advice_daily_nap.body': 'Your data suggests daytime sleepiness. If you nap, keep it under 20 minutes and before 3pm. If you have insomnia, consider skipping naps.',
    'toolbox.sleep.library.advice_daily_nap.reason': 'Naps can help or hurt nighttime sleep depending on timing and duration.',
    'toolbox.sleep.library.tag.recovery': 'Recovery',
    'toolbox.sleep.library.advice_weekly_light.title': 'Morning light is your strongest rhythm tool',
    'toolbox.sleep.library.advice_weekly_light.body': 'Your weekly data shows inconsistent morning light. Prioritizing even 10 minutes outdoors within 30 minutes of waking can strengthen your sleep-wake cycle.',
    'toolbox.sleep.library.advice_weekly_light.reason': 'Consistent morning light exposure is the most effective way to stabilize circadian timing.',
    'toolbox.sleep.library.advice_weekly_caffeine.title': 'Your caffeine pattern may be reducing sleep quality',
    'toolbox.sleep.library.advice_weekly_caffeine.body': 'Caffeine close to bedtime correlates with lower sleep efficiency and less deep sleep in your weekly data.',
    'toolbox.sleep.library.advice_weekly_caffeine.reason': 'Late caffeine affects sleep architecture even when you don\'t notice difficulty falling asleep.',
    'toolbox.sleep.library.advice_weekly_screen.title': 'Late screen use is affecting your sleep',
    'toolbox.sleep.library.advice_weekly_screen.body': 'Your data shows a correlation between late screen use and longer time to fall asleep. Try a 30-60 minute screen-free buffer before bed.',
    'toolbox.sleep.library.advice_weekly_screen.reason': 'Screen light and content arousal both contribute to delayed sleep onset.',
    'toolbox.sleep.library.advice_weekly_rescue.title': 'Night awakenings: prepare a response plan',
    'toolbox.sleep.library.advice_weekly_rescue.body': 'Multiple night awakenings in your recent logs suggest having a pre-planned rescue response could help. The key: avoid clock-checking, and get up briefly if awake 20+ minutes.',
    'toolbox.sleep.library.advice_weekly_rescue.reason': 'A planned response to night waking reduces the frustration that can prolong wakefulness.',
    'toolbox.sleep.library.advice_weekly_worry.title': 'Pre-sleep worry: a simple writing exercise can help',
    'toolbox.sleep.library.advice_weekly_worry.body': 'Your data shows elevated worry or busy-mind ratings. A structured 2-minute "worry unload" before bed can clear mental space for sleep.',
    'toolbox.sleep.library.advice_weekly_worry.reason': 'Cognitive arousal before bed is one of the strongest predictors of prolonged sleep onset.',
    'toolbox.sleep.library.advice_weekly_environment.title': 'Your sleep environment needs attention',
    'toolbox.sleep.library.advice_weekly_environment.body': 'Environmental complaints (temperature, noise, light) appear across multiple nights. Consistent bedroom optimization can yield cumulative benefits.',
    'toolbox.sleep.library.advice_weekly_environment.reason': 'Persistent environmental issues have a compounding negative effect on sleep quality.',
    'toolbox.sleep.library.advice_weekly_sleep_amount.title': 'Your total sleep time shows a pattern',
    'toolbox.sleep.library.advice_weekly_sleep_amount.body': 'Your weekly sleep duration shows variability. Focus on consistent wake time rather than bedtime — this is the stronger anchor for circadian rhythm.',
    'toolbox.sleep.library.advice_weekly_sleep_amount.reason': 'Wake-time consistency is more important than bedtime consistency for circadian health.',
    'toolbox.sleep.library.tag.sleep_amount': 'Sleep amount',
    'toolbox.sleep.library.empty.no_advice': 'No advice available yet',
    'toolbox.sleep.library.empty.no_advice_hint': 'Continue logging your sleep to receive personalized suggestions.',
    ...
    'toolbox.breathing.altitude_simulation_description': 'Altitude simulation adjusts patterns and difficulty, designed for experienced users. If you have respiratory conditions, cardiovascular issues, or are pregnant, consult a doctor first.',
    'toolbox.breathing.altitude_extra_warning': 'Altitude simulation is not medical advice. Stop immediately and return to natural breathing if you feel dizzy, tightness, or any discomfort.',
    'toolbox.breathing.cancel': 'Cancel',
    'toolbox.breathing.continue_select': 'Continue',
    'toolbox.breathing.bolt_test': 'BOLT test',
    'toolbox.breathing.bolt_description': 'Measures your CO2 tolerance to help assess current breathing efficiency. A low score often points to shallow or rapid breathing.',
    ...
    'toolbox.breathing.breath_hold_on': 'On: adding a hold makes the cycle more complete but takes more adaptation.',
    'toolbox.breathing.breath_hold_off': 'Off: best for first-time practice or when you prefer no extra hold.',
    'toolbox.breathing.recovery_stage': 'Recovery stage',
    'toolbox.breathing.recovery_on': 'On: a quiet recovery pause at the end of each cycle.',
    'toolbox.breathing.recovery_off': 'Off: skip the recovery pause for a tighter rhythm.',
    'toolbox.breathing.voice_cues': 'Voice cues',
    'toolbox.breathing.voice_on': 'On: spoken reminders guide each phase of the breath.',
    'toolbox.breathing.voice_off': 'Off: keep text, animation, and haptics only.',
    ...
    'toolbox.breathing.haptics_on': 'On: a light vibration on each stage change.',
    'toolbox.breathing.haptics_off': 'Off: no extra vibration.',
    'toolbox.breathing.scenarios_title': 'Breathing scenarios',
    'toolbox.breathing.scenarios_subtitle': 'From focus to relaxation, from daily practice to BOLT testing and altitude simulation. Each scenario includes detailed breathing guidance and phase breakdown.',
    ...
    'toolbox.breathing.safety_note_body': 'Breathing exercises are not a substitute for medical advice. Consult a doctor before starting new training if you have respiratory or cardiovascular concerns or are pregnant. Stop immediately and return to natural breathing if you feel dizzy, tightness, or any discomfort.',
    'toolbox.breathing.stop_preview': 'Stop preview',
    'toolbox.breathing.preview_guidance': 'Preview guidance',
    'toolbox.breathing.voice_only_chinese_title': 'Voice is Chinese-only for now',
    'toolbox.breathing.voice_only_chinese_body': 'Breathing voice guidance is currently recorded in Chinese only. The interface can stay in your current language, but spoken cues will play in Chinese.',
    ...
    'toolbox.breathing.voice_availability_short': 'Voice guidance is available.',
    ...
    'toolbox.breathing.not_tested_body': 'You have not completed a BOLT test yet. BOLT (Body Oxygen Level Test) measures your CO2 tolerance: a higher score generally indicates better breathing efficiency.',
    'toolbox.breathing.not_tested_next': 'Suggestion: complete one BOLT test for a baseline score.',
    'toolbox.breathing.low_bolt': 'Low BOLT',
    'toolbox.breathing.low_bolt_body': 'Your BOLT is low (under 20 s), suggesting room to improve CO2 tolerance. Shallow or rapid breathing is a common cause.',
    'toolbox.breathing.low_bolt_next': 'Start with the diaphragmatic breathing scenario and aim to raise BOLT above 20 before trying breath-hold patterns.',
    'toolbox.breathing.building_bolt': 'BOLT building',
    'toolbox.breathing.building_bolt_body': 'Your BOLT is 20-29 s, in the building range. Breathing efficiency still has room to grow.',
    'toolbox.breathing.building_bolt_next': 'Keep practicing diaphragmatic breathing and no-hold slow patterns to gradually improve CO2 tolerance.',
    'toolbox.breathing.stable_bolt': 'Stable BOLT',
    'toolbox.breathing.stable_bolt_body': 'Your BOLT is 30-39 s, a stable range where breath-hold patterns become appropriate.',
    'toolbox.breathing.stable_bolt_next': 'You can safely try box breathing, 4-7-8, and other patterns with holds.',
    'toolbox.breathing.advanced_bolt': 'Advanced BOLT',
    'toolbox.breathing.advanced_bolt_body': 'Your BOLT is over 40 s, indicating strong breathing efficiency. You are ready for altitude simulation and advanced hold training.',
    'toolbox.breathing.advanced_bolt_next': 'You can try altitude simulation and longer breath-hold sessions. Keep up regular practice.',
    ...
    'toolbox.daily_choice.page_subtitle': 'Turn everyday indecision into light, editable, reviewable choices, from what to eat and wear to lightweight decision calculations.',
    ...
    'toolbox.daily_choice.context_influences': 'The context changes which lens should lead: random, weighted, scenario, or guardrails.',
    'toolbox.daily_choice.high_stakes_guardrail': 'For high-stakes calls, check the safety threshold before upside. Open the full checklist when needed.',
    'toolbox.daily_choice.pre_commit_scan': 'Before committing, scan bias, noise, and review conditions.',
    ...
    'toolbox.daily_choice.check_guardrails_first': 'Check the safety threshold before chasing upside.',
    'toolbox.daily_choice.guardrail_best_for': 'Best when stakes are high, reversal is hard, time is tight, or the floor must be protected.',
    ...
    'toolbox.daily_choice.uniform_random_subtitle': 'Best for low-stakes, reversible choices with tiny differences.',
    'toolbox.daily_choice.uniform_random_formula': 'Each option gets the same chance. The goal is to end hesitation fast.',
    'toolbox.daily_choice.uniform_random_caution': 'Do not use random choice for high-stakes decisions.',
    'toolbox.daily_choice.weighted_factors': 'Weighted factors',
    'toolbox.daily_choice.weighted_factors_subtitle': 'Compare value, success odds, reversibility, risk, and info gaps on one ruler.',
    'toolbox.daily_choice.weighted_factors_formula': 'Weighted positives minus penalties for risk, effort, regret, and info gaps.',
    'toolbox.daily_choice.weighted_factors_caution': 'Useful for ranking, not for claiming certainty.',
    'toolbox.daily_choice.expected_value': 'Expected value',
    'toolbox.daily_choice.expected_value_subtitle': 'Best for uncertain outcomes when you can estimate rough odds.',
    'toolbox.daily_choice.expected_value_formula': 'Success probability × upside − downside exposure − effort cost.',
    'toolbox.daily_choice.expected_value_caution': 'Your inputs are still judgments, so estimate independently first.',
    'toolbox.daily_choice.joint_probability': 'Joint probability',
    'toolbox.daily_choice.joint_probability_subtitle': 'Use a conservative product when success needs multiple things to line up.',
    'toolbox.daily_choice.joint_probability_formula': 'Success probability × execution probability × confidence, then subtract downside exposure.',
    'toolbox.daily_choice.joint_probability_caution': 'Great for multi-step dependence, weaker when the events are strongly correlated.',
    'toolbox.daily_choice.scenario_blend': 'Scenario blend',
    'toolbox.daily_choice.scenario_blend_subtitle': 'Blend optimistic, base, and pessimistic scenarios so you do not stare only at the upside.',
    'toolbox.daily_choice.scenario_blend_formula': 'A weighted blend of optimistic, base, and pessimistic cases.',
    'toolbox.daily_choice.scenario_blend_caution': 'When uncertainty is high, let the pessimistic case carry real weight.',
    'toolbox.daily_choice.regret_balance': 'Regret and opportunity cost',
    'toolbox.daily_choice.regret_balance_subtitle': 'Useful when you are likely to revisit the decision and ask what you should have chosen.',
    'toolbox.daily_choice.regret_balance_formula': 'Realized upside plus reversibility buffer minus regret exposure and opportunity cost.',
    'toolbox.daily_choice.regret_balance_caution': 'This lens corrects emotion; it does not predict destiny.',
    'toolbox.daily_choice.threshold_guardrail': 'Safety threshold first',
    'toolbox.daily_choice.threshold_guardrail_subtitle': 'Check minimum standards first, then rank only the options that clear them.',
    'toolbox.daily_choice.threshold_guardrail_formula': 'Check confidence, downside, reversibility, and info gaps first, then break ties with a composite score.',
    'toolbox.daily_choice.threshold_guardrail_caution': 'In high-stakes situations, protect the floor before chasing upside.',
    'toolbox.daily_choice.calibrated_forecast': 'Calibrated forecast',
    'toolbox.daily_choice.calibrated_forecast_subtitle': 'Shrink extreme forecasts back toward the mean to curb overconfidence.',
    'toolbox.daily_choice.calibrated_forecast_formula': 'Average score + confidence × (raw forecast − average forecast).',
    'toolbox.daily_choice.calibrated_forecast_caution': 'This is not machine learning; it is a disciplined pull back from extremes.',
    'toolbox.daily_choice.classify_first': 'Classify before choosing a method',
    'toolbox.daily_choice.classify_first_subtitle': 'High-quality decisions start by identifying the type of decision before choosing the math lens.',
    'toolbox.daily_choice.low_stakes_fast': 'Low stakes and reversible: decide fast',
    'toolbox.daily_choice.low_stakes_fast_body': 'For restaurants, weekend plans, or lightweight purchases, the point is not perfection. Random choice or weighted factors are usually enough.',
    'toolbox.daily_choice.high_stakes_guardrail_title': 'High stakes or hard to undo: set a safety threshold first',
    'toolbox.daily_choice.high_stakes_guardrail_body': 'When mistakes are costly to unwind, check risk, confidence, info gaps, and reversibility before chasing upside.',
    'toolbox.daily_choice.high_uncertainty_pessimistic': 'High uncertainty: bring in the pessimistic case',
    'toolbox.daily_choice.high_uncertainty_pessimistic_body': 'When you know you do not know enough, a single score is not enough. Use joint probability, scenarios, and information value together.',
    'toolbox.daily_choice.six_elements_quality': 'Six elements of decision quality',
    'toolbox.daily_choice.six_elements_quality_subtitle': 'Taken from the Stanford decision-quality framework. This is the backbone of the module.',
    'toolbox.daily_choice.frame_question_right': 'Frame the question correctly',
    'toolbox.daily_choice.frame_question_right_body': 'Clarify what is being decided, the time horizon, and which constraints are non-negotiable. A bad frame corrupts later analysis.',
    'toolbox.daily_choice.generate_options': 'Generate at least 2 to 3 viable options',
    'toolbox.daily_choice.generate_options_body': 'Many bad decisions happen because the option set was poor, not because comparison failed. Expand first, then narrow.',
    'toolbox.daily_choice.reliable_info': 'Use relevant and reliable information',
    'toolbox.daily_choice.values_tradeoffs': 'Write down values and tradeoffs',
    'toolbox.daily_choice.transparent_reasoning': 'Keep reasoning transparent and reviewable',
    'toolbox.daily_choice.decision_to_action': 'A decision must end in action',
    'toolbox.daily_choice.probability_uncertainty': 'Probability and uncertainty',
    'toolbox.daily_choice.probability_uncertainty_subtitle': 'Translate emotional certainty into probability language that can actually be compared.',
    'toolbox.daily_choice.assign_probabilities': 'Assign probabilities before conclusions',
    'toolbox.daily_choice.use_multiplication': 'Use multiplication when several conditions must hold',
    'toolbox.daily_choice.pull_extremes_back': 'Pull extreme forecasts back toward the mean',
    ...
    'toolbox.daily_choice.bias_noise_control_subtitle': 'Avoid getting dragged around by anchors, sunk costs, compelling stories, or group noise.',
    'toolbox.daily_choice.independent_estimate': 'Estimate independently before discussion',
    ...
    'toolbox.daily_choice.when_to_research': 'When to research more and when to move',
    'toolbox.daily_choice.when_to_research_subtitle': 'Information has value, but analysis still needs a stop point.',
    'toolbox.daily_choice.most_likely_flip': 'Collect the one fact most likely to change the answer',
    'toolbox.daily_choice.stop_rule': 'Set a stopping rule',
    'toolbox.daily_choice.premortem': 'Run a premortem for high-stakes choices',
    'toolbox.daily_choice.professional_judgment': 'Medical, legal, and financial calls still need experts',
    ...
    'toolbox.daily_choice.base_rates_high_uncertainty': 'Use base rates when uncertainty is high',
    'toolbox.daily_choice.research_flip_fact': 'Research the fact most likely to change the answer',
    'toolbox.daily_choice.premortem_high_stakes': 'Run a premortem for high stakes',
    'toolbox.daily_choice.value_ranking_disagree': 'Return to value ranking when methods disagree',
    'toolbox.daily_choice.stop_rule_now': 'If you must decide now, define a stopping rule',
    ...
    'toolbox.daily_choice.hub_subtitle': 'Turn everyday small dilemmas into randomized, editable, reviewable lightweight choices.',
    ...
    'toolbox.daily_choice.weather_not_ready': 'Showing all temperatures for now. If the weather service has loaded, it will be used here automatically.',
  };
  ...
  static const Map<String, String> _toolboxZh = <String, String>{
    ...
    'toolbox.sound.locator.page_subtitle': '使用手机自带麦克风监听目标声源，并引导你移动到多个位置逐步确认声源区域。',
    ...
    'toolbox.sound.locator.guidance_mono': '单声道也可以使用：请记录当前位置，然后向左、向右或向前移动一步继续采样。',
    ...
    'toolbox.sound.locator.guidance_normal': '方向估计正在更新；请记录多个位置，系统会结合强度、信噪比和方位稳定性确认声源区域。',
    ...
    'toolbox.sound.locator.confirm_locked': '已根据多个手机位置确认声源区域。复杂环境下仍建议再采一次反方向样本。',
    ...
    'toolbox.sound.locator.try_stereo_subtitle': '如果平台只返回单声道或开启失败，可关闭此项改为稳定的单声道活动检查。',
    'toolbox.sound.locator.mic_sufficient': '手机自带麦克风足够用于移动确认流程：静止单点不可靠，但记录多个位置后可以逐步确定声源区域。',
    ...
    'toolbox.sound.locator.odas_description': '手机端默认不要求外接同步麦克风。ODAS 只作为高级参考：当用户有专用阵列时，可把输出并入本页的确认模型。',
    'toolbox.sound.locator.odas_default_path': '默认路径是手机移动采样；高级模式可以通过原生插件或本地守护进程读取 ODAS tracked source JSON 作为附加证据。',
    ...
    'toolbox.sound.soothing.page_subtitle': '精选疗愈系轻音乐与氛围旋律，配合动态呼吸光效与本地曲库，适合手机端沉浸使用。',
    ...
    'toolbox.sound.soothing.empty_mode_subtitle_favorites': '给常用模式点亮爱心，之后就能在这里快速切换。',
    'toolbox.sound.soothing.empty_mode_subtitle_recent': '切换或播放几个模式后，这里会自动记录最近使用内容。',
    ...
    'toolbox.sound.soothing.arrangement_progress': '第 {current}/{total} 段 · {mode} · {track} · {repeat}/{max} 次',
    ...
    'toolbox.sound.soothing.playback_order_desc': '默认单曲重复。切换为顺次播放后，可按设定顺序自动切换主题和曲目。',
    'toolbox.sound.soothing.arrangement_not_saved': '播放顺序未保存',
    'toolbox.sound.soothing.arrangement_steps_info': '{steps} 段 · 已保存模板 {templates} 个',
    ...
    'toolbox.sound.bowls.today_suggestion_body': '夜里想要沉一点，优先尝试"深邃 + 地球 / 174 Hz"；白天短时调息，"水晶 + 和谐 / 528 Hz / 639 Hz"会更轻一些。',
    ...
    'toolbox.sound.bowls.auto_summary_suffix': ' \u00b7 \u81ea\u52a8 {interval}s',
    ...
    'toolbox.sound.flute.brighter_lead_tone_with_stronger': '\u66f4\u4eae\u3001\u66f4\u9760\u524d\uff0c\u9002\u5408\u65cb\u5f8b\u53e5\u7684\u7a81\u51fa\u3002',
    'toolbox.sound.flute.clay_ocarina': '\u9676\u7b1b',
    'toolbox.sound.flute.disable_blow_sensor': '\u5173\u95ed\u5439\u6c14\u68c0\u6d4b',
    'toolbox.sound.flute.dorian': '\u591a\u5229\u4e9a',
    'toolbox.sound.flute.enable_blow_sensor': '\u5f00\u542f\u5439\u6c14\u68c0\u6d4b',
    'toolbox.sound.flute.flute_settings': '\u957f\u7b1b\u8bbe\u7f6e',
    'toolbox.sound.flute.full_screen': '\u5168\u5c4f',
    'toolbox.sound.flute.gentler_attacks_and_a_more': '\u7af9\u611f\u66f4\u5f3a\uff0c\u8d77\u97f3\u66f4\u67d4\uff0c\u9002\u5408\u5b89\u9759\u7684\u4e94\u58f0\u97f3\u9636\u5373\u5174\u3002',
    ...
    'toolbox.sound.flute.microphone_permission_unavailable': '\u9ea6\u514b\u98ce\u6743\u9650\u4e0d\u53ef\u7528',
    'toolbox.sound.flute.microphone_permission_unavailable_touch_play': '\u9ea6\u514b\u98ce\u6743\u9650\u4e0d\u53ef\u7528\uff0c\u5f53\u524d\u4ec5\u53ef\u4f7f\u7528\u89e6\u63a7\u6f14\u594f\u3002',
    'toolbox.sound.flute.mixolydian': '\u6df7\u5408\u5229\u5e95\u4e9a',
    'toolbox.sound.flute.natural_breathy_tone_for_gentle': '\u81ea\u7136\u6c14\u606f\u611f\uff0c\u9002\u5408\u8f7b\u67d4\u6f14\u594f\u3002',
    ...
    'toolbox.sound.flute.rebuild_the_flute_body_finger': '\u6309\u624b\u673a\u7ad6\u5c4f\u91cd\u6392\u957f\u7b1b\u673a\u8eab\u3001\u6309\u5b54\u548c\u97f3\u9636\u6309\u94ae\uff0c\u4fdd\u7559\u89e6\u63a7\u4e0e\u5439\u6c14\u4e24\u79cd\u6f14\u594f\u8def\u5f84\u3002',
    ...
    'toolbox.sound.flute.threshold_current': '\u5439\u6c14\u9608\u503c {pct}% \u00b7 \u5f53\u524d {current}%',
    'toolbox.sound.flute.threshold_current_holes': '\u5439\u6c14\u9608\u503c {pct}% \u00b7 \u5f53\u524d {current}% \u00b7 \u6309\u5b54 {holes}',
    ...
    'toolbox.sound.flute.warmer_midrange_and_softer_tail': '\u66f4\u539a\u5b9e\u7684\u4e2d\u9891\u548c\u66f4\u67d4\u548c\u5c3e\u97f3\uff0c\u9002\u5408\u6c1b\u56f4\u94fa\u5e95\u3002',
    'toolbox.sound.flute.wood_flute': '\u6728\u7b1b',
    'toolbox.sound.guitar.ambient_chime': '\u6c1b\u56f4\u6cdb\u97f3',
    'toolbox.sound.guitar.chord_and_capo': '\u548c\u5f26\u4e0e\u53d8\u8c03\u5939',
    'toolbox.sound.guitar.clear_steelcore_tone_tuned_for': '\u6e05\u6670\u6709\u529b\u7684\u94a2\u5f26\u6838\u5fc3\uff0c\u9002\u5408\u8282\u594f\u626b\u5f26\u3002',
    'toolbox.sound.guitar.guitar_settings': '\u5409\u4ed6\u8bbe\u7f6e',
    'toolbox.sound.guitar.guitar_stage': '\u5409\u4ed6\u821e\u53f0',
    'toolbox.sound.guitar.longer_shimmer_and_overtones_for': '\u66f4\u957f\u6cdb\u97f3\u548c\u5c3e\u97f5\uff0c\u9002\u5408\u6c1b\u56f4\u94fa\u5e95\u3002',
    ...
    'toolbox.sound.guitar.pick_a_chord_pluck_or': '\u9009\u5b9a\u548c\u5f26\u540e\u53ef\u76f4\u63a5\u70b9\u5f26\u6216\u6ed1\u626b\uff0c\u53d8\u8c03\u5939\u4f1a\u6574\u4f53\u62ac\u9ad8\u97f3\u9ad8\u3002',
    'toolbox.sound.guitar.pick_position': '\u62e8\u5f26\u4f4d\u7f6e {value}%',
    'toolbox.sound.guitar.resonance': '\u5171\u9e23 {value}%',
    'toolbox.sound.guitar.resonance_shapes_body_response_and': '\u5171\u9e23\u63a7\u5236\u7434\u4f53\u54cd\u5e94\uff0c\u62e8\u5f26\u4f4d\u7f6e\u63a7\u5236\u4eae\u5ea6\u4e0e\u9897\u7c92\u611f\u3002',
    'toolbox.sound.guitar.rounder_and_softer_for_slow': '\u66f4\u5706\u6da6\u67d4\u548c\uff0c\u9002\u5408\u6162\u901f\u5206\u89e3\u548c\u5355\u97f3\u62e8\u594f\u3002',
    'toolbox.sound.guitar.shortens_sustain_and_tightens_upper': '\u5f00\u542f\u540e\u4f1a\u7f29\u77ed\u5ef6\u97f3\uff0c\u66f4\u9002\u5408\u8282\u594f\u578b\u626b\u5f26\u3002',
    'toolbox.sound.guitar.steel_strum': '\u94a2\u5f26\u626b\u5f26',
    'toolbox.sound.guitar.strum_down': '\u4e0b\u626b',
    'toolbox.sound.guitar.strum_up': '\u4e0a\u626b',
    'toolbox.sound.guitar.swipe_vertically_to_strum_tap': '\u7eb5\u5411\u6ed1\u52a8\u53ef\u626b\u5f26\uff1b\u70b9\u6309\u5355\u6839\u7434\u5f26\u53ef\u89e6\u53d1\u5355\u97f3\u62e8\u594f\u3002',
    'toolbox.sound.guitar.tone_shaping': '\u97f3\u8272\u5851\u5f62',
    'toolbox.sound.guitar.swipe_label': '\u6ed1\u626b',
    'toolbox.sound.guitar.strum_label': '\u6ed1\u52a8\u626b\u5f26',
    'toolbox.sound.guitar.phone_layout_sub': '\u624b\u673a\u4f18\u5148\u4fdd\u7559\u4e3b\u626b\u5f26\u533a\u57df\uff0c\u548c\u5f26\u4e0e\u53d8\u8c03\u5939\u6536\u8fdb\u7d27\u51d1\u63a7\u5236\u533a\u3002',
    'toolbox.sound.guitar.desktop_layout_sub': '\u626b\u5f26\u533a\u57df\u4fdd\u6301\u4e3b\u89c6\u89c9\uff0c\u548c\u5f26\u3001\u53d8\u8c03\u5939\u4e0e\u97f3\u8272\u63a7\u5236\u56f4\u7ed5\u5176\u5e03\u5c40\u3002',
    'toolbox.sound.harp.a_minor': 'A\u5c0f\u8c03',
    'toolbox.sound.harp.add9': '\u52a0\u4e5d',
    'toolbox.sound.harp.advanced': '\u9ad8\u7ea7\u5fae\u8c03',
    'toolbox.sound.harp.arpeggio': '\u7435\u97f3\u6a21\u5f0f',
    'toolbox.sound.harp.ascending_sweep': '\u8fde\u7eed\u4e0a\u884c\u626b\u5f26\u3002',
    'toolbox.sound.harp.aurora': '\u6781\u5149',
    'toolbox.sound.harp.auto_arpeggio': '\u81ea\u52a8\u7435\u97f3',
    'toolbox.sound.harp.balanced_and_soft': '\u5e73\u8861\u67d4\u548c\u3002',
    'toolbox.sound.harp.balanced_sustain_for_melodic_passages': '\u9002\u5408\u65cb\u5f8b\u7ebf\u6761\u7684\u5e73\u8861\u5ef6\u97f3\u3002',
    ...
    'toolbox.sound.harp.chord_root': '\u548c\u5f26\u6839\u97f3 {current} / {total}',
    'toolbox.sound.harp.clear_attack_for_active_strum': '\u8d77\u97f3\u66f4\u6e05\u695a\uff0c\u9002\u5408\u626b\u5f26\u3002',
    ...
    'toolbox.sound.harp.damping_sweep_deadzone_and_chord': '\u963b\u5c3c\u3001\u626b\u5f26\u6b7b\u533a\u4e0e\u548c\u5f26\u6839\u97f3\u3002',
    ...
    'toolbox.sound.harp.high_realism_presets': '\u9ad8\u771f\u5b9e\u5ea6\u9884\u8bbe',
    ...
    'toolbox.sound.harp.more_body_and_slower_tail': '\u66f4\u539a\u5b9e\u3001\u5c3e\u97f3\u66f4\u6162\u3002',
    'toolbox.sound.harp.muted': '\u9759\u97f3',
    'toolbox.sound.harp.nylon': '\u5c3c\u9f99',
    'toolbox.sound.harp.palette': '\u4e3b\u9898',
    'toolbox.sound.harp.pedal_harp': '\u8e0f\u677f\u7ad6\u7434',
    'toolbox.sound.harp.pedalharp_like_balance_and_sustain': '\u63a5\u8fd1\u8e0f\u677f\u7ad6\u7434\u7684\u5747\u8861\u5ef6\u97f3\u3002',
    'toolbox.sound.harp.preset': '\u9884\u8bbe',
    'toolbox.sound.harp.pulse_active_chord_tones': '\u8109\u51b2\u5f39\u594f\u5f53\u524d\u548c\u5f26\u97f3\u3002',
    'toolbox.sound.harp.reverb': '\u6b8b\u54cd',
    'toolbox.sound.harp.reverb_2': '\u6b8b\u54cd {value}%',
    'toolbox.sound.harp.round_body_with_controlled_hall': '\u5706\u6da6\u7434\u4f53\u4e0e\u53d7\u63a7\u5385\u5802\u5c3e\u97f3\u3002',
    'toolbox.sound.harp.round_body_with_light_transient': '\u5706\u6da6\u67d4\u548c\uff0c\u77ac\u6001\u8f83\u8f7b\u3002',
    'toolbox.sound.harp.scale_harmony': '\u8c03\u5f0f\u4e0e\u548c\u58f0',
    'toolbox.sound.harp.sharper_upper_harmonics': '\u9ad8\u9891\u66f4\u4eae\uff0c\u9897\u7c92\u66f4\u6e05\u6670\u3002',
    'toolbox.sound.harp.silk': '\u4e1d\u7ef8',
    'toolbox.sound.harp.soft_fingerpluck_with_gentle_bloom': '\u67d4\u548c\u62e8\u5f26\uff0c\u4f59\u97f5\u8212\u5c55\u3002',
    'toolbox.sound.harp.sound_on': '\u58f0\u97f3\u5f00',
    'toolbox.sound.harp.steel': '\u94a2\u5f26',
    'toolbox.sound.harp.steel_studio': '\u94a2\u5f26\u5f55\u97f3\u68da',
    'toolbox.sound.harp.stronger_core_and_brighter_attack': '\u6838\u5fc3\u66f4\u5f3a\uff0c\u62e8\u5f26\u66f4\u4eae\u3002',
    'toolbox.sound.harp.sus2': '\u6302\u4e8c',
    'toolbox.sound.harp.sus4': '\u6302\u56db',
    'toolbox.sound.harp.sweep_deadzone_px': '\u626b\u5f26\u6b7b\u533a {value} px',
    'toolbox.sound.harp.tap_a_note_then_glide': '\u8f7b\u89e6\u5355\u97f3\uff0c\u987a\u7740\u7434\u5f26\u6ed1\u52a8\u53ef\u626b\u5f26\u3002',
    'toolbox.sound.harp.tap_for_single_note_swipe': 'Tap for single note, swipe for sweep.',
    'toolbox.sound.harp.theme_timbre': '\u4e3b\u9898\u4e0e\u97f3\u8272',
    'toolbox.sound.harp.thin_body_and_sparkling_top': '\u66f4\u8584\u66f4\u4eae\uff0c\u6cdb\u97f3\u95ea\u70c1\u3002',
    'toolbox.sound.harp.tight_transient_and_clear_note': '\u77ac\u6001\u7d27\u81f4\uff0c\u97f3\u7b26\u5206\u79bb\u6e05\u6670\u3002',
    'toolbox.sound.harp.timbre': '\u97f3\u8272',
    'toolbox.sound.harp.timbre_scale_chord_and_feel': '\u97f3\u8272\u3001\u8c03\u5f0f\u3001\u548c\u5f26\u4e0e\u624b\u611f\u5df2\u6536\u5165\u53e3\u5e95\u677f\u3002',
    'toolbox.sound.harp.up_then_down': '\u5148\u4e0a\u884c\u518d\u4e0b\u884c\u3002',
    ...
    'toolbox.sound.triangle.balanced_brightness_and_decay_close': '\u660e\u4eae\u4e0e\u5ef6\u97f3\u66f4\u5e73\u8861\uff0c\u66f4\u63a5\u8fd1\u7ba1\u5f26\u8bed\u5883\u3002',
    'toolbox.sound.triangle.brass': '\u9ec4\u94dc',
    'toolbox.sound.triangle.bright_ring': '\u660e\u4eae\u632f\u94c3',
    'toolbox.sound.triangle.brighter_attack_and_stronger_ring': '\u66f4\u4eae\u66f4\u8106\uff0c\u5c3e\u97f3\u66f4\u660e\u663e\uff0c\u9002\u5408\u5f3a\u8c03\u62cd\u70b9\u3002',
    'toolbox.sound.triangle.damping': '\u963b\u5c3c {value}%',
    'toolbox.sound.triangle.left_is_softer_right_is': '\u5de6\u4fa7\u66f4\u67d4\uff0c\u53f3\u4fa7\u66f4\u4eae\uff1b\u6eda\u594f\u6a21\u5f0f\u9002\u5408\u8fde\u7eed\u7d27\u51d1\u7684\u5f3a\u8c03\u3002',
    'toolbox.sound.triangle.left_softer': '\u5de6\u4fa7\u66f4\u67d4',
    'toolbox.sound.triangle.material_shapes_overtones_while_strike': '\u6750\u8d28\u51b3\u5b9a\u6cdb\u97f3\u8d28\u611f\uff0c\u6572\u51fb\u70b9\u548c\u963b\u5c3c\u51b3\u5b9a\u8106\u5ea6\u4e0e\u5c3e\u97f3\u957f\u5ea6\u3002',
    'toolbox.sound.triangle.orchestral_ring': '\u7ba1\u5f26\u632f\u94c3',
    'toolbox.sound.triangle.presets_move_tone_material_and': '\u9884\u8bbe\u4f1a\u8054\u52a8\u97f3\u8272\u3001\u9ed8\u8ba4\u6750\u8d28\u548c\u5ef6\u97f3\u957f\u5ea6\u3002',
    ...
    'toolbox.sound.triangle.softer_highs_and_a_shorter': '\u66f4\u67d4\u548c\u7684\u9ad8\u9891\u548c\u66f4\u77ed\u7684\u5c3e\u97f3\uff0c\u9002\u5408\u8f7b\u8282\u594f\u70b9\u7f00\u3002',
    ...
    'toolbox.sound.triangle.tap_directly_on_the_triangle': '\u76f4\u63a5\u5728\u4e09\u89d2\u94c1\u753b\u9762\u4e0a\u70b9\u6309\uff1a\u5de6\u67d4\u53f3\u4eae\uff0c\u6a21\u5f0f\u51b3\u5b9a\u662f\u5355\u51fb\u3001\u91cd\u51fb\u8fd8\u662f\u6eda\u594f\u3002',
    'toolbox.sound.triangle.tone_and_decay': '\u97f3\u8272\u4e0e\u8870\u51cf',
    'toolbox.sound.triangle.triangle_settings': '\u4e09\u89d2\u94c1\u8bbe\u7f6e',
    'toolbox.sound.violin.a_woody': 'A \u6728\u8d28',
    'toolbox.sound.violin.ab_voicing': 'A/B \u5fae\u8c03',
    'toolbox.sound.violin.b_bright': 'B \u4eae\u5f13',
    'toolbox.sound.violin.balanced_solo_tone_for_melodic': '\u5e73\u8861\u7684\u72ec\u594f\u97f3\u8272\uff0c\u9002\u5408\u65cb\u5f8b\u6ed1\u97f3\u3002',
    'toolbox.sound.violin.bow_and_space': '\u5f13\u538b\u4e0e\u7a7a\u95f4',
    'toolbox.sound.violin.bow_tone': '\u5f13\u538b {pct}% \u00b7 \u97f3\u8272 {tone} \u00b7 {variant}',
    'toolbox.sound.violin.brighter_harmonics_with_a_cleaner': '\u66f4\u4eae\u7684\u6cdb\u97f3\u548c\u66f4\u6e05\u6670\u7684\u524d\u7f18\uff0c\u9002\u5408\u7a7a\u7075\u94fa\u5e95\u3002',
    'toolbox.sound.violin.chromatic': '\u534a\u97f3\u9636',
    'toolbox.sound.violin.expose_bow_pressure_and_reverb': '\u5f00\u653e\u5f13\u538b\u548c\u6b8b\u54cd\u53c2\u6570\uff0c\u65b9\u4fbf\u628a\u72ec\u594f\u611f\u4e0e\u7a7a\u95f4\u611f\u62c6\u5f00\u63a7\u5236\u3002',
    ...
    'toolbox.sound.violin.softer_bow_pressure_with_a': '\u66f4\u67d4\u548c\u7684\u5f13\u538b\u548c\u66f4\u957f\u7684\u5c3e\u97f3\uff0c\u9002\u5408\u6162\u901f\u6b4c\u5531\u6027\u65cb\u5f8b\u3002',
    'toolbox.sound.violin.solo': '\u72ec\u594f',
    'toolbox.sound.violin.solo_bow': '\u72ec\u594f\u8fd0\u5f13',
    'toolbox.sound.violin.strings': '\u5f26\u6570',
    'toolbox.sound.violin.two_fingers_enable_doublestop': '\u53cc\u6307\u53ef\u89e6\u53d1\u53cc\u97f3',
    'toolbox.sound.violin.use_scale_categories_and_position': '\u7528\u8c03\u5f0f\u5206\u7c7b\u548c\u628a\u4f4d\u7a97\u53e3\u63a7\u5236\u624b\u673a\u5c4f\u5e55\u4e2d\u7684\u6709\u6548\u6f14\u594f\u533a\u95f4\u3002',
    'toolbox.sound.violin.variant_a_is_woodier_and': 'A \u7248\u7434\u4f53\u66f4\u539a\u3001\u66f4\u6728\u8d28\uff0c\u9002\u5408\u81ea\u7136\u72ec\u594f\u4e0e\u6162\u901f\u65cb\u5f8b\u3002',
    'toolbox.sound.violin.variant_b_is_brighter_and': 'B \u7248\u524d\u7f18\u66f4\u4eae\u3001\u66f4\u9760\u524d\uff0c\u9002\u5408\u7a7f\u900f\u611f\u66f4\u5f3a\u7684\u72ec\u594f\u3002',
    'toolbox.sound.violin.violin_settings': '\u5c0f\u63d0\u7434\u8bbe\u7f6e',
    'toolbox.sound.violin.warm': '\u67d4\u6696',
    'toolbox.sound.violin.warm_legato': '\u6e29\u6696\u8fde\u5f13',
    'toolbox.sound.violin.phone_subtitle': '\u624b\u673a\u4e0a\u652f\u6301\u70b9\u6309\u8d77\u5f13\u3001\u6ed1\u52a8\u6362\u97f3\uff0c\u62ac\u624b\u5373\u505c\uff0c\u4f18\u5148\u4fdd\u8bc1\u6f14\u594f\u8fde\u8d2f\u3002',
    'toolbox.sound.violin.desktop_subtitle': '\u6a2a\u5411\u6ed1\u52a8\u6539\u53d8\u91cf\u9ad8\uff0c\u7eb5\u5411\u5207\u6362\u5f26\u4f4d\uff1b\u73b0\u5728\u652f\u6301\u70b9\u6309\u5373\u53d1\u58f0\u3001\u62ac\u624b\u5373\u505c\u3002',

    // B4: \u4e13\u6ce8\u8282\u62cd (sound)
    'toolbox.sound.focus.controlTempo': '\u901f\u5ea6',
    'toolbox.sound.focus.controlTempoDesc': '\u8c03\u6574 BPM\uff0c\u7528\u5feb\u6377\u6309\u94ae\u5fae\u8c03\u8282\u594f\u3002',
    'toolbox.sound.focus.controlMeter': '\u62cd\u53f7',
    'toolbox.sound.focus.controlMeterDesc': '\u51b3\u5b9a\u5f3a\u5f31\u62cd\u7ed3\u6784\u4e0e\u5207\u5206\u5bc6\u5ea6\u3002',
    'toolbox.sound.focus.controlTimbre': '\u62cd\u70b9\u97f3\u8272',
    'toolbox.sound.focus.controlTimbreDesc': '\u9009\u62e9\u62cd\u70b9\u6572\u51fb\u7684\u58f0\u97f3\u8d28\u611f\u3002',
    'toolbox.sound.focus.controlArrangement': '\u62cd\u6bb5\u7ec4\u5408',
    'toolbox.sound.focus.controlArrangementDesc': '\u6309\u5c0f\u8282\u7f16\u7ec4\u5f62\u6210\u6bb5\u843d\uff0c\u8ba9\u8282\u594f\u66f4\u6709\u5c42\u6b21\u3002',
    'toolbox.sound.focus.singleBarLoop': '\u5355\u5c0f\u8282',
    'toolbox.sound.focus.controlMix': '\u6df7\u97f3\u4e0e\u89e6\u611f',
    'toolbox.sound.focus.controlMixDesc': '\u5206\u522b\u8c03\u6574\u91cd\u62cd\u3001\u666e\u901a\u62cd\u3001\u5b50\u62cd\u4e0e\u632f\u52a8\u5f3a\u5ea6\u3002',
    'toolbox.sound.focus.controlMixDesc2': '\u7cbe\u7ec6\u8c03\u6574\u91cd\u62cd\u3001\u666e\u901a\u62cd\u3001\u5b50\u62cd\u4e0e\u89e6\u611f\u632f\u52a8\u3002',
    ...
    'toolbox.sound.focus.controlOpenControls': '\u6253\u5f00\u63a7\u5236\u9762\u677f',
    ...
    'toolbox.sound.focus.controlTapHint': '\u8f7b\u89e6\u753b\u9762\u5f00\u59cb\u6216\u505c\u6b62\uff0c\u4fdd\u6301\u4e13\u6ce8\u8282\u594f\u3002',
    ...
    'toolbox.sound.focus.immersiveControlsDesc': '\u8f7b\u89e6\u5e95\u90e8\u8fb9\u7f18\u5373\u53ef\u5524\u51fa\u63a7\u5236\u9762\u677f\uff0c\u65e0\u9700\u9000\u51fa\u5168\u5c4f\u3002',
    ...
    'toolbox.sound.focus.immersiveHint': '\u8f7b\u89e6\u5f00\u59cb\u8282\u62cd\uff0c\u8ddf\u968f\u8282\u594f\u8fdb\u5165\u4e13\u6ce8\u3002',
    ...
    'toolbox.sound.focus.meterDesc': '\u62cd\u53f7\u51b3\u5b9a\u5f3a\u5f31\u62cd\u7ed3\u6784\uff0c\u5b50\u62cd\u51b3\u5b9a\u6bcf\u62cd\u5185\u90e8\u5207\u5206\uff1b\u4e24\u8005\u5171\u540c\u5f71\u54cd\u8282\u594f\u63a8\u8fdb\u548c\u62cd\u6bb5\u7ec4\u5408\u3002',
    'toolbox.sound.focus.meterSubDiv': '\u5b50\u62cd \u00d7{div}',
    'toolbox.sound.focus.styleDesc': '\u52a8\u753b\u4e0e\u97f3\u8272\u9ed8\u8ba4\u63a8\u8350\u642d\u914d\uff0c\u4e5f\u53ef\u4ee5\u81ea\u7531\u6df7\u642d\u3002',
    'toolbox.sound.focus.previewButton': '\u8bd5\u542c',
    'toolbox.sound.focus.styleTimbreTitle': '\u62cd\u70b9\u97f3\u8272',
    'toolbox.sound.focus.arrangementEnabled': '\u62cd\u6bb5\u7ec4\u5408\u5df2\u5f00\u542f',
    'toolbox.sound.focus.arrangementSingleBar': '\u5355\u5c0f\u8282',
    'toolbox.sound.focus.arrangementLabel': '\u5f53\u524d\u62cd\u6bb5\uff1a{label}\uff08\u5171 {total} \u62cd\uff09',
    'toolbox.sound.focus.editButton': '\u7f16\u8f91',
    'toolbox.sound.focus.arrangementDesc': '\u901a\u8fc7\u5c0f\u8282\u7f16\u7ec4\u8ba9\u89c6\u89c9\u548c\u97f3\u8272\u5728\u5b8c\u6574\u5468\u671f\u4e2d\u5f62\u6210\u66f4\u660e\u663e\u7684\u6bb5\u843d\u611f\u3002',
    ...
    'toolbox.sound.focus.mixHapticDesc': '\u5728\u91cd\u62cd\u548c\u6bb5\u843d\u5207\u6362\u65f6\u63d0\u4f9b\u8f7b\u5fae\u632f\u52a8\u63d0\u793a\u3002',

    // --- toolbox hub (B2: Chinese) ---
    'toolbox.hub.page.title': '\u5de5\u5177\u7bb1',
    'toolbox.hub.page.subtitle': '\u6d4f\u89c8\u3001\u6574\u7406\u548c\u4e2a\u6027\u5316\u4f60\u7684\u5065\u5eb7\u5de5\u5177\u7bb1\u3002',
    'toolbox.hub.page.section_title': '\u53ef\u7528\u5de5\u5177',
    'toolbox.hub.intro.title_idle': '\u4f60\u7684\u5065\u5eb7\u5de5\u5177\u7bb1',
    'toolbox.hub.intro.summary_idle': '\u5feb\u901f\u8bbf\u95ee\u7761\u7720\u3001\u4e13\u6ce8\u3001\u97f3\u7597\u548c\u51a5\u60f3\u5de5\u5177\u3002',
    'toolbox.hub.intro.details_idle': '\u70b9\u51fb\u4efb\u610f\u5de5\u5177\u5373\u53ef\u6253\u5f00\u3002\u5c06\u6761\u76ee\u62d6\u5165\u5feb\u6377\u9762\u677f\u53ef\u5b9e\u73b0\u4e00\u952e\u8bbf\u95ee\u3002',
    'toolbox.hub.intro.title_editing': '\u81ea\u5b9a\u4e49\u4f60\u7684\u5de5\u5177\u7bb1',
    'toolbox.hub.intro.summary_editing': '\u9690\u85cf\u4e0d\u5e38\u7528\u7684\u5de5\u5177\uff0c\u91cd\u65b0\u6392\u5e8f\u4f60\u7684\u6536\u85cf\uff0c\u56fa\u5b9a\u5feb\u6377\u65b9\u5f0f\u3002',
    'toolbox.hub.intro.details_editing': '\u70b9\u51fb\u773c\u775b\u56fe\u6807\u9690\u85cf\u6216\u6062\u590d\u3002\u62d6\u52a8\u624b\u67c4\u91cd\u65b0\u6392\u5e8f\u3002\u56fa\u5b9a\u7684\u6761\u76ee\u4f1a\u663e\u793a\u5728\u9876\u90e8\u3002',
    'toolbox.hub.intro.highlight_edit': '\u9690\u85cf\u6216\u663e\u793a\u5de5\u5177\u4ee5\u5339\u914d\u4f60\u7684\u65e5\u5e38\u8282\u594f\u3002',
    'toolbox.hub.intro.highlight_reorder': '\u62d6\u62fd\u6392\u5e8f\uff0c\u8ba9\u5e38\u7528\u5de5\u5177\u89e6\u624b\u53ef\u53ca\u3002',
    'toolbox.hub.intro.highlight_shortcuts': '\u5c06\u6700\u5e38\u7528\u7684\u5de5\u5177\u56fa\u5b9a\u5230\u5feb\u6377\u9762\u677f\u3002',
    'toolbox.hub.intro.highlight_restorable': '\u9690\u85cf\u7684\u5de5\u5177\u5e76\u672a\u5220\u9664\u2014\u2014\u4e00\u952e\u5373\u53ef\u6062\u590d\u3002',
    'toolbox.hub.intro.help_tooltip': '\u5982\u4f55\u4f7f\u7528\u5de5\u5177\u7bb1',
    ...
    'toolbox.hub.edit.confirm_remove_desc': '\u6b64\u5de5\u5177\u5c06\u4ece\u5de5\u5177\u7bb1\u4e2d\u9690\u85cf\u3002\u4f60\u53ef\u4ee5\u968f\u65f6\u4ece\u7f16\u8f91\u9762\u677f\u6062\u590d\u5b83\u3002',
    ...
    'toolbox.hub.edit.layout_instructions': '\u70b9\u51fb\u773c\u775b\u56fe\u6807\u663e\u793a\u6216\u9690\u85cf\u5de5\u5177\u3002\u62d6\u52a8\u624b\u67c4\u91cd\u65b0\u6392\u5e8f\u3002',
    ...
    'toolbox.hub.edit.empty_desc_no_hidden': '\u6240\u6709\u53ef\u7528\u5de5\u5177\u5f53\u524d\u5747\u53ef\u89c1\u3002\u8981\u9690\u85cf\u5de5\u5177\uff0c\u8bf7\u70b9\u51fb\u5176\u540d\u79f0\u65c1\u8fb9\u7684\u773c\u775b\u56fe\u6807\u3002',
    'toolbox.hub.edit.empty_desc_has_hidden': '\u90e8\u5206\u5de5\u5177\u5f53\u524d\u5df2\u9690\u85cf\u3002\u4f7f\u7528\u4e0b\u65b9\u9690\u85cf\u533a\u57df\u6765\u6062\u590d\u5b83\u4eec\u3002',
    'toolbox.hub.edit.empty_hidden_count': '\u6709 {count} \u4e2a\u9690\u85cf\u5de5\u5177\u53ef\u7528',
    'toolbox.hub.edit.empty_edit_button': '\u6253\u5f00\u7f16\u8f91\u9762\u677f',
    'toolbox.hub.edit.restore_section_title': '\u9690\u85cf\u7684\u5de5\u5177',
    'toolbox.hub.edit.restore_notice': '\u70b9\u51fb\u773c\u775b\u56fe\u6807\u6765\u6062\u590d\u9690\u85cf\u7684\u5de5\u5177\u3002',
    'toolbox.hub.edit.restore_action': '\u6062\u590d',

    'toolbox.hub.section.sleep.title': '\u7761\u7720',
    'toolbox.hub.section.sleep.subtitle': '\u7761\u7720\u8bc4\u4f30\u3001\u8bb0\u5f55\u3001\u7761\u524d\u653e\u677e\u4e0e\u591c\u9192\u5b89\u629a\u6307\u5357\u3002',
    'toolbox.hub.section.games.title': '\u8ff7\u4f60\u6e38\u620f',
    'toolbox.hub.section.games.subtitle': '\u8f7b\u5ea6\u8ba4\u77e5\u6d3b\u52a8\uff0c\u5e2e\u52a9\u8f6c\u79fb\u6ce8\u610f\u529b\u548c\u653e\u677e\u3002',
    'toolbox.hub.section.tests.title': '\u4eba\u7c7b\u6d4b\u8bd5',
    'toolbox.hub.section.tests.subtitle': '\u8ba4\u77e5\u4e0e\u884c\u4e3a\u6a21\u5f0f\u7684\u81ea\u6211\u8bc4\u4f30\u5de5\u5177\u3002',
    'toolbox.hub.section.sound.title': '\u58f0\u97f3\u4e0e\u97f3\u4e50',
    'toolbox.hub.section.sound.subtitle': '\u8212\u7f13\u8f7b\u97f3\u3001\u7a7a\u7075\u97f3\u94b5\u3001\u7ad6\u7434\u3001\u5409\u4ed6\u3001\u957f\u7b1b\u7b49\u3002',
    'toolbox.hub.section.focus.title': '\u4e13\u6ce8\u4e0e\u6ce8\u610f\u529b',
    'toolbox.hub.section.focus.subtitle': '\u8212\u5c14\u7279\u65b9\u683c\u3001\u547c\u5438\u5f15\u5bfc\u4e0e\u6ce8\u610f\u529b\u8bad\u7ec3\u3002',
    'toolbox.hub.section.calm.title': '\u51a5\u60f3\u4e0e\u653e\u677e',
    'toolbox.hub.section.calm.subtitle': '\u9759\u5fc3\u5ff5\u73e0\u3001\u6307\u5c16\u6c99\u753b\u4e0e\u6b63\u5ff5\u5de5\u5177\u3002',
    'toolbox.hub.section.life.title': '\u751f\u6d3b\u5b9e\u7528',
    'toolbox.hub.section.life.subtitle': '\u65e5\u5e38\u5b9e\u7528\u5de5\u5177\u4e0e\u751f\u6d3b\u65b9\u5f0f\u52a9\u624b\u3002',
    'toolbox.hub.section.crypto.title': '\u52a0\u5bc6\u4e0e\u5b89\u5168',
    'toolbox.hub.section.crypto.subtitle': '\u52a0\u5bc6\u3001\u54c8\u5e0c\u4e0e\u5b89\u5168\u5b9e\u7528\u5de5\u5177\u3002',
    'toolbox.hub.section.decision.title': '\u51b3\u7b56\u52a9\u624b',
    'toolbox.hub.section.decision.subtitle': '\u5316\u89e3\u9009\u62e9\u56f0\u96be\uff0c\u8ba9\u65e5\u5e38\u7ea0\u7ed3\u53d8\u5f97\u8f7b\u677e\u3002',

    'toolbox.hub.entry.sleep_assistant.title': '\u7761\u7720\u52a9\u624b',
    'toolbox.hub.entry.sleep_assistant.subtitle': '\u4e2a\u6027\u5316\u8bc4\u4f30\u3001\u6539\u5584\u8ba1\u5212\u4e0e\u591c\u95f4\u6307\u5bfc\u3002',
    'toolbox.hub.entry.games.title': '\u8ff7\u4f60\u6e38\u620f',
    'toolbox.hub.entry.games.subtitle': '\u5feb\u901f\u8ba4\u77e5\u5c0f\u6e38\u620f\uff0c\u5e2e\u52a9\u8f6c\u79fb\u6ce8\u610f\u529b\u3002',
    'toolbox.hub.entry.tests.title': '\u4eba\u7c7b\u6d4b\u8bd5',
    'toolbox.hub.entry.tests.subtitle': '\u8ba4\u77e5\u4e0e\u884c\u4e3a\u81ea\u6211\u8bc4\u4f30\u3002',
    'toolbox.hub.entry.soothing.title': '\u8212\u7f13\u8f7b\u97f3',
    'toolbox.hub.entry.soothing.subtitle': '\u7cbe\u9009\u7597\u6108\u7cfb\u8f7b\u97f3\u4e50\u4e0e\u52a8\u6001\u547c\u5438\u5149\u6548\u3002',
    'toolbox.hub.entry.harp.title': '\u7ad6\u7434\u4e0e\u5f26\u4e50',
    'toolbox.hub.entry.harp.subtitle': '\u6f14\u594f\u7ad6\u7434\u3001\u5409\u4ed6\u3001\u5c0f\u63d0\u7434\u3001\u957f\u7b1b\u548c\u4e09\u89d2\u94c1\u3002',
    'toolbox.hub.entry.bowls.title': '\u7a7a\u7075\u97f3\u94b5',
    'toolbox.hub.entry.bowls.subtitle': '\u5341\u4e00\u7ec4\u81ea\u7136\u9891\u7387\u4e0e\u56db\u79cd\u94b5\u4f53\u97f3\u8272\u3002',
    'toolbox.hub.entry.locator.title': '\u58f0\u6e90\u5b9a\u4f4d',
    'toolbox.hub.entry.locator.subtitle': '\u4f7f\u7528\u624b\u673a\u9ea6\u514b\u98ce\u5b9a\u4f4d\u5e76\u786e\u8ba4\u58f0\u6e90\u3002',
    'toolbox.hub.entry.beats.title': '\u4e13\u6ce8\u8282\u62cd',
    'toolbox.hub.entry.beats.subtitle': '\u7528\u6709\u8282\u594f\u7684\u97f3\u9891\u63d0\u793a\uff0c\u966a\u4f34\u4f60\u7684\u4e13\u6ce8\u65f6\u5149\u3002',
    'toolbox.hub.entry.woodfish.title': '\u8d5b\u535a\u6728\u9c7c',
    'toolbox.hub.entry.woodfish.subtitle': '\u7535\u5b50\u6728\u9c7c\uff0c\u5b89\u5fc3\u89e3\u538b\u7684\u8282\u5f8b\u6572\u51fb\u3002',
    'toolbox.hub.entry.schulte.title': '\u8212\u5c14\u7279\u65b9\u683c',
    'toolbox.hub.entry.schulte.subtitle': '\u7ecf\u5178\u6ce8\u610f\u529b\u8bad\u7ec3\uff0c\u8ffd\u8e2a\u901f\u5ea6\u4e0e\u51c6\u786e\u5ea6\u3002',
    'toolbox.hub.entry.breathing.title': '\u547c\u5438\u5f15\u5bfc',
    'toolbox.hub.entry.breathing.subtitle': '\u5e26\u53ef\u89c6\u5316\u8282\u594f\u7684\u5f15\u5bfc\u547c\u5438\u7ec3\u4e60\u3002',
    'toolbox.hub.entry.beads.title': '\u9759\u5fc3\u5ff5\u73e0',
    'toolbox.hub.entry.beads.subtitle': '\u6307\u5c16\u8f7b\u62e8\u5ff5\u73e0\uff0c\u5728\u5b89\u5b81\u8282\u594f\u4e2d\u6c89\u6dc0\u5fc3\u7eea\u3002',
    'toolbox.hub.entry.zen.title': '\u6307\u5c16\u6c99\u753b',
    'toolbox.hub.entry.zen.subtitle': '\u4ee5\u6307\u4e3a\u7b14\u3001\u4ee5\u6c99\u4e3a\u7eb8\uff0c\u5728\u65b9\u5bf8\u4e4b\u95f4\u653e\u677e\u5fc3\u5883\u3002',
    'toolbox.hub.entry.life.title': '\u751f\u6d3b\u5b9e\u7528',
    'toolbox.hub.entry.life.subtitle': '\u65e5\u5e38\u751f\u6d3b\u7684\u5b9e\u7528\u5de5\u5177\u3002',
    'toolbox.hub.entry.crypto.title': '\u52a0\u5bc6\u5b89\u5168',
    'toolbox.hub.entry.crypto.subtitle': '\u52a0\u5bc6\u3001\u54c8\u5e0c\u4e0e\u6570\u636e\u5b89\u5168\u5de5\u5177\u3002',
    'toolbox.hub.entry.decision.title': '\u6bcf\u65e5\u51b3\u7b56',
    'toolbox.hub.entry.decision.subtitle': '\u628a\u65e5\u5e38\u5c0f\u7ea0\u7ed3\u53d8\u6210\u53ef\u968f\u673a\u3001\u53ef\u7f16\u8f91\u3001\u53ef\u56de\u770b\u7684\u8f7b\u91cf\u9009\u62e9\u3002',

    'toolbox.hub.quick.title': '\u5feb\u6377\u8bbf\u95ee',
    'toolbox.hub.quick.release_hint': '\u62d6\u653e\u5230\u6b64\u5904\u4ee5\u56fa\u5b9a',
    'toolbox.hub.quick.manage': '\u7ba1\u7406',
    'toolbox.hub.quick.empty_hint': '\u5c06\u5de5\u5177\u62d6\u5230\u6b64\u5904\u5b9e\u73b0\u4e00\u952e\u8bbf\u95ee\u3002\u70b9\u51fb"\u7ba1\u7406"\u9009\u62e9\u4f60\u7684\u5feb\u6377\u65b9\u5f0f\u3002',
    'toolbox.hub.quick.choose_title': '\u9009\u62e9\u5feb\u6377\u5165\u53e3',
    'toolbox.hub.quick.choose_desc': '\u9009\u62e9\u4f60\u60f3\u8981\u5728\u5feb\u6377\u9762\u677f\u4e2d\u663e\u793a\u7684\u5de5\u5177\u3002',
    ...
    'toolbox.sleep.core.disabled': '\u7761\u7720\u6a21\u5757\u5f53\u524d\u5df2\u7981\u7528\u3002',
    'toolbox.sleep.core.disabledHint': '\u8bf7\u5728\u8bbe\u7f6e\u4e2d\u542f\u7528\u7761\u7720\u6a21\u5757\u4ee5\u4f7f\u7528\u6b64\u529f\u80fd\u3002',
    ...
    'toolbox.sleep.assist.locatorPlanHint': '\u8ffd\u8e2a\u4f60\u5f53\u524d\u7684\u884c\u52a8\u8ba1\u5212\u548c\u8fdb\u5c55\u3002',
    'toolbox.sleep.assist.locatorLoop': '\u7761\u7720\u5faa\u73af',
    'toolbox.sleep.assist.locatorLoopHint': '\u4eca\u665a\u548c\u660e\u5929\u65e9\u4e0a\u7684\u5feb\u901f\u64cd\u4f5c\u3002',
    'toolbox.sleep.assist.locatorMore': '\u66f4\u591a\u64cd\u4f5c',
    'toolbox.sleep.assist.locatorMoreHint': '\u5de5\u5177\u3001\u5efa\u8bae\u548c\u66f4\u6df1\u5c42\u7684\u8c03\u6574\u3002',
    'toolbox.sleep.assist.locatorAdvice': '\u76f4\u63a5\u5efa\u8bae',
    'toolbox.sleep.assist.locatorAdviceHint': '\u57fa\u4e8e\u4f60\u7684\u6570\u636e\u63d0\u4f9b\u7684\u4e2a\u6027\u5316\u5efa\u8bae\u3002',
    'toolbox.sleep.assist.locatorTrend': '7\u65e5\u8d8b\u52bf',
    'toolbox.sleep.assist.locatorTrendHint': '\u67e5\u770b\u8fc7\u53bb\u4e00\u5468\u4f60\u7684\u7761\u7720\u6a21\u5f0f\u3002',
    'toolbox.sleep.assist.locatorScience': '\u79d1\u5b66\u5361\u7247',
    'toolbox.sleep.assist.locatorScienceHint': '\u57fa\u4e8e\u8bc1\u636e\u7684\u7761\u7720\u77e5\u8bc6\u548c\u6280\u5de7\u3002',
    'toolbox.sleep.assist.subtitle': '\u4f60\u7684\u4e2a\u4eba\u7761\u7720\u6307\u5357\u2014\u2014\u8bc4\u4f30\u3001\u8ffd\u8e2a\u4e0e\u591c\u95f4\u652f\u6301\u3002',
    'toolbox.sleep.assist.morningSame': '\u548c\u5e73\u65f6\u4e00\u6837',
    'toolbox.sleep.assist.morningWorse': '\u6bd4\u5e73\u65f6\u5dee',
    'toolbox.sleep.assist.morningBetter': '\u6bd4\u5e73\u65f6\u597d',
    'toolbox.sleep.assist.morningSavedSame': '\u6668\u95f4\u7b7e\u5230\u5df2\u4fdd\u5b58\u3002',
    'toolbox.sleep.assist.morningSavedWorse': '\u6668\u95f4\u7b7e\u5230\u5df2\u4fdd\u5b58\u2014\u2014\u4eca\u5929\u653e\u8f7b\u677e\u3002',
    'toolbox.sleep.assist.morningSavedBetter': '\u6668\u95f4\u7b7e\u5230\u5df2\u4fdd\u5b58\u2014\u2014\u597d\u7684\u5f00\u59cb\uff01',
    'toolbox.sleep.assist.recentRescue': '\u6700\u8fd1\u591c\u9192\u8bb0\u5f55',
    'toolbox.sleep.assist.leftBedRecorded': '\u5df2\u8bb0\u5f55\u79bb\u5e8a\u4e8b\u4ef6\u3002',
    'toolbox.sleep.assist.tinyRoutineUsed': '\u6700\u8fd1\u4f7f\u7528\u4e86\u7b80\u6613\u653e\u677e\u6d41\u7a0b\u3002',
    'toolbox.sleep.assist.lateScreenClue': '\u8fd1\u671f\u65e5\u5fd7\u4e2d\u68c0\u6d4b\u5230\u665a\u7761\u5c4f\u5e55\u4f7f\u7528\u3002',
    ...
    'toolbox.sleep.assist.darkModeHint': '\u8c03\u6697\u5c4f\u5e55\u5e76\u51cf\u5c11\u84dd\u5149\u4ee5\u9002\u5408\u591c\u95f4\u4f7f\u7528\u3002',
    'toolbox.sleep.assist.currentPlan': '\u5f53\u524d\u8ba1\u5212',
    'toolbox.sleep.assist.currentPlanHint': '\u4f60\u6b63\u5728\u8fdb\u884c\u7684\u7761\u7720\u6539\u5584\u65b9\u6848\u3002',
    'toolbox.sleep.assist.sleepLoop': '\u7761\u7720\u5faa\u73af',
    'toolbox.sleep.assist.sleepLoopSub': '\u4eca\u665a\u548c\u660e\u65e9\uff0c\u4e00\u7ad9\u5f0f\u6d41\u7a0b\u3002',
    'toolbox.sleep.assist.moreActions': '\u66f4\u591a\u64cd\u4f5c',
    'toolbox.sleep.assist.moreActionsHint': '\u5de5\u5177\u3001\u62a5\u8868\u548c\u66f4\u6df1\u5c42\u8bbe\u7f6e\u3002',
    'toolbox.sleep.assist.whiteNoise': '\u767d\u566a\u97f3',
    'toolbox.sleep.assist.morningLightTimer': '\u6668\u5149\u8ba1\u65f6\u5668',
    'toolbox.sleep.assist.caffeineCutoff': '\u5496\u5561\u56e0\u622a\u6b62\u65f6\u95f4',
    ...
    'toolbox.sleep.assist.directAdviceSub': '\u57fa\u4e8e\u4f60\u7684\u7761\u7720\u6570\u636e\u751f\u6210\u7684\u4e2a\u6027\u5316\u5efa\u8bae\u3002',
    'toolbox.sleep.assist.trend7': '7\u65e5\u8d8b\u52bf',
    'toolbox.sleep.assist.trend7Sub': '\u8fc7\u53bb\u4e00\u5468\u4f60\u7684\u7761\u7720\u53d8\u5316\u60c5\u51b5\u3002',
    'toolbox.sleep.assist.setDirection': '\u8bbe\u5b9a\u65b9\u5411',
    'toolbox.sleep.assist.setDirectionHint': '\u9009\u62e9\u4e00\u4e2a\u7761\u7720\u76ee\u6807\u5e76\u83b7\u53d6\u4e2a\u6027\u5316\u8ba1\u5212\u3002',
    'toolbox.sleep.assist.windDown': '\u7761\u524d\u653e\u677e\u6d41\u7a0b',
    'toolbox.sleep.assist.windDownHint': '\u4e3a\u5165\u7761\u505a\u51c6\u5907\u7684\u9010\u6b65\u665a\u95f4\u6d41\u7a0b\u3002',
    'toolbox.sleep.assist.nightRescue': '\u591c\u9192\u6307\u5357',
    'toolbox.sleep.assist.nightRescueHint': '\u534a\u591c\u9192\u6765\u65f6\u8be5\u600e\u4e48\u529e\u3002',
    'toolbox.sleep.assist.dayAnchor': '\u65e5\u95f4\u951a\u70b9',
    'toolbox.sleep.assist.dayAnchorHint': '\u65e9\u6668\u5149\u7167\u548c\u6d3b\u52a8\u6765\u7a33\u5b9a\u4f60\u7684\u751f\u7269\u949f\u3002',
    'toolbox.sleep.assist.tinyLog': '\u7b80\u6613\u65e5\u5fd7',
    'toolbox.sleep.assist.tinyLogHint': '\u6bcf\u665a\u53ea\u970030\u79d2\u7684\u4f4e\u8d1f\u62c5\u7761\u7720\u8bb0\u5f55\u3002',
    'toolbox.sleep.assist.weeklyReview': '\u6bcf\u5468\u56de\u987e',
    'toolbox.sleep.assist.weeklyReviewHint': '\u56de\u987e\u4f60\u7684\u7761\u7720\u6a21\u5f0f\u5e76\u8fdb\u884c\u8c03\u6574\u3002',
    'toolbox.sleep.assist.scienceCard': '\u79d1\u5b66\u77e5\u8bc6',
    'toolbox.sleep.assist.scienceCardSub': '\u5173\u4e8e\u7761\u7720\u7684\u5faa\u8bc1\u77e5\u8bc6\u3002',
    'toolbox.sleep.assist.assessmentCard': '\u7761\u7720\u8bc4\u4f30',
    'toolbox.sleep.assist.assessmentCardSub': '\u8bc4\u4f30\u4f60\u7684\u7761\u7720\u95ee\u9898\u548c\u98ce\u9669\u56e0\u7d20\u3002',
    'toolbox.sleep.assist.logCard': '\u6bcf\u65e5\u65e5\u5fd7',
    'toolbox.sleep.assist.logCardSub': '\u7528\u7ed3\u6784\u5316\u7761\u7720\u65e5\u8bb0\u8ffd\u8e2a\u6bcf\u4e00\u665a\u3002',
    'toolbox.sleep.assist.routineCard': '\u7761\u524d\u653e\u677e',
    'toolbox.sleep.assist.routineCardSub': '\u5efa\u7acb\u548c\u8fd0\u884c\u4f60\u7684\u665a\u95f4\u653e\u677e\u6d41\u7a0b\u3002',
    'toolbox.sleep.assist.rescueCard': '\u591c\u9192\u6307\u5357',
    'toolbox.sleep.assist.rescueCardSub': '\u591c\u95f4\u9192\u6765\u65f6\u7684\u5b89\u5fc3\u5f15\u5bfc\u3002',
    'toolbox.sleep.assist.rhythmCard': '\u65e5\u95f4\u8282\u5f8b',
    'toolbox.sleep.assist.rhythmCardSub': '\u4e00\u4e2a7\u5929\u8ba1\u5212\u6765\u7a33\u5b9a\u4f60\u7684\u4f5c\u606f\u8282\u5f8b\u3002',
    'toolbox.sleep.assist.reportCard': '\u7761\u7720\u62a5\u544a',
    'toolbox.sleep.assist.reportCardSub': '\u53ef\u89c6\u5316\u8d8b\u52bf\u548c\u957f\u671f\u6a21\u5f0f\u3002',
    'toolbox.sleep.assist.collect3': '\u6536\u96c63\u665a\u6570\u636e\u4ee5\u89e3\u9501\u4e2a\u6027\u5316\u6a21\u5f0f\u3002',
    ...
    'toolbox.sleep.assist.assessmentIntro': '\u4e00\u4efd\u7b80\u77ed\u76842\u5206\u949f\u95ee\u5377\uff0c\u4e86\u89e3\u4f60\u7684\u7761\u7720\u72b6\u51b5\u5e76\u83b7\u53d6\u4e2a\u6027\u5316\u6307\u5bfc\u3002',
    'toolbox.sleep.assist.startAssessment': '\u5f00\u59cb\u8bc4\u4f30',
    'toolbox.sleep.assist.rescueFirst': '\u5148\u770b\u591c\u9192\u6307\u5357',
    'toolbox.sleep.assist.smallFirst': '\u4ece\u5c0f\u5904\u5f00\u59cb',
    'toolbox.sleep.assist.autoPlan': '\u8bc4\u4f30\u540e\u81ea\u52a8\u751f\u6210\u8ba1\u5212',
    'toolbox.sleep.assist.inProgress': '\u8fdb\u884c\u4e2d',
    'toolbox.sleep.assist.continueRoutine': '\u7ee7\u7eed\u4f60\u7684\u7761\u524d\u653e\u677e\u6d41\u7a0b',
    'toolbox.sleep.assist.continueRoutineHint': '\u4f60\u7684\u665a\u95f4\u6d41\u7a0b\u5df2\u7ecf\u8bbe\u7f6e\u597d\u4e86\uff0c\u4ece\u4e0a\u6b21\u4e2d\u65ad\u7684\u5730\u65b9\u7ee7\u7eed\u3002',
    'toolbox.sleep.assist.backToRoutine': '\u56de\u5230\u6d41\u7a0b',
    'toolbox.sleep.assist.noNewTask': '\u4eca\u665a\u4e0d\u52a0\u65b0\u4efb\u52a1',
    'toolbox.sleep.assist.nightMode': '\u591c\u95f4\u6a21\u5f0f',
    'toolbox.sleep.assist.nightModeHint': '\u534a\u591c\u65f6\u5206',
    'toolbox.sleep.assist.nightModeDesc': '\u4fdd\u6301\u4f4e\u523a\u6fc0\u3002\u907f\u514d\u5c4f\u5e55\u3001\u65f6\u949f\u548c\u4eae\u5149\u3002',
    'toolbox.sleep.assist.openRescue': '\u6253\u5f00\u591c\u9192\u6307\u5357',
    'toolbox.sleep.assist.leaveBedAid': '\u9192\u676520\u5206\u949f\u4ee5\u4e0a\u5c31\u79bb\u5e8a',
    'toolbox.sleep.assist.lowStim': '\u4f4e\u523a\u6fc0',
    'toolbox.sleep.assist.noClock': '\u4e0d\u8981\u770b\u949f',
    'toolbox.sleep.assist.tonightStep': '\u4eca\u665a\u7684\u4efb\u52a1',
    'toolbox.sleep.assist.startTinyRoutine': '\u5f00\u59cb\u7b80\u6613\u653e\u677e',
    'toolbox.sleep.assist.startTinyRoutineHint': '\u4e00\u4e2a\u5373\u4f7f\u7b4b\u75b2\u529b\u5c3d\u4e5f\u80fd\u5b8c\u6210\u7684\u4e09\u6b65\u6781\u7b80\u6d41\u7a0b\u3002',
    ...
    'toolbox.sleep.assist.dayAnchorScenarioHint': '\u8d77\u5e8a\u540e30\u5206\u949f\u5185\u63a5\u89e6\u81ea\u7136\u5149\u6216\u4eae\u5149\uff0c\u4ee5\u7a33\u56fa\u4f60\u7684\u751f\u7269\u949f\u3002',
    'toolbox.sleep.assist.startLightTimer': '\u5f00\u59cb\u5149\u7167\u8ba1\u65f6',
    ...
    'toolbox.sleep.assist.minimalLogDesc': '\u4e00\u4e2a\u5feb\u901f\u768430\u79d2\u65e5\u5fd7\u6761\u76ee\uff0c\u8bb0\u5f55\u6628\u665a\u7684\u5173\u952e\u4fe1\u606f\u3002',
    ...
    'toolbox.sleep.assist.controlOneVar': '\u63a7\u5236\u4e00\u4e2a\u53d8\u91cf',
    'toolbox.sleep.assist.controlOneVarHint': '\u5496\u5561\u56e0\u622a\u6b62',
    'toolbox.sleep.assist.controlOneVarDesc': '\u6839\u636e\u4f60\u7684\u5178\u578b\u5c31\u5bdd\u65f6\u95f4\u8ba1\u7b97\u4e2a\u4eba\u5496\u5561\u56e0\u622a\u6b62\u65f6\u95f4\u3002',
    'toolbox.sleep.assist.calcCutoff': '\u8ba1\u7b97\u622a\u6b62\u65f6\u95f4',
    'toolbox.sleep.assist.dayRhythm': '\u65e5\u95f4\u8282\u5f8b\u8ba1\u5212',
    'toolbox.sleep.assist.lateYesterday': '\u6628\u5929\u5496\u5561\u56e0\u8fc7\u665a',
    'toolbox.sleep.assist.caffeineSensitive': '\u5bf9\u5496\u5561\u56e0\u654f\u611f',
    'toolbox.sleep.assist.nextCycle': '\u4e0b\u4e00\u4e2a\u5468\u671f',
    'toolbox.sleep.assist.nextCycleHint': '\u67e5\u770b\u5373\u5c06\u5230\u6765\u7684\u7761\u7720\u7a97\u53e3',
    'toolbox.sleep.assist.nextCycleDesc': '\u57fa\u4e8e90\u5206\u949f\u7761\u7720\u5468\u671f\uff0c\u67e5\u770b\u6700\u4f73\u5165\u7761\u6216\u8d77\u5e8a\u65f6\u95f4\u3002',
    ...
    'toolbox.sleep.assist.noLogsHint': '\u5f00\u59cb\u8bb0\u5f55\u4f60\u7684\u7761\u7720\u4ee5\u67e5\u770b\u8d8b\u52bf\u5e76\u83b7\u53d6\u4e2a\u6027\u5316\u5efa\u8bae\u3002',
    ...
    'toolbox.sleep.assist.jumpDesc': '\u76f4\u63a5\u8df3\u8f6c\u5230\u4f60\u73b0\u5728\u9700\u8981\u7684\u529f\u80fd\u3002',
    'toolbox.sleep.assist.noInputStarts': '\u96f6\u8f93\u5165\u5f00\u59cb',
    'toolbox.sleep.assist.noInputStartsHint': '\u53ea\u9700\u70b9\u51fb\u5373\u53ef\u5f00\u59cb\u2014\u2014\u65e0\u9700\u4efb\u4f55\u8bbe\u7f6e\u3002',
    ...
    'toolbox.sleep.assist.nightWakeBranches': '\u591c\u95f4\u9192\u6765\u5206\u652f',
    'toolbox.sleep.assist.noPlanYet': '\u6682\u65e0\u8ba1\u5212',
    'toolbox.sleep.assist.noPlanHint': '\u5b8c\u6210\u7761\u7720\u8bc4\u4f30\u4ee5\u83b7\u53d6\u4e2a\u6027\u5316\u8ba1\u5212\u3002',
    ...
    'toolbox.sleep.assessment.moduleDisabled': '\u7761\u7720\u6a21\u5757\u5df2\u7981\u7528\u3002\u8bf7\u5728\u8bbe\u7f6e\u4e2d\u542f\u7528\u4ee5\u4f7f\u7528\u6b64\u529f\u80fd\u3002',
    'toolbox.sleep.assessment.title': '\u7761\u7720\u8bc4\u4f30',
    'toolbox.sleep.assessment.intro': '\u4e00\u4efd\u7b80\u77ed\u95ee\u5377\uff0c\u4e86\u89e3\u4f60\u7684\u7761\u7720\u6a21\u5f0f\u5e76\u83b7\u53d6\u4e2a\u6027\u5316\u6307\u5bfc\u3002',
    'toolbox.sleep.assessment.mainConcerns': '\u4e3b\u8981\u95ee\u9898',
    'toolbox.sleep.assessment.baselineSchedule': '\u57fa\u51c6\u4f5c\u606f',
    'toolbox.sleep.assessment.typicalBedtime': '\u901a\u5e38\u5c31\u5bdd\u65f6\u95f4',
    'toolbox.sleep.assessment.typicalWakeTime': '\u901a\u5e38\u8d77\u5e8a\u65f6\u95f4',
    'toolbox.sleep.assessment.currentGoal': '\u5f53\u524d\u7761\u7720\u76ee\u6807',
    'toolbox.sleep.assessment.goalHint': '\u4f8b\u5982\uff1a\u66f4\u5feb\u5165\u7761\u3001\u51cf\u5c11\u591c\u95f4\u9192\u6765\u3001\u9192\u6765\u65f6\u66f4\u7cbe\u795e',
    'toolbox.sleep.assessment.riskAndContext': '\u98ce\u9669\u4e0e\u73af\u5883',
    'toolbox.sleep.assessment.racingThoughts': '\u7761\u524d\u601d\u7eea\u7eb7\u98de',
    'toolbox.sleep.assessment.caffeineSensitive': '\u5496\u5561\u56e0\u654f\u611f\u5ea6',
    'toolbox.sleep.assessment.snoringRisk': '\u6253\u9f3e\u6216\u547c\u5438\u6682\u505c',
    'toolbox.sleep.assessment.bedroomBright': '\u5367\u5ba4\u592a\u4eae',
    'toolbox.sleep.assessment.bedroomNoisy': '\u5367\u5ba4\u592a\u5435',
    'toolbox.sleep.assessment.bedroomTemp': '\u5367\u5ba4\u8fc7\u51b7\u6216\u8fc7\u70ed',
    'toolbox.sleep.assessment.shiftWork': '\u8f6e\u73ed\u6216\u4e0d\u89c4\u5f8b\u4f5c\u606f',
    'toolbox.sleep.assessment.digestiveDiscomfort': '\u591c\u95f4\u6d88\u5316\u4e0d\u9002',
    ...
    'toolbox.sleep.log.intro': '\u7ed3\u6784\u5316\u7684\u7761\u7720\u65e5\u8bb0\uff0c\u8be6\u7ec6\u8ffd\u8e2a\u6bcf\u4e00\u665a\u3002',
    ...
    'toolbox.sleep.log.log30secHint': '\u4f7f\u7528\u5e38\u89c1\u6a21\u5f0f\u9884\u8bbe\u5feb\u901f\u8bb0\u5f55\u3002',
    ...
    'toolbox.sleep.log.estimatedSleepMinutes': '\u9884\u4f30\u7761\u7720\uff08\u5206\u949f\uff09',
    'toolbox.sleep.log.sleepLatency': '\u5165\u7761\u8017\u65f6\uff08\u5206\u949f\uff09',
    'toolbox.sleep.log.wakeCount': '\u9192\u6765\u6b21\u6570',
    'toolbox.sleep.log.fourPlus': '4\u6b21\u4ee5\u4e0a',
    'toolbox.sleep.log.wakeTotal': '\u591c\u95f4\u6e05\u9192\u603b\u8ba1\uff08\u5206\u949f\uff09',
    'toolbox.sleep.log.napMinutes': '\u5348\u7761\uff08\u5206\u949f\uff09',
    'toolbox.sleep.log.windDownMinutes': '\u7761\u524d\u653e\u677e\uff08\u5206\u949f\uff09',
    'toolbox.sleep.log.contextNotes': '\u60c5\u5883\u5907\u6ce8',
    'toolbox.sleep.log.notesHint': '\u4eca\u665a\u6709\u4ec0\u4e48\u4e0d\u5bfb\u5e38\u7684\u4e8b\u60c5...',
    ...
    'toolbox.sleep.log.daytimeSleepiness': '\u767d\u5929\u56f0\u5026\u7a0b\u5ea6',
    'toolbox.sleep.log.stressPeak': '\u538b\u529b\u5cf0\u503c',
    'toolbox.sleep.log.worryLoad': '\u7126\u8651\u8d1f\u8377',
    'toolbox.sleep.log.behaviorEnv': '\u884c\u4e3a\u4e0e\u73af\u5883',
    'toolbox.sleep.log.heavyDinnerHint': '\u7761\u524d\u4e09\u5c0f\u65f6\u5185\u5403\u8fc7\u5927\u9910',
    'toolbox.sleep.log.intenseExerciseHint': '\u7761\u524d\u4e24\u5c0f\u65f6\u5185\u5267\u70c8\u8fd0\u52a8',
    'toolbox.sleep.log.hotBathHint': '\u7761\u524d\u4e24\u5c0f\u65f6\u5185\u6d17\u8fc7\u70ed\u6c34\u6fa1',
    'toolbox.sleep.log.stretchingHint': '\u7761\u524d\u505a\u4f38\u5c55\u6216\u745c\u4f3d',
    'toolbox.sleep.log.bedroomHotHint': '\u5367\u5ba4\u611f\u89c9\u592a\u70ed',
    'toolbox.sleep.log.bedroomBrightHint': '\u5367\u5ba4\u611f\u89c9\u592a\u4eae',
    'toolbox.sleep.log.bedroomNoisyHint': '\u5367\u5ba4\u611f\u89c9\u592a\u5435',
    ...
    'toolbox.sleep.rhythm.needOneLog': '\u4f60\u9700\u8981\u81f3\u5c11\u4e00\u6761\u7761\u7720\u65e5\u5fd7\u6765\u5f00\u542f\u8282\u5f8b\u8ba1\u5212\u3002',
    'toolbox.sleep.rhythm.morningLight': '\u6668\u95f4\u5149\u7167',
    'toolbox.sleep.rhythm.morningLightDone': '\u5df2\u5b8c\u6210\u6668\u95f4\u5149\u7167',
    'toolbox.sleep.rhythm.morningLightMissed': '\u672a\u5b8c\u6210\u6668\u95f4\u5149\u7167',
    'toolbox.sleep.rhythm.done': '\u5df2\u5b8c\u6210',
    'toolbox.sleep.rhythm.missed': '\u672a\u5b8c\u6210',
    'toolbox.sleep.rhythm.lateCaffeine': '\u5496\u5561\u56e0\u8fc7\u665a',
    'toolbox.sleep.rhythm.noLateCaffeine': '\u65e0\u8fc7\u665a\u5496\u5561\u56e0',
    ...
    'toolbox.sleep.rhythm.eveningStimHigh': '\u665a\u95f4\u523a\u6fc0\u504f\u9ad8',
    'toolbox.sleep.rhythm.eveningStimOk': '\u665a\u95f4\u523a\u6fc0\u6b63\u5e38',
    ...
    'toolbox.sleep.rescue.saved': '\u591c\u9192\u8bb0\u5f55\u5df2\u4fdd\u5b58\u3002',
    'toolbox.sleep.rescue.title': '\u591c\u9192\u6307\u5357',
    'toolbox.sleep.rescue.intro': '\u534a\u591c\u9192\u6765\u65f6\u8be5\u600e\u4e48\u529e\u3002\u9009\u62e9\u4f60\u5f53\u524d\u7684\u72b6\u6001\uff0c\u83b7\u53d6\u9010\u6b65\u6307\u5bfc\u3002',
    'toolbox.sleep.rescue.chooseState': '\u9009\u62e9\u4f60\u6b64\u523b\u7684\u72b6\u6001',
    'toolbox.sleep.rescue.currentGuidance': '\u5f53\u524d\u6307\u5bfc',
    'toolbox.sleep.rescue.chooseFirst': '\u8bf7\u5148\u9009\u62e9\u4f60\u5f53\u524d\u7684\u72b6\u6001\u4ee5\u83b7\u53d6\u9488\u5bf9\u6027\u6307\u5bfc\u3002',
    ...
    'toolbox.sleep.low.tonightGoalHint': '\u4f8b\u5982\uff1a11\u70b9\u524d\u4e0a\u5e8a\uff0c10\u70b9\u540e\u4e0d\u770b\u5c4f\u5e55',
    'toolbox.sleep.low.wakeTap': '\u9192\u6765\u65f6\u70b9\u51fb',
    'toolbox.sleep.low.wakeTapDone': '\u6668\u95f4\u7b7e\u5230\u5df2\u8bb0\u5f55',
    'toolbox.sleep.low.wakeTapHint': '\u6628\u665a\u7761\u5f97\u600e\u4e48\u6837\uff1f',
    ...
    'toolbox.sleep.low.bedtimeSceneHint': '\u8c03\u6697\u706f\u5149\uff0c\u5b89\u9759\u7a7a\u95f4\uff0c\u624b\u673a\u5207\u6362\u6697\u8272\u6a21\u5f0f\u3002',
    'toolbox.sleep.low.switchDark': '\u5207\u6362\u5230\u6697\u8272',
    'toolbox.sleep.low.selectTiny': '\u9009\u62e9\u7b80\u6613\u6d41\u7a0b',
    'toolbox.sleep.low.enterRunner': '\u8fdb\u5165\u6d41\u7a0b\u8fd0\u884c\u5668',
    ...
    'toolbox.sleep.low.imTiredHint': '\u7528\u6700\u5c11\u7684\u529b\u6c14\u5e2e\u4f60\u5165\u7761\u3002',
    ...
    'toolbox.sleep.routine.intro': '\u5efa\u7acb\u4f60\u4e2a\u6027\u5316\u7684\u665a\u95f4\u653e\u677e\u6d41\u7a0b\u3002',
    ...
    'toolbox.sleep.winddown.unloadSaved': '\u601d\u7eea\u5378\u8f7d\u5df2\u4fdd\u5b58\u3002',
    ...
    'toolbox.sleep.winddown.reminderWakeCreated': '\u8d77\u5e8a\u63d0\u9192\u5df2\u521b\u5efa\u3002',
    'toolbox.sleep.winddown.reminderBedCreated': '\u5c31\u5bdd\u63d0\u9192\u5df2\u521b\u5efa\u3002',
    'toolbox.sleep.winddown.title': '\u7761\u524d\u653e\u677e',
    'toolbox.sleep.winddown.intro': '\u4e00\u4e2a\u5f15\u5bfc\u5f0f\u7684\u665a\u95f4\u6d41\u7a0b\uff0c\u5e2e\u52a9\u4f60\u7684\u8eab\u4f53\u548c\u5927\u8111\u4e3a\u7761\u7720\u505a\u597d\u51c6\u5907\u3002',
    'toolbox.sleep.winddown.templates': '\u6a21\u677f',
    'toolbox.sleep.winddown.templatesHint': '\u9009\u62e9\u4e00\u4e2a\u9884\u8bbe\u6d41\u7a0b\u6216\u521b\u5efa\u4f60\u81ea\u5df1\u7684\u3002',
    ...
    'toolbox.sleep.winddown.topThought': '\u6700\u8ba9\u5728\u610f\u7684\u5ff5\u5934',
    'toolbox.sleep.winddown.gentlerReframe': '\u66f4\u6e29\u548c\u7684\u91cd\u65b0\u8868\u8ff0',
    ...
    'toolbox.sleep.winddown.stepHint': '\u5b8c\u6210\u6bcf\u4e00\u6b65\u540e\u70b9\u51fb\u6807\u8bb0\u3002',
    ...
    'toolbox.sleep.support.issue.frequent_awakenings': '\u9891\u7e41\u9192\u6765',
    'toolbox.sleep.support.issue.early_awakening': '\u8fc7\u65e9\u9192\u6765',
    'toolbox.sleep.support.issue.non_restorative': '\u7761\u7720\u4e0d\u89e3\u4e4f',
    'toolbox.sleep.support.issue.irregular_schedule': '\u4f5c\u606f\u4e0d\u89c4\u5f8b',
    'toolbox.sleep.support.issue.racing_thoughts': '\u601d\u7eea\u7eb7\u98de',
    'toolbox.sleep.support.issue.daytime_sleepiness': '\u767d\u5929\u56f0\u5026',
    'toolbox.sleep.support.issue.snoring_risk': '\u6253\u9f3e\u98ce\u9669',
    'toolbox.sleep.support.issue.pain_tension': '\u75bc\u75db\u6216\u7d27\u7ef7',
    ...
    'toolbox.sleep.support.mode_body.brief': '\u4f60\u77ed\u6682\u5730\u9192\u4e86\uff0c\u60f3\u5feb\u901f\u91cd\u65b0\u5165\u7761\u3002',
    'toolbox.sleep.support.mode_body.fully_awake': '\u4f60\u5b8c\u5168\u6e05\u9192\u4e86\uff0c\u65e0\u6cd5\u91cd\u65b0\u5165\u7761\u3002',
    'toolbox.sleep.support.mode_body.racing_thoughts': '\u4f60\u7684\u5927\u8111\u5f88\u5fd9\u788c\uff0c\u601d\u7eea\u4e0d\u65ad\u3002',
    'toolbox.sleep.support.mode_body.body_activated': '\u4f60\u611f\u5230\u8eab\u4f53\u7d27\u5f20\u3001\u4e0d\u5b89\u6216\u5fc3\u795e\u4e0d\u5b81\u3002',
    'toolbox.sleep.support.mode_body.temperature': '\u4f60\u611f\u89c9\u592a\u70ed\u6216\u592a\u51b7\u3002',
    ...
    'toolbox.sleep.support.program.reset_14': '14\u5929\u7761\u7720\u91cd\u7f6e',
    'toolbox.sleep.support.program.starter': '\u5931\u7720\u5165\u95e8',
    'toolbox.sleep.support.program_body.rhythm_7': '\u4e00\u4e2a\u901a\u8fc7\u5149\u7167\u548c\u4f5c\u606f\u951a\u5b9a\u6765\u7a33\u5b9a\u7761\u7720-\u6e05\u9192\u8282\u5f8b\u76847\u5929\u8ba1\u5212\u3002',
    'toolbox.sleep.support.program_body.reset_14': '\u4e3a\u671f\u4e24\u5468\u7684\u7efc\u5408\u7761\u7720\u91cd\u7f6e\uff0c\u542b\u6bcf\u65e5\u6307\u5bfc\u4e0e\u4e60\u60ef\u8ffd\u8e2a\u3002',
    'toolbox.sleep.support.program_body.starter': '\u4e00\u4e2a\u6e29\u548c\u76845\u6b65\u5165\u95e8\u8ba1\u5212\uff0c\u7528\u4e8e\u7ba1\u7406\u5076\u53d1\u6027\u5931\u7720\u3002',
    ...
    'toolbox.sleep.support.template_step.tiny1': '\u53ea\u8c03\u6697\u4f60\u80fd\u78b0\u5230\u7684\u706f',
    'toolbox.sleep.support.template_step.tiny2': '\u628a\u624b\u673a\u5c4f\u5e55\u671d\u4e0b\u653e',
    'toolbox.sleep.support.template_step.tiny3': '\u653e\u4e0b\u6700\u5435\u7684\u90a3\u4e2a\u5ff5\u5934',
    'toolbox.sleep.support.template_step.tiny4': '\u5ef6\u957f\u547c\u6c14\u7684\u547c\u5438',
    'toolbox.sleep.support.template_step.tiny5': '\u4e0d\u6dfb\u65b0\u4efb\u52a1\u5730\u8fdb\u5165\u88ab\u7a9d',
    ...
    'toolbox.sleep.support.factor.late_work': '\u6df1\u591c\u5de5\u4f5c\u9891\u7387',
    'toolbox.sleep.support.factor.late_exercise': '\u6df1\u591c\u8fd0\u52a8\u9891\u7387',
    'toolbox.sleep.support.factor.pain': '\u75bc\u75db\u5f71\u54cd',
    'toolbox.sleep.support.factor.snoring': '\u6253\u9f3e\u98ce\u9669',
    'toolbox.sleep.support.factor_hint.stress': '\u538b\u529b\u5bf9\u4f60\u7761\u7720\u7684\u5f71\u54cd\u7a0b\u5ea6',
    'toolbox.sleep.support.factor_hint.screen': '\u5c4f\u5e55\u4f7f\u7528\u5982\u4f55\u5f71\u54cd\u4f60\u7684\u5165\u7761',
    'toolbox.sleep.support.factor_hint.late_work': '\u5de5\u4f5c\u8ba9\u4f60\u71ac\u591c\u7684\u9891\u7387',
    'toolbox.sleep.support.factor_hint.late_exercise': '\u4f60\u5728\u4e34\u8fd1\u5c31\u5bdd\u65f6\u8fd0\u52a8\u7684\u9891\u7387',
    'toolbox.sleep.support.factor_hint.pain': '\u75bc\u75db\u5bf9\u7761\u7720\u7684\u5e72\u6270\u7a0b\u5ea6',
    'toolbox.sleep.support.factor_hint.snoring': '\u662f\u5426\u51fa\u73b0\u6253\u9f3e\u6216\u547c\u5438\u6682\u505c',
    'toolbox.sleep.support.daily.late_caffeine': '\u5496\u5561\u56e0\u8d85\u8fc7\u622a\u6b62\u65f6\u95f4',
    'toolbox.sleep.support.daily.late_screens': '\u6df1\u591c\u5c4f\u5e55\u4f7f\u7528',
    'toolbox.sleep.support.daily.alcohol': '\u591c\u95f4\u996e\u9152',
    'toolbox.sleep.support.daily.morning_light': '\u5df2\u5b8c\u6210\u6668\u5149',
    'toolbox.sleep.support.daily.heavy_dinner': '\u665a\u9910\u8fc7\u9971',
    'toolbox.sleep.support.daily.late_exercise': '\u6df1\u591c\u5267\u70c8\u8fd0\u52a8',
    'toolbox.sleep.support.daily.warm_bath': '\u70ed\u6c34\u6fa1\u6216\u6dcb\u6d74',
    'toolbox.sleep.support.daily.stretching': '\u5df2\u5b8c\u6210\u4f38\u5c55',
    'toolbox.sleep.support.daily.white_noise': '\u5df2\u4f7f\u7528\u767d\u566a\u97f3',
    ...
    'toolbox.sleep.support.daily_hint.caffeine': '\u5728\u622a\u6b62\u65f6\u95f4\u4e4b\u540e\u559d\u4e86\u5496\u5561\u3001\u8336\u6216\u80fd\u91cf\u996e\u6599',
    'toolbox.sleep.support.daily_hint.screens': '\u6df1\u591c\u4f7f\u7528\u624b\u673a\u3001\u5e73\u677f\u6216\u7535\u8111',
    'toolbox.sleep.support.daily_hint.alcohol': '\u4e34\u7761\u524d\u996e\u9152',
    'toolbox.sleep.support.daily_hint.morning_light': '\u8d77\u5e8a\u540e30\u5206\u949f\u5185\u63a5\u89e6\u81ea\u7136\u5149\u6216\u4eae\u5149',
    'toolbox.sleep.support.daily_hint.clock': '\u591c\u95f4\u53cd\u590d\u67e5\u770b\u65f6\u95f4',
    'toolbox.sleep.support.daily_hint.white_noise': '\u4f7f\u7528\u4e86\u767d\u566a\u97f3\u3001\u98ce\u6247\u6216\u73af\u5883\u97f3',

    // --- toolbox sleep report (Chinese) ---
    'toolbox.sleep.report.title': '\u7761\u7720\u62a5\u544a',
    'toolbox.sleep.report.intro': '\u53ef\u89c6\u5316\u4f60\u7684\u7761\u7720\u8d8b\u52bf\u548c\u957f\u671f\u6a21\u5f0f\u3002',
    'toolbox.sleep.report.noData': '\u6682\u65e0\u6570\u636e',
    'toolbox.sleep.report.noDataHint': '\u8bf7\u81f3\u5c11\u8bb0\u5f55\u4e00\u665a\u4ee5\u67e5\u770b\u4f60\u7684\u7761\u7720\u62a5\u544a\u3002',
    ...
    'toolbox.sleep.report.sleepDurationTrend': '\u7761\u7720\u65f6\u957f\u8d8b\u52bf',
    'toolbox.sleep.report.sleepDurationTrendHint': '\u4f60\u7684\u603b\u7761\u7720\u65f6\u95f4\u5982\u4f55\u53d8\u5316\u3002',
    'toolbox.sleep.report.efficiencyTrend': '\u6548\u7387\u8d8b\u52bf',
    'toolbox.sleep.report.efficiencyTrendHint': '\u4f60\u7684\u7761\u7720\u6548\u7387\u5982\u4f55\u53d8\u5316\u3002',
    'toolbox.sleep.report.energyTrend': '\u6668\u95f4\u7cbe\u529b\u8d8b\u52bf',
    'toolbox.sleep.report.energyTrendHint': '\u4f60\u9192\u6765\u65f6\u611f\u89c9\u6709\u591a\u7cbe\u795e\u3002',
    'toolbox.sleep.report.wakeBurden': '\u591c\u95f4\u6e05\u9192\u8d1f\u62c5',
    'toolbox.sleep.report.wakeBurdenHint': '\u591c\u95f4\u6e05\u9192\u7684\u603b\u65f6\u957f\u3002',
    'toolbox.sleep.report.lateCaffeineDays': '\u5496\u5561\u56e0\u8fc7\u665a\u5929\u6570',
    'toolbox.sleep.report.lateCaffeineDaysHint': '\u8d85\u8fc7\u622a\u6b62\u65f6\u95f4\u6444\u5165\u5496\u5561\u56e0\u7684\u591c\u665a\u6570\u3002',
    'toolbox.sleep.report.lateScreenDays': '\u5c4f\u5e55\u8fc7\u665a\u5929\u6570',
    'toolbox.sleep.report.lateScreenDaysHint': '\u4e34\u7761\u524d\u4f7f\u7528\u5c4f\u5e55\u7684\u591c\u665a\u6570\u3002',
    'toolbox.sleep.report.morningLightDays': '\u6668\u95f4\u5149\u7167\u5929\u6570',
    'toolbox.sleep.report.morningLightDaysHint': '\u65e9\u6668\u63a5\u89e6\u81ea\u7136\u4eae\u5149\u7684\u5929\u6570\u3002',
    'toolbox.sleep.report.envIssueDays': '\u73af\u5883\u95ee\u9898\u5929\u6570',
    'toolbox.sleep.report.envIssueDaysHint': '\u5367\u5ba4\u73af\u5883\u6709\u95ee\u9898\u7684\u591c\u665a\u6570\u3002',
    'toolbox.sleep.report.nextCycleAdvice': '\u67e5\u770b\u4eca\u665a90\u5206\u949f\u5468\u671f\u7a97\u53e3\u3002',

    // --- toolbox sleep science (Chinese) ---
    'toolbox.sleep.science.title': '\u7761\u7720\u79d1\u5b66',
    'toolbox.sleep.science.intro': '\u57fa\u4e8e\u8bc1\u636e\u7684\u7761\u7720\u77e5\u8bc6\u3001\u53c2\u8003\u6587\u732e\u548c\u5b9e\u7528\u539f\u7406\u3002',
    'toolbox.sleep.science.disclaimer': '\u6b64\u4fe1\u606f\u4ec5\u4f9b\u6559\u80b2\u53c2\u8003\uff0c\u4e0d\u80fd\u66ff\u4ee3\u533b\u7597\u5efa\u8bae\u3002\u6301\u7eed\u7684\u7761\u7720\u95ee\u9898\u8bf7\u54a8\u8be2\u533b\u7597\u4e13\u4e1a\u4eba\u5458\u3002',
    'toolbox.sleep.science.anchorRhythm': '\u951a\u5b9a\u4f60\u7684\u8282\u5f8b',
    'toolbox.sleep.science.anchorRhythmBody': '\u8d77\u5e8a\u540e30\u5206\u949f\u5185\u7684\u6668\u95f4\u5149\u7167\u662f\u8bbe\u5b9a\u4f53\u5185\u65f6\u949f\u7684\u6700\u5f3a\u4fe1\u53f7\u3002\u5373\u4f7f\u5728\u9634\u5929\u6237\u5916\u5f8510\u5206\u949f\u4e5f\u80fd\u4ea7\u751f\u53ef\u6d4b\u91cf\u7684\u6548\u679c\u3002',
    'toolbox.sleep.science.keepBedForSleep': '\u5e8a\u53ea\u7528\u6765\u7761\u89c9',
    'toolbox.sleep.science.keepBedForSleepBody': '\u5982\u679c\u4f60\u8eba\u4e8620\u5206\u949f\u4ee5\u4e0a\u8fd8\u7761\u4e0d\u7740\uff0c\u5c31\u8d77\u5e8a\u505a\u4e9b\u4f4e\u523a\u6fc0\u7684\u4e8b\u60c5\u76f4\u5230\u56f0\u5026\u3002\u8fd9\u6837\u53ef\u4ee5\u91cd\u65b0\u52a0\u5f3a\u5e8a\u4e0e\u7761\u7720\u7684\u5173\u8054\u3002',
    'toolbox.sleep.science.logLightly': '\u8f7b\u677e\u8bb0\u5f55',
    'toolbox.sleep.science.logLightlyBody': '\u4e00\u4e2a30\u79d2\u7684\u7761\u7720\u65e5\u8bb0\u8db3\u4ee5\u968f\u7740\u65f6\u95f4\u7684\u63a8\u79fb\u63ed\u793a\u6a21\u5f0f\u3002\u4e0d\u9700\u8981\u5b8c\u7f8e\u2014\u2014\u575a\u6301\u6bd4\u7ec6\u8282\u66f4\u91cd\u8981\u3002',
    ...
    'toolbox.sleep.science.refGroupCbtiBody': '\u9488\u5bf9\u6162\u6027\u5931\u7720\u7684\u523a\u6fc0\u63a7\u5236\u3001\u7761\u7720\u9650\u5236\u548c\u8ba4\u77e5\u6280\u672f\u3002',
    'toolbox.sleep.science.refGroupRhythm': '\u663c\u591c\u8282\u5f8b\u79d1\u5b66',
    'toolbox.sleep.science.refGroupRhythmBody': '\u5149\u7167\u66b4\u9732\u3001\u892a\u9ed1\u7d20\u65f6\u673a\u548c\u751f\u7269\u949f\u57fa\u7840\u3002',
    'toolbox.sleep.science.refGroupMedical': '\u533b\u5b66\u7b5b\u67e5',
    'toolbox.sleep.science.refGroupMedicalBody': '\u4f55\u65f6\u8003\u8651\u7761\u7720\u547c\u5438\u6682\u505c\u7b5b\u67e5\u3001RLS\u6216\u4e13\u79d1\u8f6c\u8bca\u3002',
    'toolbox.sleep.science.refGroupPopular': '\u5927\u4f17\u5faa\u8bc1\u6458\u8981',
    'toolbox.sleep.science.refGroupPopularBody': '\u5c06\u7814\u7a76\u8f6c\u5316\u4e3a\u65e5\u5e38\u7761\u7720\u4e60\u60ef\u3002',
    'toolbox.sleep.science.riskFirst': '\u5148\u6392\u9664\u533b\u5b66\u95ee\u9898',
    'toolbox.sleep.science.riskFirstBody': '\u67d0\u4e9b\u7761\u7720\u95ee\u9898\u53ef\u80fd\u6709\u6f5c\u5728\u7684\u533b\u5b66\u539f\u56e0\u3002\u5728\u81ea\u6211\u8c03\u6574\u524d\u8bf7\u6ce8\u610f\u5173\u952e\u8b66\u544a\u4fe1\u53f7\u3002',
    'toolbox.sleep.science.riskSnoring': '\u5927\u58f0\u6253\u9f3e\u4f34\u6709\u4eba\u89c1\u8bc1\u7684\u547c\u5438\u6682\u505c',
    'toolbox.sleep.science.riskMental': '\u4e0e\u60c5\u7eea\u53d1\u4f5c\u6216\u521b\u4f24\u76f8\u5173\u7684\u7761\u7720\u969c\u788d',
    'toolbox.sleep.science.riskMedical': '\u4e0d\u5b81\u817f\u3001\u6162\u6027\u75bc\u75db\u6216\u836f\u7269\u526f\u4f5c\u7528',
    'toolbox.sleep.science.dayAnchors': '\u65e5\u95f4\u951a\u70b9\u7a33\u5b9a\u591c\u665a',
    'toolbox.sleep.science.dayAnchorsBody': '\u7a33\u5b9a\u7684\u8d77\u5e8a\u65f6\u95f4\u3001\u6668\u95f4\u5149\u7167\u548c\u89c4\u5f8b\u7684\u7528\u9910\u65f6\u95f4\u53ef\u4ee5\u951a\u5b9a\u4f60\u7684\u663c\u591c\u8282\u5f8b\u3002',
    'toolbox.sleep.science.fixWakeTime': '\u6bcf\u5929\u56fa\u5b9a\u8d77\u5e8a\u65f6\u95f4\uff0c\u6d6e\u52a8\u4e0d\u8d85\u8fc730\u5206\u949f',
    'toolbox.sleep.science.caffeineRule': '\u4e0b\u53482\u70b9\u540e\u4e0d\u6444\u5165\u5496\u5561\u56e0\uff08\u6216\u7761\u524d8-10\u5c0f\u65f6\uff09',
    'toolbox.sleep.science.napRule': '\u5348\u7761\u4e0d\u8d85\u8fc720\u5206\u949f\u4e14\u5728\u4e0b\u53483\u70b9\u524d\uff0c\u6216\u8005\u5b8c\u5168\u4e0d\u5348\u7761',
    'toolbox.sleep.science.windDownSm': '\u5c0f\u5c0f\u7684\u653e\u677e\u5f88\u91cd\u8981',
    'toolbox.sleep.science.windDownSmBody': '\u5373\u4f7f\u4e00\u4e2a\u5fae\u5c0f\u7684\u4e09\u6b65\u6d41\u7a0b\u4e5f\u80fd\u5411\u4f60\u7684\u5927\u8111\u53d1\u51fa"\u4e00\u5929\u7ed3\u675f\u4e86"\u7684\u4fe1\u53f7\u3002\u575a\u6301\u6bd4\u4eea\u5f0f\u7684\u590d\u6742\u5ea6\u66f4\u91cd\u8981\u3002',
    'toolbox.sleep.science.windDownDetail1': '\u7761\u524d30-60\u5206\u949f\u8c03\u6697\u706f\u5149',
    'toolbox.sleep.science.windDownDetail2': '\u6536\u8d77\u5c4f\u5e55\u6216\u5207\u6362\u5230\u591c\u95f4\u6a21\u5f0f',
    'toolbox.sleep.science.windDownDetail3': '\u505a\u4e00\u4ef6\u5b89\u9759\u7684\u4e8b\uff1a\u9605\u8bfb\u3001\u4f38\u5c55\u6216\u547c\u5438',
    'toolbox.sleep.science.nightWaking': '\u591c\u91cc\u9192\u6765\u662f\u6b63\u5e38\u7684',
    'toolbox.sleep.science.nightWakingBody': '\u7761\u7720\u5468\u671f\u4e4b\u95f4\u7684\u77ed\u6682\u9192\u6765\u662f\u6b63\u5e38\u7684\u3002\u95ee\u9898\u5728\u4e8e\u6211\u4eec\u7684\u53cd\u5e94\u2014\u2014\u53cd\u590d\u770b\u949f\u548c\u6cae\u4e27\u60c5\u7eea\u4f1a\u5ef6\u957f\u6e05\u9192\u65f6\u95f4\u3002',
    'toolbox.sleep.science.nightWakingDetail1': '\u907f\u514d\u770b\u949f\u6216\u624b\u673a',
    'toolbox.sleep.science.nightWakingDetail2': '\u5982\u679c20\u5206\u949f\u540e\u4ecd\u7136\u6e05\u9192\uff0c\u5c31\u79bb\u5f00\u5e8a\u94fa',
    'toolbox.sleep.science.nightWakingDetail3': '\u5728\u660f\u6697\u7684\u5149\u7ebf\u4e0b\u505a\u4e00\u4e9b\u65e0\u804a\u7684\u4e8b\u76f4\u5230\u56f0\u5026',
    'toolbox.sleep.science.easyMisuse': '\u5e38\u89c1\u8bef\u89e3',
    'toolbox.sleep.science.easyMisuseIntro': '\u6d41\u884c\u7684\u7761\u7720\u5efa\u8bae\u53ef\u80fd\u88ab\u8bef\u7528\u3002\u4ee5\u4e0b\u662f\u4e09\u4e2a\u5e38\u89c1\u8bef\u533a\u3002',
    'toolbox.sleep.science.eightHour': '"\u6bcf\u4e2a\u4eba\u90fd\u9700\u89818\u5c0f\u65f6"\u2014\u2014\u6b63\u5e38\u7761\u7720\u56e0\u4eba\u800c\u5f02\uff0c\u4ece6\u52309\u5c0f\u65f6\u4e0d\u7b49\u3002',
    'toolbox.sleep.science.cycle90': '"\u5fc5\u987b\u5728\u5468\u671f\u7ed3\u675f\u65f6\u9192\u6765"\u2014\u2014\u7761\u7720\u7ed3\u6784\u6bd4\u56fa\u5b9a\u768490\u5206\u949f\u533a\u5757\u66f4\u590d\u6742\u3002',
    'toolbox.sleep.science.hygiene': '"\u7761\u7720\u536b\u751f\u5c31\u80fd\u6cbb\u6108\u5931\u7720"\u2014\u2014\u6162\u6027\u5931\u7720\u901a\u5e38\u9700\u8981\u7ed3\u6784\u5316\u7684CBT-I\u6280\u672f\u3002',

    // --- toolbox sleep tools (Chinese) ---
    'toolbox.sleep.tools.ambientNoise': '\u73af\u5883\u58f0\u97f3',
    'toolbox.sleep.tools.ambientNoiseHint': '\u4f7f\u7528\u767d\u566a\u97f3\u3001\u96e8\u58f0\u6216\u73af\u5883\u97f3\u6765\u63a9\u76d6\u5e72\u6270\u3002',
    ...
    'toolbox.sleep.tools.downloadedReady': '\u5df2\u4e0b\u8f7d\uff0c\u53ef\u7528',
    ...
    'toolbox.sleep.sheets.plannedBedtime': '\u8ba1\u5212\u5c31\u5bdd\u65f6\u95f4',
    'toolbox.sleep.sheets.caffeineSensitive': '\u5496\u5561\u56e0\u654f\u611f\u5ea6',
    'toolbox.sleep.sheets.caffeineSuggestion': '\u6839\u636e\u4f60\u7684\u654f\u611f\u5ea6\u548c\u8ba1\u5212\u5c31\u5bdd\u65f6\u95f4\uff0c\u8bf7\u5728 {time} \u524d\u505c\u6b62\u6444\u5165\u5496\u5561\u56e0\u3002',
    'toolbox.sleep.sheets.lightTimer': '\u5149\u7167\u8ba1\u65f6\u5668',
    'toolbox.sleep.sheets.lightTimerHint': '\u63a5\u89e6 {minutes} \u5206\u949f\u7684\u4eae\u5149\u4ee5\u7a33\u56fa\u4f60\u7684\u8282\u5f8b\u3002',
    'toolbox.sleep.core.cancel': '\u53d6\u6d88',
    'toolbox.sleep.sheets.cyclePlan': '90\u5206\u949f\u5468\u671f\u8ba1\u5212',
    'toolbox.sleep.sheets.cyclePlanHint': '\u7761\u7720\u5468\u671f\u5927\u7ea690\u5206\u949f\u3002\u56f4\u7ed5\u5468\u671f\u8fb9\u754c\u6765\u5b89\u6392\u4f60\u7684\u65f6\u95f4\u3002',
    'toolbox.sleep.sheets.targetWake': '\u76ee\u6807\u8d77\u5e8a\u65f6\u95f4',
    'toolbox.sleep.sheets.settleBuffer': '\u5165\u7761\u7f13\u51b2\uff1a{minutes} \u5206\u949f',
    'toolbox.sleep.sheets.backPlanLightsOff': '\u8ba1\u5212\uff1a{time} \u524d\u5173\u706f',
    'toolbox.sleep.sheets.backPlanHint': '\u4ece\u76ee\u6807\u8d77\u5e8a\u65f6\u95f4\u5012\u63a85-6\u4e2a\u5468\u671f\u3002',
    'toolbox.sleep.sheets.sleepNow': '\u5982\u679c\u73b0\u5728\u5c31\u7761',
    'toolbox.sleep.sheets.sleepNowHint': '\u5927\u7ea6\u5728 {time} \u9192\u6765\uff0c\u5b8c\u6210 {cycles} \u4e2a\u5b8c\u6574\u5468\u671f\u3002',
    'toolbox.sleep.sheets.leaveBed': '\u79bb\u5f00\u5e8a\u94fa',
    'toolbox.sleep.sheets.awakeAWhile': '\u6211\u5df2\u7ecf\u9192\u4e86\u4e00\u4f1a\u513f',
    'toolbox.sleep.sheets.stillSleepy': '\u4ecd\u7136\u611f\u5230\u56f0\u5026',
    'toolbox.sleep.sheets.busyMind': '\u5927\u8111\u5fd9\u788c/\u601d\u7eea\u7eb7\u98de',
    'toolbox.sleep.sheets.bodyUncomfortable': '\u8eab\u4f53\u611f\u89c9\u4e0d\u8212\u670d',
    'toolbox.sleep.sheets.adviceUncomfortable': '\u68c0\u67e5\u6e29\u5ea6\uff0c\u8c03\u6574\u88ab\u8925\uff0c\u5c1d\u8bd5\u8f7b\u67d4\u4f38\u5c55\u3002',
    'toolbox.sleep.sheets.adviceAwake': '\u8d77\u676515-20\u5206\u949f\uff0c\u505a\u5b89\u9759\u7684\u6d3b\u52a8\uff0c\u611f\u5230\u56f0\u5026\u518d\u56de\u5e8a\u3002',
    'toolbox.sleep.sheets.adviceBusy': '\u5199\u4e0b\u8111\u4e2d\u7684\u60f3\u6cd5\uff0c\u7136\u540e\u505a2\u5206\u949f\u76844-7-8\u547c\u5438\u3002',
    'toolbox.sleep.sheets.adviceSleepy': '\u95ed\u4e0a\u773c\u775b\uff0c\u6162\u6162\u547c\u5438\uff0c\u8ba9\u81ea\u5df1\u6e10\u6e10\u5165\u7761\u3002',

    // --- toolbox sleep library (Chinese) ---
    'toolbox.sleep.library.topic.light.title': '\u6668\u5149\u4e0e\u663c\u591c\u8282\u5f8b\u951a\u5b9a',
    'toolbox.sleep.library.topic.light.summary': '\u8d77\u5e8a\u540e30\u5206\u949f\u5185\u7684\u4eae\u5149\u662f\u8bbe\u5b9a\u4f53\u5185\u65f6\u949f\u7684\u6700\u5f3a\u4fe1\u53f7\u3002',
    'toolbox.sleep.library.topic.light.detail': '\u89c6\u4ea4\u53c9\u4e0a\u6838\uff08SCN\uff09\u5229\u7528\u89c6\u7f51\u819c\u4e2d\u7684ipRGC\u7ec6\u80de\u68c0\u6d4b\u5230\u7684\u5149\u7ebf\u6765\u540c\u6b65\u4f60\u7684\u663c\u591c\u8282\u5f8b\u3002\u6668\u5149\u4f7f\u4f60\u7684\u65f6\u949f\u63d0\u524d\uff0c\u8ba9\u4f60\u66f4\u5bb9\u6613\u5728\u665a\u4e0a\u5165\u7761\u3002\u5373\u4f7f\u5728\u9634\u5929\u6237\u5916\u5f8510-15\u5206\u949f\u4e5f\u80fd\u63d0\u4f9b\u8db3\u591f\u7684\u5149\u7167\u5f3a\u5ea6\u6765\u4ea7\u751f\u53ef\u6d4b\u91cf\u7684\u5dee\u5f02\u3002',
    'toolbox.sleep.library.topic.light.action_hint': '\u8d77\u5e8a\u540e30\u5206\u949f\u5185\u5230\u6237\u5916\u3002\u524d10\u5206\u949f\u4e0d\u8981\u6234\u592a\u9633\u955c\u3002',
    'toolbox.sleep.library.source.light_1': 'Czeisler CA \u7b49\u3002\u4eba\u7c7b\u663c\u591c\u8282\u5f8b\u8d77\u640f\u5668\u7684\u7a33\u5b9a\u6027\u3001\u7cbe\u786e\u5ea6\u4e0e\u8fd124\u5c0f\u65f6\u5468\u671f\u3002Science (1999)\u3002',
    'toolbox.sleep.library.source.light_2': 'Duffy JF, Czeisler CA\u3002\u5149\u7167\u5bf9\u4eba\u7c7b\u663c\u591c\u8282\u5f8b\u751f\u7406\u7684\u5f71\u54cd\u3002Sleep Med Clin (2009)\u3002',
    'toolbox.sleep.library.source.light_3': 'Blume C \u7b49\u3002\u5149\u7167\u5bf9\u4eba\u7c7b\u663c\u591c\u8282\u5f8b\u3001\u7761\u7720\u4e0e\u60c5\u7eea\u7684\u5f71\u54cd\u3002Somnologie (2019)\u3002',
    'toolbox.sleep.library.topic.caffeine.title': '\u5496\u5561\u56e0\u65f6\u673a\u4e0e\u817a\u82f7\u963b\u65ad',
    'toolbox.sleep.library.topic.caffeine.summary': '\u5496\u5561\u56e0\u901a\u8fc7\u963b\u65ad\u817a\u82f7\u53d7\u4f53\u8d77\u4f5c\u7528\u3002\u5176\u534a\u8870\u671f\u4e3a3-7\u5c0f\u65f6\uff0c\u610f\u5473\u7740\u4e0b\u53482\u70b9\u7684\u5496\u5561\u5230\u4e86\u5348\u591c\u4ecd\u53ef\u80fd\u5f71\u54cd\u7761\u7720\u3002',
    'toolbox.sleep.library.topic.caffeine.detail': '\u817a\u82f7\u5728\u767d\u5929\u79ef\u7d2f\uff0c\u4ea7\u751f"\u7761\u7720\u538b\u529b"\u3002\u5496\u5561\u56e0\u6682\u65f6\u963b\u65ad\u817a\u82f7\u53d7\u4f53\uff0c\u63a9\u76d6\u56f0\u5026\u611f\u800c\u4e0d\u51cf\u5c11\u6f5c\u5728\u7684\u7761\u7720\u538b\u529b\u3002CYP1A2\u57fa\u56e0\u5dee\u5f02\u610f\u5473\u7740\u6709\u4e9b\u4eba\u4ee3\u8c22\u5496\u5561\u56e0\u7684\u901f\u5ea6\u6bd4\u5176\u4ed6\u4eba\u6162\u5f97\u591a\u3002',
    'toolbox.sleep.library.topic.caffeine.action_hint': '\u8bbe\u5b9a\u4e2a\u4eba\u5496\u5561\u56e0\u622a\u6b62\u65f6\u95f4\uff0c\u5728\u901a\u5e38\u5c31\u5bdd\u65f6\u95f4\u524d8-10\u5c0f\u65f6\u3002',
    'toolbox.sleep.library.source.caffeine_1': 'Drake C \u7b49\u3002\u7761\u524d0\u30013\u62166\u5c0f\u65f6\u6444\u5165\u5496\u5561\u56e0\u5bf9\u7761\u7720\u7684\u5f71\u54cd\u3002J Clin Sleep Med (2013)\u3002',
    'toolbox.sleep.library.source.caffeine_2': 'Landolt HP\u3002\u7761\u7720\u3001\u8b66\u89c9\u6027\u548c\u5174\u594b\u5242\u53cd\u5e94\u4e2d\u7684\u57fa\u56e0\u578b\u4f9d\u8d56\u6027\u5dee\u5f02\u3002Curr Pharm Des (2008)\u3002',
    'toolbox.sleep.library.source.caffeine_3': 'Roehrs T, Roth T\u3002\u5496\u5561\u56e0\uff1a\u7761\u7720\u4e0e\u65e5\u95f4\u56f0\u5026\u3002Sleep Med Rev (2008)\u3002',
    'toolbox.sleep.library.topic.digital_sunset.title': '\u6570\u5b57\u65e5\u843d\u4e0e\u84dd\u5149',
    'toolbox.sleep.library.topic.digital_sunset.summary': '\u665a\u95f4\u5c4f\u5e55\u5149\u7167\uff0c\u5c24\u5176\u662f\u84dd\u8272\u6ce2\u957f\uff0c\u53ef\u80fd\u901a\u8fc7\u6fc0\u6d3b\u4e0e\u6668\u5149\u53cd\u5e94\u76f8\u540c\u7684ipRGC\u7ec6\u80de\u6765\u6291\u5236\u892a\u9ed1\u7d20\u3002',
    'toolbox.sleep.library.topic.digital_sunset.detail': 'ipRGC\u7ec6\u80de\u4e2d\u7684\u9ed1\u89c6\u86cb\u767d\u5149\u8272\u7d20\u5bf9\u7ea6480nm\uff08\u84dd\u8272\uff09\u5149\u6700\u654f\u611f\u3002\u665a\u95f4\u66b4\u9732\u4f1a\u4f7f\u663c\u591c\u8282\u5f8b\u65f6\u949f\u5411\u540e\u63a8\u79fb\uff0c\u4f7f\u5165\u7761\u66f4\u52a0\u56f0\u96be\u3002\u7136\u800c\uff0c\u6548\u5e94\u5927\u5c0f\u5728\u4e0d\u540c\u4e2a\u4f53\u4e4b\u95f4\u5dee\u5f02\u5f88\u5927\uff0c\u5185\u5bb9\u5f15\u8d77\u7684\u7cbe\u795e\u5524\u8d77\u53ef\u80fd\u4e0e\u5149\u7167\u672c\u8eab\u540c\u6837\u91cd\u8981\u3002',
    'toolbox.sleep.library.topic.digital_sunset.action_hint': '\u65e5\u843d\u540e\u5c06\u8bbe\u5907\u5207\u6362\u81f3\u591c\u95f4\u6a21\u5f0f\u3002\u7761\u524d30-60\u5206\u949f\u505c\u6b62\u4e3b\u52a8\u4f7f\u7528\u5c4f\u5e55\u3002',
    'toolbox.sleep.library.source.digital_sunset_1': 'Chang AM \u7b49\u3002\u665a\u95f4\u4f7f\u7528\u53d1\u5149\u7535\u5b50\u9605\u8bfb\u5668\u5bf9\u7761\u7720\u7684\u4e0d\u5229\u5f71\u54cd\u3002PNAS (2015)\u3002',
    'toolbox.sleep.library.source.digital_sunset_2': 'Cajochen C \u7b49\u3002\u665a\u95f4\u66b4\u9732\u4e8e\u53d1\u5149\u4e8c\u6781\u7ba1\uff08LED\uff09\u80cc\u5149\u7535\u8111\u5c4f\u5e55\u5f71\u54cd\u663c\u591c\u8282\u5f8b\u751f\u7406\u3002J Appl Physiol (2011)\u3002',
    'toolbox.sleep.library.source.digital_sunset_3': 'Exelmans L, Van den Bulck J\u3002\u6210\u5e74\u4eba\u7761\u524d\u624b\u673a\u4f7f\u7528\u4e0e\u7761\u7720\u3002Soc Sci Med (2016)\u3002',
    'toolbox.sleep.library.topic.stimulus_control.title': '\u523a\u6fc0\u63a7\u5236\uff1a\u5e8a = \u7761\u7720',
    'toolbox.sleep.library.topic.stimulus_control.summary': '\u6700\u6709\u6548\u7684CBT-I\u6280\u672f\u4e4b\u4e00\uff1a\u91cd\u65b0\u5c06\u5e8a\u4e0e\u7761\u7720\u8054\u7cfb\u8d77\u6765\u3002',
    'toolbox.sleep.library.topic.stimulus_control.detail': '\u5f53\u4eba\u4eec\u5728\u5e8a\u4e0a\u82b1\u8d39\u6e05\u9192\u65f6\u95f4\uff08\u62c5\u5fe7\u3001\u5de5\u4f5c\u3001\u770b\u8282\u76ee\uff09\uff0c\u5927\u8111\u4f1a\u5b66\u5230\u5e8a\u662f\u6e05\u9192\u7684\u5730\u65b9\u3002\u523a\u6fc0\u63a7\u5236\u7597\u6cd5\u901a\u8fc7\u89c4\u5b9a\u53ea\u5728\u56f0\u5026\u65f6\u4e0a\u5e8a\u3001\u9192\u7740\u8d85\u8fc720\u5206\u949f\u5c31\u8d77\u6765\u3001\u5e8a\u53ea\u7528\u4e8e\u7761\u7720\u6765\u6253\u7834\u8fd9\u4e2a\u5faa\u73af\u3002',
    'toolbox.sleep.library.topic.stimulus_control.action_hint': '\u5982\u679c\u4f60\u5728\u5e8a\u4e0a\u6e05\u9192\u8d85\u8fc720\u5206\u949f\uff0c\u5c31\u8d77\u6765\u5728\u660f\u6697\u7684\u706f\u5149\u4e0b\u505a\u4e9b\u65e0\u804a\u7684\u4e8b\u3002',
    'toolbox.sleep.library.source.stimulus_control_1': 'Bootzin RR, Epstein D, Wood JM\u3002\u523a\u6fc0\u63a7\u5236\u6307\u5bfc\u3002\u6536\u5f55\u4e8e\uff1a\u5931\u7720\u6848\u4f8b\u7814\u7a76 (1991)\u3002',
    'toolbox.sleep.library.source.stimulus_control_2': 'Morin CM \u7b49\u3002\u5931\u7720\u7684\u5fc3\u7406\u4e0e\u884c\u4e3a\u6cbb\u7597\uff1a\u8fd1\u671f\u8bc1\u636e\u66f4\u65b0\u3002Sleep (2006)\u3002',
    'toolbox.sleep.library.topic.diary_trends.title': '\u7b80\u6613\u7761\u7720\u65e5\u8bb0\u7684\u529b\u91cf',
    'toolbox.sleep.library.topic.diary_trends.summary': '\u4e00\u4e2a30\u79d2\u7684\u7761\u7720\u65e5\u5fd7\u63ed\u793a\u7684\u89c4\u5f8b\uff0c\u751a\u81f3\u8d85\u8fc7\u8be6\u7ec6\u7684\u7761\u7720\u8ffd\u8e2a\u5668\u3002',
    'toolbox.sleep.library.topic.diary_trends.detail': '\u6d88\u8d39\u7ea7\u7761\u7720\u8ffd\u8e2a\u5668\u901a\u8fc7\u8fd0\u52a8\u548c\u5fc3\u7387\u4f30\u8ba1\u7761\u7720\u9636\u6bb5\uff0c\u4f46\u5176\u51c6\u786e\u6027\u5dee\u5f02\u5f88\u5927\uff0c\u4e14\u5e38\u5e38\u9ad8\u4f30\u7761\u7720\u3002\u4e00\u4e2a\u7b80\u5355\u7684\u65e5\u8bb0\u8bb0\u5f55\u5c31\u5bdd\u65f6\u95f4\u3001\u8d77\u5e8a\u65f6\u95f4\u548c\u4e3b\u89c2\u6062\u590d\u611f\uff0c\u63d0\u4f9b\u4e86\u8ffd\u8e2a\u5668\u770b\u4e0d\u5230\u7684\u884c\u4e3a\u6a21\u5f0f\u8865\u5145\u6570\u636e\u3002',
    'toolbox.sleep.library.topic.diary_trends.action_hint': '\u6bcf\u665a\u53ea\u8bb0\u5f553\u4e2a\u6570\u636e\u70b9\uff1a\u4e0a\u5e8a\u65f6\u95f4\u3001\u8d77\u5e8a\u65f6\u95f4\u548c\u4f60\u611f\u89c9\u6709\u591a\u7cbe\u795e\u3002',
    'toolbox.sleep.library.source.diary_trends_1': 'Carney CE \u7b49\u3002\u5171\u8bc6\u7761\u7720\u65e5\u8bb0\uff1a\u6807\u51c6\u5316\u524d\u77bb\u6027\u7761\u7720\u81ea\u6211\u76d1\u6d4b\u3002Sleep (2012)\u3002',
    'toolbox.sleep.library.source.diary_trends_2': 'Baron KG \u7b49\u3002\u611f\u89c9\u88ab\u9a8c\u8bc1\u4e86\u5417\uff1f\u6d88\u8d39\u7ea7\u53ef\u7a7f\u6234\u7761\u7720\u6280\u672f\u7684\u8303\u56f4\u7efc\u8ff0\u3002Sleep Med Rev (2018)\u3002',
    'toolbox.sleep.library.source.diary_trends_3': 'de Zambotti M \u7b49\u3002\u6212\u6307\u7684\u7761\u7720\uff1a\u014cURA\u7761\u7720\u8ffd\u8e2a\u5668\u4e0e\u591a\u5bfc\u7761\u7720\u56fe\u7684\u6bd4\u8f83\u3002Behav Sleep Med (2019)\u3002',
    'toolbox.sleep.library.topic.sleep_cycles.title': '\u7761\u7720\u5468\u671f\u4e0e90\u5206\u949f\u8ff7\u601d',
    'toolbox.sleep.library.topic.sleep_cycles.summary': '\u7761\u7720\u5468\u671f\u5e73\u5747\u7ea690\u5206\u949f\uff0c\u4f46\u8303\u56f4\u662f70-120\u5206\u949f\uff0c\u4e14\u5728\u6574\u4e2a\u591c\u95f4\u4f1a\u53d8\u5316\u3002',
    'toolbox.sleep.library.topic.sleep_cycles.detail': 'NREM-REM\u5468\u671f\u786e\u5b9e\u9075\u5faa\u5927\u7ea690\u5206\u949f\u7684\u8282\u5f8b\uff0c\u4f46\u591c\u665a\u7684\u7b2c\u4e00\u4e2a\u5468\u671f\u901a\u5e38\u8f83\u77ed\uff08\u7ea670\u5206\u949f\uff09\u4e14\u5305\u542b\u66f4\u591a\u6df1\u5ea6\u7761\u7720\uff0c\u800c\u540e\u671f\u5468\u671f\u66f4\u957f\uff08\u7ea6100-120\u5206\u949f\uff09\u4e14\u5305\u542b\u66f4\u591aREM\u3002\u81ea\u7136\u9192\u6765\u901a\u5e38\u53d1\u751f\u5728REM\u671f\uff0c\u53ef\u4ee5\u611f\u5230\u6062\u590d\u7cbe\u529b\u3002',
    'toolbox.sleep.library.topic.sleep_cycles.action_hint': '\u5c0690\u5206\u949f\u7a97\u53e3\u4f5c\u4e3a\u7c97\u7565\u53c2\u8003\uff0c\u800c\u975e\u4e25\u683c\u89c4\u5219\u3002\u8d77\u5e8a\u65f6\u95f4\u7684\u4e00\u81f4\u6027\u66f4\u4e3a\u91cd\u8981\u3002',
    'toolbox.sleep.library.source.sleep_cycles_1': 'Feinberg I, Floyd TC\u3002\u4eba\u7c7b\u7761\u7720\u5468\u671f\u5728\u591c\u95f4\u7684\u7cfb\u7edf\u6027\u8d8b\u52bf\u3002Psychophysiology (1979)\u3002',
    'toolbox.sleep.library.source.sleep_cycles_2': 'Carskadon MA, Dement WC\u3002\u6b63\u5e38\u4eba\u7c7b\u7761\u7720\uff1a\u6982\u8ff0\u3002\u6536\u5f55\u4e8e\uff1a\u7761\u7720\u533b\u5b66\u539f\u7406\u4e0e\u5b9e\u8df5 (2011)\u3002',
    'toolbox.sleep.library.source.sleep_cycles_3': 'Achermann P, Borb\u00e9ly AA\u3002\u7761\u7720\u7a33\u6001\u4e0e\u7761\u7720\u8c03\u8282\u6a21\u578b\u3002J Biol Rhythms (1999)\u3002',
    'toolbox.sleep.library.topic.worry_unload.title': '\u7761\u524d\u5378\u8f7d\u70e6\u607c',
    'toolbox.sleep.library.topic.worry_unload.summary': '\u7761\u524d\u8fdb\u884c\u7b80\u77ed\u7684\u3001\u6709\u7ed3\u6784\u7684\u4e66\u5199\u7ec3\u4e60\u53ef\u4ee5\u51cf\u5c11\u7761\u524d\u8ba4\u77e5\u5524\u8d77\u3002',
    'toolbox.sleep.library.topic.worry_unload.detail': '\u7761\u524d\u8ba4\u77e5\u5524\u8d77\u2014\u2014\u62c5\u5fe7\u3001\u8ba1\u5212\u3001\u56de\u653e\u4e8b\u4ef6\u2014\u2014\u662f\u5165\u7761\u56f0\u96be\u578b\u5931\u7720\u7684\u4e3b\u8981\u9a71\u52a8\u56e0\u7d20\u3002\u508d\u665a\u8fdb\u884c\u6709\u7ed3\u6784\u7684"\u70e6\u607c\u65f6\u95f4"\u52a0\u4e0a\u5e8a\u8fb9\u7b80\u77ed\u7684\u5378\u8f7d\u7ec3\u4e60\uff08\u5199\u4e0b\u6700\u91cd\u8981\u7684\u5fe7\u8651\u548c\u4e00\u4e2a\u6e29\u548c\u7684\u91cd\u65b0\u8868\u8ff0\uff09\u53ef\u4ee5\u51cf\u5c11\u5ef6\u8fdf\u7761\u7720\u7684\u7cbe\u795e\u6d3b\u8dc3\u3002',
    'toolbox.sleep.library.topic.worry_unload.action_hint': '\u5173\u706f\u4e4b\u524d\uff0c\u5199\u4e0b\u4f60\u6700\u5728\u610f\u7684\u70e6\u607c\u548c\u4e00\u4e2a\u66f4\u6e29\u548c\u7684\u89c6\u89d2\u3002',
    'toolbox.sleep.library.source.worry_unload_1': 'Harvey AG\u3002\u5931\u7720\u7684\u8ba4\u77e5\u6a21\u578b\u3002Behav Res Ther (2002)\u3002',
    'toolbox.sleep.library.source.worry_unload_2': 'Espie CA \u7b49\u3002\u5fc3\u7406\u751f\u7406\u6027\u5931\u7720\u53d1\u5c55\u4e2d\u7684\u6ce8\u610f-\u610f\u56fe-\u52aa\u529b\u901a\u8def\u3002Sleep Med Rev (2006)\u3002',
    'toolbox.sleep.library.topic.bedroom.title': '\u5367\u5ba4\u73af\u5883\u4f18\u5316',
    'toolbox.sleep.library.topic.bedroom.summary': '\u6e29\u5ea6\u3001\u566a\u97f3\u548c\u5149\u7ebf\u662f\u5f71\u54cd\u7761\u7720\u8d28\u91cf\u7684\u4e09\u4e2a\u4e3b\u8981\u73af\u5883\u56e0\u7d20\u3002',
    'toolbox.sleep.library.topic.bedroom.detail': '\u7406\u60f3\u7684\u5367\u5ba4\u7761\u7720\u6e29\u5ea6\u4e3a18-20\u00b0C\u3002\u6838\u5fc3\u4f53\u6e29\u5fc5\u987b\u4e0b\u964d\u7ea61\u00b0C\u624d\u80fd\u8fdb\u5165\u548c\u7ef4\u6301\u7761\u7720\u3002\u623f\u95f4\u592a\u70ed\u4f1a\u963b\u6b62\u8fd9\u79cd\u4e0b\u964d\u3002\u8d85\u8fc740\u5206\u8d1d\u7684\u566a\u97f3\u5373\u4f7f\u6ca1\u6709\u5b8c\u5168\u9192\u6765\u4e5f\u80fd\u5f15\u8d77\u5524\u9192\u3002',
    'toolbox.sleep.library.topic.bedroom.action_hint': '\u4fdd\u6301\u5367\u5ba4\u51c9\u723d\u3001\u9ed1\u6697\u548c\u5b89\u9759\u3002\u5c1d\u8bd518-20\u00b0C\u7684\u6e29\u5ea6\u3002',
    'toolbox.sleep.library.source.bedroom_1': 'Okamoto-Mizuno K, Mizuno K\u3002\u70ed\u73af\u5883\u5bf9\u7761\u7720\u548c\u663c\u591c\u8282\u5f8b\u7684\u5f71\u54cd\u3002J Physiol Anthropol (2012)\u3002',
    'toolbox.sleep.library.source.bedroom_2': 'Muzet A\u3002\u73af\u5883\u566a\u97f3\u3001\u7761\u7720\u4e0e\u5065\u5eb7\u3002Sleep Med Rev (2007)\u3002',
    'toolbox.sleep.library.source.bedroom_3': 'van Maanen A \u7b49\u3002\u5149\u7597\u5bf9\u7761\u7720\u95ee\u9898\u7684\u5f71\u54cd\u3002Sleep Med Rev (2016)\u3002',
    'toolbox.sleep.library.topic.temperature.title': '\u6838\u5fc3\u4f53\u6e29\u4e0e\u5165\u7761',
    'toolbox.sleep.library.topic.temperature.summary': '\u6838\u5fc3\u4f53\u6e29\u5fc5\u987b\u4e0b\u964d\u7ea61\u00b0C\u624d\u80fd\u8fdb\u5165\u548c\u7ef4\u6301\u7761\u7720\u3002',
    'toolbox.sleep.library.topic.temperature.detail': '\u8eab\u4f53\u7684\u4f53\u6e29\u8c03\u8282\u7cfb\u7edf\u4e0e\u7761\u7720\u8c03\u8282\u5bc6\u5207\u76f8\u5173\u3002\u624b\u90e8\u548c\u811a\u90e8\u7684\u8840\u7ba1\u6269\u5f20\uff08\u8fd9\u5c31\u662f\u4e3a\u4ec0\u4e48\u6e29\u6696\u7684\u624b\u6709\u52a9\u4e8e\u5165\u7761\uff09\u4fc3\u8fdb\u70ed\u91cf\u6563\u5931\u3002\u7761\u524d1-2\u5c0f\u65f6\u6d17\u4e2a\u6e29\u6c34\u6fa1\u53cd\u800c\u6709\u5e2e\u52a9\uff0c\u56e0\u4e3a\u5b83\u5c06\u8840\u6db2\u5f15\u81f3\u76ae\u80a4\u8868\u9762\uff0c\u89e6\u53d1\u4f53\u6e29\u7684\u53cd\u5f39\u6027\u4e0b\u964d\u3002',
    'toolbox.sleep.library.topic.temperature.action_hint': '\u7761\u524d1-2\u5c0f\u65f6\u5c1d\u8bd5\u6e29\u6c34\u6fa1\u6216\u6dcb\u6d74\u3002\u4fdd\u6301\u5367\u5ba4\u7a0d\u5fae\u51c9\u723d\u3002',
    'toolbox.sleep.library.source.temperature_1': 'Kr\u00e4uchi K \u7b49\u3002\u6e29\u6696\u7684\u811a\u4fc3\u8fdb\u5feb\u901f\u5165\u7761\u3002Nature (1999)\u3002',
    'toolbox.sleep.library.source.temperature_2': 'Raymann RJ \u7b49\u3002\u76ae\u80a4\u6e29\u5ea6\u4e0e\u5165\u7761\u6f5c\u4f0f\u671f\u3002Physiol Behav (2007)\u3002',
    'toolbox.sleep.library.topic.nap.title': '\u5348\u7761\uff1a\u7b56\u7565\u6027\u4f7f\u7528\u4e0e\u65f6\u673a',
    'toolbox.sleep.library.topic.nap.summary': '\u5c11\u4e8e20\u5206\u949f\u7684\u77ed\u5348\u7761\u53ef\u4ee5\u63d0\u5347\u8b66\u89c9\u6027\uff0c\u800c\u4e0d\u4f1a\u5f15\u8d77\u7761\u7720\u60ef\u6027\u6216\u5e72\u6270\u591c\u95f4\u7761\u7720\u3002',
    'toolbox.sleep.library.topic.nap.detail': '\u7406\u60f3\u7684\u5348\u7761\u7a97\u53e3\u662f10-20\u5206\u949f\uff08"\u80fd\u91cf\u5348\u7761"\uff09\uff0c\u505c\u7559\u5728\u8f83\u6d45\u7684NREM\u7761\u7720\u9636\u6bb5\uff0c\u672a\u8fdb\u5165\u6df1\u5ea6\u6162\u6ce2\u7761\u7720\u3002\u8f83\u957f\u7684\u5348\u7761\uff0830\u5206\u949f\u4ee5\u4e0a\uff09\u6709\u7761\u7720\u60ef\u6027\u98ce\u9669\u2014\u2014\u9192\u6765\u65f6\u660f\u660f\u6c89\u6c89\u2014\u2014\u5e76\u4e14\u4f1a\u51cf\u5c11\u7a33\u6001\u7761\u7720\u538b\u529b\uff0c\u4f7f\u665a\u4e0a\u66f4\u96be\u5165\u7761\u3002',
    'toolbox.sleep.library.topic.nap.action_hint': '\u5348\u7761\u4e0d\u8d85\u8fc720\u5206\u949f\uff0c\u5728\u4e0b\u53483\u70b9\u4e4b\u524d\u3002\u5982\u679c\u4f60\u6709\u5931\u7720\u95ee\u9898\uff0c\u5b8c\u5168\u4e0d\u8981\u5348\u7761\u3002',
    'toolbox.sleep.library.source.nap_1': 'Milner CE, Cote KA\u3002\u5065\u5eb7\u6210\u5e74\u4eba\u5348\u7761\u7684\u76ca\u5904\u3002J Sleep Res (2009)\u3002',
    'toolbox.sleep.library.source.nap_2': 'Brooks A, Lack L\u3002\u591c\u95f4\u7761\u7720\u9650\u5236\u540e\u7684\u77ed\u6682\u4e0b\u5348\u5348\u7761\u3002Sleep (2006)\u3002',
    'toolbox.sleep.library.topic.white_noise.title': '\u767d\u566a\u97f3\u4e0e\u542c\u89c9\u63a9\u853d',
    'toolbox.sleep.library.topic.white_noise.summary': '\u767d\u566a\u97f3\u53ef\u4ee5\u901a\u8fc7\u63a9\u76d6\u7a81\u7136\u7684\u73af\u5883\u58f0\u97f3\u6765\u5e2e\u52a9\u51cf\u5c11\u5fae\u89c9\u9192\u3002',
    'toolbox.sleep.library.topic.white_noise.detail': '\u767d\u566a\u97f3\u63d0\u9ad8\u4e86\u542c\u89c9\u9608\u503c\uff0c\u4f7f\u7a81\u7136\u7684\u58f0\u97f3\uff08\u5173\u95e8\u3001\u4ea4\u901a\u3001\u90bb\u5c45\u566a\u97f3\uff09\u66f4\u96be\u89e6\u53d1\u6e05\u9192\u53cd\u5e94\u3002\u5728\u95f4\u6b47\u6027\u566a\u97f3\u800c\u975e\u6301\u7eed\u6027\u566a\u97f3\u7684\u73af\u5883\u4e2d\u6548\u679c\u6700\u4e3a\u660e\u663e\u3002',
    'toolbox.sleep.library.topic.white_noise.action_hint': '\u5c06\u767d\u566a\u97f3\u8bbe\u7f6e\u5728\u8212\u9002\u7684\u97f3\u91cf\uff0c\u521a\u597d\u80fd\u63a9\u76d6\u80cc\u666f\u5e72\u6270\u3002',
    'toolbox.sleep.library.source.white_noise_1': 'Stanchina ML \u7b49\u3002\u767d\u566a\u97f3\u5bf9\u66b4\u9732\u4e8eICU\u566a\u97f3\u7684\u53d7\u8bd5\u8005\u7761\u7720\u7684\u5f71\u54cd\u3002Sleep Med (2005)\u3002',
    'toolbox.sleep.library.source.white_noise_2': 'Forquer LM, Johnson CM\u3002\u6301\u7eed\u767d\u566a\u97f3\u51cf\u5c11\u5927\u5b66\u751f\u5165\u7761\u6f5c\u4f0f\u671f\u548c\u591c\u95f4\u9192\u6765\u6b21\u6570\u3002Sleep Hypn (2007)\u3002',
    'toolbox.sleep.library.topic.red_flags.title': '\u4f55\u65f6\u9700\u8981\u770b\u533b\u751f',
    'toolbox.sleep.library.topic.red_flags.summary': '\u67d0\u4e9b\u7761\u7720\u75c7\u72b6\u9700\u8981\u5728\u5c1d\u8bd5\u81ea\u52a9\u65b9\u6cd5\u4e4b\u524d\u8fdb\u884c\u533b\u5b66\u8bc4\u4f30\u3002',
    'toolbox.sleep.library.topic.red_flags.detail': '\u5927\u58f0\u3001\u4e60\u60ef\u6027\u6253\u9f3e\u5e76\u4f34\u6709\u76ee\u51fb\u7684\u547c\u5438\u6682\u505c\u63d0\u793a\u53ef\u80fd\u662f\u7761\u7720\u547c\u5438\u6682\u505c\uff0c\u5f71\u54cd10-30%\u7684\u6210\u5e74\u4eba\uff0c\u9700\u8981\u533b\u5b66\u8bca\u65ad\u3002\u4e0d\u5b81\u817f\u3001\u5e72\u6270\u7761\u7720\u7684\u6162\u6027\u75bc\u75db\u4ee5\u53ca\u4e0e\u60c5\u7eea\u53d1\u4f5c\u76f8\u5173\u7684\u7761\u7720\u969c\u788d\u4e5f\u9700\u8981\u4e13\u4e1a\u8bc4\u4f30\u3002',
    'toolbox.sleep.library.topic.red_flags.action_hint': '\u5982\u679c\u4f60\u5927\u58f0\u6253\u9f3e\u4e14\u5c3d\u7ba1\u7761\u7720\u65f6\u957f\u5145\u8db3\u4ecd\u611f\u89c9\u672a\u6062\u590d\u7cbe\u795e\uff0c\u8bf7\u54a8\u8be2\u533b\u751f\u8fdb\u884c\u7761\u7720\u68c0\u67e5\u3002',
    'toolbox.sleep.library.source.red_flags_1': 'Young T \u7b49\u3002\u4e2d\u5e74\u6210\u5e74\u4eba\u4e2d\u7761\u7720\u547c\u5438\u969c\u788d\u7684\u53d1\u751f\u7387\u3002N Engl J Med (1993)\u3002',
    'toolbox.sleep.library.source.red_flags_2': 'Winkelman JW \u7b49\u3002\u4e0d\u5b81\u817f\u7efc\u5408\u5f81\u4e34\u5e8a\u5b9e\u8df5\u6307\u5357\u3002J Clin Sleep Med (2016)\u3002',
    'toolbox.sleep.library.source.red_flags_3': 'Baglioni C \u7b49\u3002\u7761\u7720\u4e0e\u7cbe\u795e\u969c\u788d\uff1a\u591a\u5bfc\u7761\u7720\u56fe\u7814\u7a76\u7684\u835f\u8403\u5206\u6790\u3002Psychol Bull (2016)\u3002',
    'toolbox.sleep.library.topic.references': '\u53c2\u8003\u6587\u732e',
    'toolbox.sleep.library.advice_assessment_rhythm.title': '\u5f00\u59cb7\u5929\u8282\u5f8b\u91cd\u7f6e',
    'toolbox.sleep.library.advice_assessment_rhythm.body': '\u4f60\u7684\u8bc4\u4f30\u663e\u793a\u7761\u7720\u65f6\u95f4\u8868\u4e0d\u89c4\u5f8b\u3002\u4e00\u4e2a\u4e13\u6ce8\u4e8e\u7a33\u5b9a\u8d77\u5e8a\u65f6\u95f4\u548c\u6668\u5149\u7684\u7ed3\u6784\u5316\u8282\u5f8b\u8ba1\u5212\u53ef\u4ee5\u7a33\u5b9a\u4f60\u7684\u663c\u591c\u8282\u5f8b\u3002',
    'toolbox.sleep.library.advice_assessment_rhythm.reason': '\u4e0d\u89c4\u5f8b\u7684\u65f6\u95f4\u8868\u524a\u5f31\u4e86\u663c\u591c\u8282\u5f8b\u4fe1\u53f7\uff0c\u4f7f\u5f97\u6309\u65f6\u5165\u7761\u548c\u8d77\u5e8a\u66f4\u52a0\u56f0\u96be\u3002',
    'toolbox.sleep.library.tag.rhythm': '\u8282\u5f8b',
    'toolbox.sleep.library.advice_assessment_wind_down.title': '\u5efa\u7acb\u4e00\u4e2a\u7b80\u5355\u7684\u7761\u524d\u653e\u677e\u6d41\u7a0b',
    'toolbox.sleep.library.advice_assessment_wind_down.body': '\u5373\u4f7f\u662f\u7b80\u5355\u7684\u4e09\u6b65\u7761\u524d\u6d41\u7a0b\uff0c\u4e5f\u80fd\u663e\u8457\u51cf\u5c11\u5165\u7761\u6240\u9700\u7684\u65f6\u95f4\uff0c\u56e0\u4e3a\u5b83\u5411\u5927\u8111\u53d1\u51fa"\u4e00\u5929\u7ed3\u675f\u4e86"\u7684\u4fe1\u53f7\u3002',
    'toolbox.sleep.library.advice_assessment_wind_down.reason': '\u601d\u7eea\u7eb7\u98de\u548c\u96be\u4ee5\u653e\u677e\u5bf9\u7a33\u5b9a\u7684\u884c\u4e3a\u6d41\u7a0b\u53cd\u5e94\u826f\u597d\u3002',
    'toolbox.sleep.library.tag.wind_down': '\u653e\u677e',
    'toolbox.sleep.library.advice_assessment_caffeine.title': '\u4f18\u5316\u4f60\u7684\u5496\u5561\u56e0\u622a\u6b62\u65f6\u95f4',
    'toolbox.sleep.library.advice_assessment_caffeine.body': '\u6839\u636e\u4f60\u7684\u654f\u611f\u5ea6\uff0c\u5728\u901a\u5e38\u5c31\u5bdd\u65f6\u95f4\u524d8-10\u5c0f\u65f6\u8bbe\u5b9a\u4e00\u4e2a\u4e25\u683c\u7684\u5496\u5561\u56e0\u622a\u6b62\u65f6\u95f4\uff0c\u4ee5\u4fdd\u62a4\u4f60\u7684\u81ea\u7136\u7761\u7720\u538b\u529b\u3002',
    'toolbox.sleep.library.advice_assessment_caffeine.reason': '\u5496\u5561\u56e0\u963b\u65ad\u817a\u82f7\u53d7\u4f53\uff0c\u63a9\u76d6\u4e86\u4f60\u5927\u8111\u8fdb\u5165\u7761\u7720\u6240\u9700\u7684\u7761\u7720\u538b\u529b\u3002',
    'toolbox.sleep.library.tag.behavior': '\u884c\u4e3a',
    'toolbox.sleep.library.advice_assessment_environment.title': '\u4f18\u5316\u4f60\u7684\u5367\u5ba4\u73af\u5883',
    'toolbox.sleep.library.advice_assessment_environment.body': '\u51c9\u723d\u3001\u9ed1\u6697\u548c\u5b89\u9759\u7684\u5367\u5ba4\u6709\u52a9\u4e8e\u6838\u5fc3\u4f53\u6e29\u7684\u81ea\u7136\u4e0b\u964d\uff0c\u8fd9\u662f\u7761\u7720\u6240\u9700\u7684\u3002',
    'toolbox.sleep.library.advice_assessment_environment.reason': '\u73af\u5883\u56e0\u7d20\u53ef\u80fd\u5e72\u6270\u8fdb\u5165\u7761\u7720\u7684\u751f\u7406\u8fc7\u6e21\u3002',
    'toolbox.sleep.library.tag.environment': '\u73af\u5883',
    'toolbox.sleep.library.advice_assessment_temp.title': '\u5229\u7528\u6e29\u5ea6\u5e2e\u52a9\u5165\u7761',
    'toolbox.sleep.library.advice_assessment_temp.body': '\u7761\u524d1-2\u5c0f\u65f6\u6d17\u4e2a\u6e29\u6c34\u6fa1\uff0c\u52a0\u4e0a\u51c9\u723d\u7684\u5367\u5ba4\uff0c\u6709\u52a9\u4e8e\u89e6\u53d1\u5165\u7761\u6240\u9700\u7684\u6838\u5fc3\u4f53\u6e29\u4e0b\u964d\u3002',
    'toolbox.sleep.library.advice_assessment_temp.reason': '\u6838\u5fc3\u4f53\u6e29\u5fc5\u987b\u4e0b\u964d\u7ea61\u00b0C\u624d\u80fd\u8fdb\u5165\u548c\u7ef4\u6301\u7761\u7720\u3002',
    'toolbox.sleep.library.tag.temperature': '\u6e29\u5ea6',
    'toolbox.sleep.library.advice_assessment_risk.title': '\u8003\u8651\u8fdb\u884c\u533b\u5b66\u8bc4\u4f30',
    'toolbox.sleep.library.advice_assessment_risk.body': '\u4f60\u7684\u8bc4\u4f30\u6807\u8bb0\u4e86\u53ef\u80fd\u7684\u98ce\u9669\u56e0\u7d20\uff0c\u8fd9\u4e9b\u56e0\u7d20\u53ef\u80fd\u9700\u8981\u5728\u81ea\u6211\u6307\u5bfc\u65b9\u6cd5\u7684\u540c\u65f6\u8fdb\u884c\u4e13\u4e1a\u8bc4\u4f30\u3002',
    'toolbox.sleep.library.advice_assessment_risk.reason': '\u67d0\u4e9b\u7761\u7720\u75c7\u72b6\u6709\u6f5c\u5728\u533b\u5b66\u539f\u56e0\uff0c\u6700\u597d\u7531\u533b\u7597\u4e13\u4e1a\u4eba\u5458\u8fdb\u884c\u8bc4\u4f30\u3002',
    'toolbox.sleep.library.tag.risk': '\u5065\u5eb7',
    'toolbox.sleep.library.advice_daily_minimal_log.title': '\u575a\u6301\u8bb0\u5f55\u2014\u2014\u4e00\u81f4\u6027\u80dc\u8fc7\u7ec6\u8282',
    'toolbox.sleep.library.advice_daily_minimal_log.body': '\u4f60\u7684\u6bcf\u65e5\u65e5\u5fd7\u6761\u76ee\u6b63\u5728\u6784\u5efa\u4e00\u4e2a\u80fd\u63ed\u793a\u89c4\u5f8b\u7684\u6570\u636e\u96c6\u3002\u7ee7\u7eed\u575a\u6301\u2014\u2014\u5373\u4f7f30\u79d2\u7684\u8bb0\u5f55\u4e5f\u80fd\u79ef\u7d2f\u3002',
    'toolbox.sleep.library.advice_daily_minimal_log.reason': '\u591a\u665a\u7684\u7761\u7720\u65e5\u8bb0\u6570\u636e\u63ed\u793a\u4e86\u5355\u665a\u5feb\u7167\u6240\u9057\u6f0f\u7684\u6a21\u5f0f\u3002',
    'toolbox.sleep.library.tag.log': '\u8bb0\u5f55',
    'toolbox.sleep.library.advice_daily_caffeine.title': '\u6ce8\u610f\u5496\u5561\u56e0\u8fc7\u665a\u7684\u6a21\u5f0f',
    'toolbox.sleep.library.advice_daily_caffeine.body': '\u4f60\u7684\u65e5\u5fd7\u663e\u793a\u67d0\u4e9b\u591c\u665a\u5728\u4e34\u7761\u65f6\u6444\u5165\u5496\u5561\u56e0\u3002\u5373\u4f7f\u4f60\u80fd\u591f\u5165\u7761\uff0c\u5496\u5561\u56e0\u4e5f\u4f1a\u51cf\u5c11\u6df1\u5ea6\u7761\u7720\u3002',
    'toolbox.sleep.library.advice_daily_caffeine.reason': '\u622a\u6b62\u65f6\u95f4\u540e\u7684\u5496\u5561\u56e0\u53ef\u80fd\u7834\u574f\u7761\u7720\u7ed3\u6784\uff0c\u5373\u4f7f\u6ca1\u6709\u5ef6\u8fdf\u5165\u7761\u3002',
    'toolbox.sleep.library.advice_daily_light.title': '\u4f18\u5148\u6668\u95f4\u5149\u7167',
    'toolbox.sleep.library.advice_daily_light.body': '\u4f60\u7684\u7761\u7720\u8d28\u91cf\u4e0e\u6668\u95f4\u5149\u7167\u66b4\u9732\u76f8\u5173\u3002\u8d77\u5e8a\u540e30\u5206\u949f\u5185\u5c1d\u8bd5\u6237\u5916\u6d3b\u52a810-15\u5206\u949f\u3002',
    'toolbox.sleep.library.advice_daily_light.reason': '\u6668\u5149\u662f\u951a\u5b9a\u663c\u591c\u8282\u5f8b\u7684\u6700\u5f3a\u65f6\u95f4\u7ebf\u7d22\u3002',
    'toolbox.sleep.library.advice_daily_screen.title': '\u4eca\u665a\u5c1d\u8bd5\u6570\u5b57\u65e5\u843d',
    'toolbox.sleep.library.advice_daily_screen.body': '\u4f60\u7684\u8fd1\u671f\u65e5\u5fd7\u4e2d\u51fa\u73b0\u6df1\u591c\u5c4f\u5e55\u4f7f\u7528\u3002\u5207\u6362\u5230\u591c\u95f4\u6a21\u5f0f\u6216\u5728\u7761\u524d30-60\u5206\u949f\u653e\u4e0b\u8bbe\u5907\u53ef\u4ee5\u6539\u5584\u7761\u7720\u8d28\u91cf\u3002',
    'toolbox.sleep.library.advice_daily_screen.reason': '\u665a\u95f4\u84dd\u5149\u53ef\u80fd\u6291\u5236\u892a\u9ed1\u7d20\u5e76\u5ef6\u8fdf\u5165\u7761\u3002',
    'toolbox.sleep.library.advice_daily_worry.title': '\u5c1d\u8bd5\u70e6\u607c\u5378\u8f7d\u7ec3\u4e60',
    'toolbox.sleep.library.advice_daily_worry.body': '\u4f60\u7684\u6570\u636e\u663e\u793a\u51fa\u7761\u524d\u70e6\u607c\u6216\u601d\u7eea\u5fd9\u788c\u7684\u6a21\u5f0f\u3002\u7761\u524d2\u5206\u949f\u7684\u4e66\u5199\u7ec3\u4e60\u53ef\u4ee5\u663e\u8457\u51cf\u5c11\u8fd9\u79cd\u8ba4\u77e5\u5524\u8d77\u3002',
    'toolbox.sleep.library.advice_daily_worry.reason': '\u7761\u524d\u8ba4\u77e5\u5524\u8d77\u662f\u5165\u7761\u56f0\u96be\u7684\u4e3b\u8981\u9a71\u52a8\u56e0\u7d20\u3002',
    'toolbox.sleep.library.tag.cognitive': '\u8ba4\u77e5',
    'toolbox.sleep.library.advice_daily_rescue.title': '\u628a\u591c\u9192\u5b89\u629a\u5de5\u5177\u653e\u5728\u624b\u8fb9',
    'toolbox.sleep.library.advice_daily_rescue.body': '\u4f60\u7684\u8fd1\u671f\u65e5\u5fd7\u4e2d\u51fa\u73b0\u591c\u95f4\u9192\u6765\u3002\u6709\u4e00\u4e2a\u9884\u5148\u8ba1\u5212\u597d\u7684\u4f4e\u523a\u6fc0\u5e94\u5bf9\u65b9\u6848\u53ef\u4ee5\u5e2e\u52a9\u4f60\u5e73\u9759\u5730\u5904\u7406\u5b83\u4eec\u3002',
    'toolbox.sleep.library.advice_daily_rescue.reason': '\u5bf9\u591c\u95f4\u9192\u6765\u7684\u6709\u8ba1\u5212\u7684\u56de\u5e94\u53ef\u4ee5\u51cf\u5c11\u7126\u8651\u548c\u5ef6\u957f\u6e05\u9192\u65f6\u95f4\u7684\u53cd\u590d\u770b\u949f\u3002',
    'toolbox.sleep.library.tag.rescue': '\u591c\u9192',
    'toolbox.sleep.library.advice_daily_environment.title': '\u8c03\u6574\u4f60\u7684\u5367\u5ba4\u73af\u5883',
    'toolbox.sleep.library.advice_daily_environment.body': '\u4f60\u7684\u65e5\u5fd7\u663e\u793a\u73af\u5883\u56e0\u7d20\u6b63\u5728\u5f71\u54cd\u4f60\u7684\u7761\u7720\u3002\u5bf9\u6e29\u5ea6\u3001\u5149\u7ebf\u6216\u566a\u97f3\u7684\u5c0f\u8c03\u6574\u53ef\u4ee5\u5e26\u6765\u6709\u610f\u4e49\u7684\u6539\u5584\u3002',
    'toolbox.sleep.library.advice_daily_environment.reason': '\u5367\u5ba4\u73af\u5883\u76f4\u63a5\u5f71\u54cd\u8eab\u4f53\u8fdb\u5165\u548c\u7ef4\u6301\u7761\u7720\u7684\u80fd\u529b\u3002',
    'toolbox.sleep.library.advice_daily_nap.title': '\u4f18\u5316\u4f60\u7684\u5348\u7761\u7b56\u7565',
    'toolbox.sleep.library.advice_daily_nap.body': '\u4f60\u7684\u6570\u636e\u663e\u793a\u51fa\u767d\u5929\u56f0\u5026\u3002\u5982\u679c\u4f60\u5348\u7761\uff0c\u8bf7\u4fdd\u6301\u572820\u5206\u949f\u4ee5\u5185\u4e14\u5728\u4e0b\u53483\u70b9\u524d\u3002\u5982\u679c\u4f60\u6709\u5931\u7720\u95ee\u9898\uff0c\u8003\u8651\u4e0d\u5348\u7761\u3002',
    'toolbox.sleep.library.advice_daily_nap.reason': '\u5348\u7761\u53ef\u80fd\u4f1a\u6709\u5e2e\u52a9\u4e5f\u53ef\u80fd\u635f\u5bb3\u591c\u95f4\u7761\u7720\uff0c\u53d6\u51b3\u4e8e\u65f6\u673a\u548c\u65f6\u957f\u3002',
    'toolbox.sleep.library.tag.recovery': '\u6062\u590d',
    'toolbox.sleep.library.advice_weekly_light.title': '\u6668\u5149\u662f\u4f60\u7684\u6700\u5f3a\u8282\u5f8b\u5de5\u5177',
    'toolbox.sleep.library.advice_weekly_light.body': '\u4f60\u7684\u6bcf\u5468\u6570\u636e\u663e\u793a\u6668\u5149\u4e0d\u7a33\u5b9a\u3002\u8d77\u5e8a\u540e30\u5206\u949f\u5185\u5373\u4f7f\u53ea\u5728\u6237\u5916\u5f8510\u5206\u949f\u4e5f\u80fd\u589e\u5f3a\u4f60\u7684\u7761\u7720-\u6e05\u9192\u5468\u671f\u3002',
    'toolbox.sleep.library.advice_weekly_light.reason': '\u7a33\u5b9a\u7684\u6668\u5149\u66b4\u9732\u662f\u7a33\u5b9a\u663c\u591c\u8282\u5f8b\u7684\u6700\u6709\u6548\u65b9\u6cd5\u3002',
    'toolbox.sleep.library.advice_weekly_caffeine.title': '\u4f60\u7684\u5496\u5561\u56e0\u6a21\u5f0f\u53ef\u80fd\u6b63\u5728\u964d\u4f4e\u7761\u7720\u8d28\u91cf',
    'toolbox.sleep.library.advice_weekly_caffeine.body': '\u4f60\u7684\u6bcf\u5468\u6570\u636e\u4e2d\uff0c\u4e34\u7761\u524d\u7684\u5496\u5561\u56e0\u4e0e\u8f83\u4f4e\u7684\u7761\u7720\u6548\u7387\u548c\u8f83\u5c11\u7684\u6df1\u5ea6\u7761\u7720\u76f8\u5173\u3002',
    'toolbox.sleep.library.advice_weekly_caffeine.reason': '\u8fc7\u665a\u7684\u5496\u5561\u56e0\u5373\u4f7f\u4f60\u6ca1\u6709\u6ce8\u610f\u5230\u5165\u7761\u56f0\u96be\uff0c\u4e5f\u4f1a\u5f71\u54cd\u7761\u7720\u7ed3\u6784\u3002',
    'toolbox.sleep.library.advice_weekly_screen.title': '\u665a\u95f4\u5c4f\u5e55\u4f7f\u7528\u6b63\u5728\u5f71\u54cd\u4f60\u7684\u7761\u7720',
    'toolbox.sleep.library.advice_weekly_screen.body': '\u4f60\u7684\u6570\u636e\u663e\u793a\u665a\u95f4\u5c4f\u5e55\u4f7f\u7528\u4e0e\u5165\u7761\u65f6\u95f4\u5ef6\u957f\u76f8\u5173\u3002\u5c1d\u8bd5\u7761\u524d30-60\u5206\u949f\u7684\u65e0\u5c4f\u5e55\u7f13\u51b2\u65f6\u95f4\u3002',
    'toolbox.sleep.library.advice_weekly_screen.reason': '\u5c4f\u5e55\u5149\u7ebf\u548c\u5185\u5bb9\u5524\u8d77\u90fd\u4f1a\u5bfc\u81f4\u5165\u7761\u5ef6\u8fdf\u3002',
    'toolbox.sleep.library.advice_weekly_rescue.title': '\u591c\u95f4\u9192\u6765\uff1a\u51c6\u5907\u4e00\u4e2a\u5e94\u5bf9\u8ba1\u5212',
    'toolbox.sleep.library.advice_weekly_rescue.body': '\u4f60\u8fd1\u671f\u65e5\u5fd7\u4e2d\u7684\u591a\u6b21\u591c\u95f4\u9192\u6765\u63d0\u793a\uff0c\u6709\u4e00\u4e2a\u9884\u5148\u8ba1\u5212\u7684\u5b89\u629a\u5e94\u5bf9\u53ef\u80fd\u6709\u6240\u5e2e\u52a9\u3002\u5173\u952e\uff1a\u907f\u514d\u770b\u949f\uff0c\u5982\u679c\u9192\u676520\u5206\u949f\u4ee5\u4e0a\u5c31\u77ed\u6682\u8d77\u6765\u3002',
    'toolbox.sleep.library.advice_weekly_rescue.reason': '\u5bf9\u591c\u95f4\u9192\u6765\u7684\u6709\u8ba1\u5212\u7684\u56de\u5e94\u53ef\u4ee5\u51cf\u5c11\u5ef6\u7eed\u6e05\u9192\u7684\u632b\u6298\u611f\u3002',
    'toolbox.sleep.library.advice_weekly_worry.title': '\u7761\u524d\u70e6\u607c\uff1a\u4e00\u4e2a\u7b80\u5355\u7684\u4e66\u5199\u7ec3\u4e60\u53ef\u80fd\u6709\u5e2e\u52a9',
    'toolbox.sleep.library.advice_weekly_worry.body': '\u4f60\u7684\u6570\u636e\u663e\u793a\u51fa\u8f83\u9ad8\u7684\u70e6\u607c\u6216\u601d\u7eea\u5fd9\u788c\u8bc4\u5206\u3002\u7761\u524d\u4e00\u4e2a\u7ed3\u6784\u5316\u76842\u5206\u949f"\u70e6\u607c\u5378\u8f7d"\u53ef\u4ee5\u6e05\u7406\u5fc3\u7406\u7a7a\u95f4\u4ee5\u4fbf\u5165\u7761\u3002',
    'toolbox.sleep.library.advice_weekly_worry.reason': '\u7761\u524d\u8ba4\u77e5\u5524\u8d77\u662f\u5ef6\u957f\u5165\u7761\u65f6\u95f4\u7684\u6700\u5f3a\u9884\u6d4b\u56e0\u7d20\u4e4b\u4e00\u3002',
    'toolbox.sleep.library.advice_weekly_environment.title': '\u4f60\u7684\u7761\u7720\u73af\u5883\u9700\u8981\u5173\u6ce8',
    'toolbox.sleep.library.advice_weekly_environment.body': '\u73af\u5883\u95ee\u9898\uff08\u6e29\u5ea6\u3001\u566a\u97f3\u3001\u5149\u7ebf\uff09\u5728\u591a\u4e2a\u591c\u665a\u4e2d\u51fa\u73b0\u3002\u6301\u7eed\u7684\u5367\u5ba4\u4f18\u5316\u53ef\u4ee5\u4ea7\u751f\u7d2f\u79ef\u7684\u76ca\u5904\u3002',
    'toolbox.sleep.library.advice_weekly_environment.reason': '\u6301\u7eed\u7684\u73af\u5883\u95ee\u9898\u5bf9\u7761\u7720\u8d28\u91cf\u6709\u7d2f\u79ef\u6027\u7684\u8d1f\u9762\u5f71\u54cd\u3002',
    'toolbox.sleep.library.advice_weekly_sleep_amount.title': '\u4f60\u7684\u603b\u7761\u7720\u65f6\u957f\u663e\u793a\u51fa\u4e00\u79cd\u6a21\u5f0f',
    'toolbox.sleep.library.advice_weekly_sleep_amount.body': '\u4f60\u7684\u6bcf\u5468\u7761\u7720\u65f6\u957f\u663e\u793a\u51fa\u53d8\u5f02\u6027\u3002\u5173\u6ce8\u7a33\u5b9a\u7684\u8d77\u5e8a\u65f6\u95f4\u800c\u975e\u5c31\u5bdd\u65f6\u95f4\u2014\u2014\u8fd9\u5bf9\u663c\u591c\u8282\u5f8b\u662f\u66f4\u5f3a\u7684\u951a\u70b9\u3002',
    'toolbox.sleep.library.advice_weekly_sleep_amount.reason': '\u8d77\u5e8a\u65f6\u95f4\u7684\u4e00\u81f4\u6027\u5bf9\u663c\u591c\u8282\u5f8b\u5065\u5eb7\u6bd4\u5c31\u5bdd\u65f6\u95f4\u7684\u4e00\u81f4\u6027\u66f4\u91cd\u8981\u3002',
    'toolbox.sleep.library.tag.sleep_amount': '\u7761\u7720\u91cf',
    'toolbox.sleep.library.empty.no_advice': '\u6682\u65e0\u53ef\u7528\u5efa\u8bae',
    'toolbox.sleep.library.empty.no_advice_hint': '\u7ee7\u7eed\u8bb0\u5f55\u4f60\u7684\u7761\u7720\u4ee5\u83b7\u53d6\u4e2a\u6027\u5316\u5efa\u8bae\u3002',
    ...
    'toolbox.breathing.altitude_simulation_prompt': '\u542f\u7528\u9ad8\u6d77\u62d4\u6a21\u62df\uff1f',
    'toolbox.breathing.altitude_simulation_description': '\u9ad8\u6d77\u62d4\u6a21\u62df\u4f1a\u6539\u53d8\u547c\u5438\u8282\u62cd\u548c\u96be\u5ea6\uff0c\u9002\u5408\u6709\u7ecf\u9a8c\u7684\u7528\u6237\u4f5c\u4e3a\u8fdb\u9636\u6311\u6218\u3002\u5982\u679c\u4f60\u6709\u547c\u5438\u7cfb\u7edf\u75be\u75c5\u3001\u5fc3\u8840\u7ba1\u95ee\u9898\u6216\u5904\u4e8e\u5b55\u671f\uff0c\u8bf7\u5148\u54a8\u8be2\u533b\u751f\u518d\u5c1d\u8bd5\u3002',
    'toolbox.breathing.altitude_extra_warning': '\u9ad8\u6d77\u62d4\u6a21\u62df\u4e0d\u662f\u533b\u7597\u5efa\u8bae\uff0c\u5982\u679c\u4f60\u611f\u5230\u5934\u6655\u3001\u80f8\u95f7\u6216\u5176\u4ed6\u4e0d\u9002\uff0c\u8bf7\u7acb\u5373\u505c\u6b62\u5e76\u56de\u5230\u81ea\u7136\u547c\u5438\u3002',
    'toolbox.breathing.cancel': '\u53d6\u6d88',
    'toolbox.breathing.continue_select': '\u7ee7\u7eed\u9009\u62e9',
    'toolbox.breathing.bolt_test': 'BOLT \u6d4b\u8bd5',
    'toolbox.breathing.bolt_description': '\u8861\u91cf\u8eab\u4f53\u5bf9\u4e8c\u6c27\u5316\u78b3\u7684\u8010\u53d7\u7a0b\u5ea6\uff0c\u5e2e\u52a9\u5224\u65ad\u76ee\u524d\u7684\u547c\u5438\u6548\u7387\u3002\u5f97\u5206\u504f\u4f4e\u901a\u5e38\u63d0\u793a\u547c\u5438\u504f\u6d45\u6216\u5bb9\u6613\u7d27\u5f20\u3002',
    ...
    'toolbox.breathing.breath_hold_on': '\u5f00\u542f\uff1a\u5c4f\u606f\u4f1a\u8ba9\u8282\u62cd\u66f4\u5b8c\u6574\uff0c\u4f46\u4e5f\u66f4\u9700\u8981\u8eab\u4f53\u9002\u5e94\u3002',
    'toolbox.breathing.breath_hold_off': '\u5173\u95ed\uff1a\u9002\u5408\u521d\u6b21\u7ec3\u4e60\u6216\u4e0d\u5e0c\u671b\u989d\u5916\u618b\u6c14\u7684\u7528\u6237\u3002',
    'toolbox.breathing.recovery_stage': '\u4fdd\u7559\u6062\u590d\u6bb5',
    'toolbox.breathing.recovery_on': '\u5f00\u542f\uff1a\u6bcf\u4e2a\u5faa\u73af\u672b\u5c3e\u6709\u4e00\u6bb5\u5b89\u9759\u6062\u590d\u3002',
    'toolbox.breathing.recovery_off': '\u5173\u95ed\uff1a\u53bb\u6389\u6062\u590d\u505c\u987f\uff0c\u8282\u594f\u66f4\u7d27\u51d1\u3002',
    'toolbox.breathing.voice_cues': '\u8bed\u97f3\u63d0\u793a',
    'toolbox.breathing.voice_on': '\u5f00\u542f\uff1a\u5728\u6bcf\u4e2a\u9636\u6bb5\u4f1a\u7528\u8bed\u97f3\u63d0\u9192\u4f60\u5438\u6c14\u3001\u547c\u6c14\u6216\u5c4f\u606f\u3002',
    'toolbox.breathing.voice_off': '\u5173\u95ed\uff1a\u53ea\u4fdd\u7559\u6587\u5b57\u3001\u52a8\u753b\u548c\u9707\u52a8\u53cd\u9988\u3002',
    'toolbox.breathing.text_cues': '\u6587\u5b57\u63d0\u793a',
    'toolbox.breathing.text_on': '\u5f00\u542f\uff1a\u5728\u5149\u7403\u65c1\u663e\u793a\u5f53\u524d\u9636\u6bb5\u7684\u6587\u5b57\u5f15\u5bfc\u3002',
    'toolbox.breathing.text_off': '\u5173\u95ed\uff1a\u4ec5\u4f9d\u9760\u52a8\u753b\u548c\u8bed\u97f3\u3002',
    'toolbox.breathing.haptics': '\u9707\u52a8\u53cd\u9988',
    'toolbox.breathing.haptics_on': '\u5f00\u542f\uff1a\u6bcf\u4e2a\u9636\u6bb5\u5207\u6362\u65f6\u6709\u8f7b\u5fae\u9707\u52a8\u63d0\u793a\u3002',
    'toolbox.breathing.haptics_off': '\u5173\u95ed\uff1a\u4e0d\u989d\u5916\u9707\u52a8\u3002',
    'toolbox.breathing.scenarios_title': '\u547c\u5438\u8bad\u7ec3\u573a\u666f',
    'toolbox.breathing.scenarios_subtitle': '\u4ece\u4e13\u6ce8\u5230\u653e\u677e\uff0c\u4ece\u65e5\u5e38\u7ec3\u4e60\u5230 BOLT \u6d4b\u8bd5\u548c\u9ad8\u6d77\u62d4\u6a21\u62df\u3002\u6bcf\u4e2a\u573a\u666f\u90fd\u6709\u8be6\u7ec6\u7684\u547c\u5438\u8bf4\u660e\u548c\u9636\u6bb5\u62c6\u89e3\u3002',
    ...
    'toolbox.breathing.safety_note_body': '\u547c\u5438\u8bad\u7ec3\u4e0d\u80fd\u66ff\u4ee3\u533b\u7597\u5efa\u8bae\u3002\u5982\u679c\u4f60\u6709\u547c\u5438\u7cfb\u7edf\u6216\u5fc3\u8840\u7ba1\u65b9\u9762\u7684\u95ee\u9898\uff0c\u6216\u6b63\u5728\u5b55\u671f\uff0c\u8bf7\u5728\u5f00\u59cb\u65b0\u8bad\u7ec3\u524d\u5148\u54a8\u8be2\u533b\u751f\u3002\u8bad\u7ec3\u4e2d\u5982\u51fa\u73b0\u5934\u6655\u3001\u80f8\u95f7\u6216\u4efb\u4f55\u4e0d\u8212\u670d\uff0c\u8bf7\u7acb\u5373\u505c\u4e0b\u5e76\u6062\u590d\u81ea\u7136\u547c\u5438\u3002',
    'toolbox.breathing.stop_preview': '\u505c\u6b62\u9884\u542c',
    'toolbox.breathing.preview_guidance': '\u9884\u542c\u5f15\u5bfc',
    'toolbox.breathing.voice_only_chinese_title': '\u5f53\u524d\u8bed\u97f3\u4ec5\u652f\u6301\u4e2d\u6587',
    'toolbox.breathing.voice_only_chinese_body': '\u547c\u5438\u9636\u6bb5\u8bed\u97f3\u76ee\u524d\u53ea\u63d0\u4f9b\u4e2d\u6587\u5f55\u97f3\u3002\u4f60\u4ecd\u53ef\u7ee7\u7eed\u4f7f\u7528\u5f53\u524d\u754c\u9762\u8bed\u8a00\u7684\u6587\u6848\u4e0e\u8ba1\u65f6\uff0c\u4f46\u8bed\u97f3\u4f1a\u64ad\u653e\u4e2d\u6587\u5f15\u5bfc\u3002',
    'toolbox.breathing.turn_voice_off': '\u5173\u95ed\u8bed\u97f3',
    'toolbox.breathing.keep_chinese_voice': '\u7ee7\u7eed\u4f7f\u7528\u4e2d\u6587\u8bed\u97f3',
    'toolbox.breathing.voice_off_status': '\u8bed\u97f3\u5df2\u5173\u95ed',
    'toolbox.breathing.voice_checking_status': '\u6b63\u5728\u68c0\u67e5\u8bed\u97f3\u8d44\u6e90',
    'toolbox.breathing.voice_remote_status': '\u5728\u7ebf\u8bed\u97f3\u5df2\u5c31\u7eea',
    'toolbox.breathing.voice_bundled_status': '\u5185\u7f6e\u8bed\u97f3\u5df2\u5c31\u7eea',
    'toolbox.breathing.voice_unavailable_status': '\u5f53\u524d\u65e0\u53ef\u7528\u7684\u9636\u6bb5\u8bed\u97f3',
    'toolbox.breathing.voice_availability_short': '\u8bed\u97f3\u53ef\u7528\u3002',
    'toolbox.breathing.short_stage_mute_hint': '\u505c\u987f\u9636\u6bb5\u4fdd\u6301\u9759\u97f3',
    'toolbox.breathing.pause_stays_silent': '\u505c\u987f\u9636\u6bb5\u4fdd\u6301\u9759\u97f3',
    ...
    'toolbox.breathing.not_tested_body': '\u4f60\u8fd8\u6ca1\u6709\u5b8c\u6210 BOLT \u6d4b\u8bd5\u3002BOLT\uff08\u4f53\u5185\u6c27\u6c14\u6c34\u5e73\u6d4b\u8bd5\uff09\u8861\u91cf\u4f60\u5bf9\u4e8c\u6c27\u5316\u78b3\u7684\u8010\u53d7\u7a0b\u5ea6\uff1a\u5206\u6570\u8d8a\u9ad8\uff0c\u901a\u5e38\u547c\u5438\u6548\u7387\u8d8a\u597d\u3002',
    'toolbox.breathing.not_tested_next': '\u5efa\u8bae\uff1a\u5b8c\u6210\u4e00\u6b21 BOLT \u6d4b\u8bd5\u4ee5\u83b7\u5f97\u57fa\u51c6\u5206\u6570\u3002',
    'toolbox.breathing.low_bolt': 'BOLT \u504f\u4f4e',
    'toolbox.breathing.low_bolt_body': '\u4f60\u7684 BOLT \u504f\u4f4e\uff08\u4f4e\u4e8e 20 \u79d2\uff09\uff0c\u8bf4\u660e\u8eab\u4f53\u5bf9\u4e8c\u6c27\u5316\u78b3\u7684\u8010\u53d7\u5ea6\u8fd8\u6709\u63d0\u5347\u7a7a\u95f4\u3002\u5e38\u89c1\u539f\u56e0\u662f\u547c\u5438\u504f\u6d45\u6216\u504f\u5feb\u3002',
    'toolbox.breathing.low_bolt_next': '\u5148\u53bb\u8bad\u7ec3\u6a21\u5f0f\u505a\u8179\u5f0f\u57fa\u7840\u7ec3\u4e60\uff0c\u7b49 BOLT \u5347\u5230 20 \u4ee5\u4e0a\u518d\u5c1d\u8bd5\u5c4f\u606f\u7c7b\u8282\u594f\u3002',
    'toolbox.breathing.building_bolt': 'BOLT \u5efa\u8bbe\u671f',
    'toolbox.breathing.building_bolt_body': '\u4f60\u7684 BOLT \u5728 20-29 \u79d2\uff0c\u5904\u4e8e\u5efa\u8bbe\u671f\u3002\u547c\u5438\u6548\u7387\u8fd8\u6709\u8fdb\u6b65\u7a7a\u95f4\u3002',
    'toolbox.breathing.building_bolt_next': '\u7ee7\u7eed\u7ec3\u4e60\u8179\u5f0f\u547c\u5438\u548c\u65e0\u5c4f\u606f\u7684\u6162\u547c\u5438\u6a21\u5f0f\uff0c\u9010\u6b65\u63d0\u9ad8\u4e8c\u6c27\u5316\u78b3\u8010\u53d7\u3002',
    'toolbox.breathing.stable_bolt': 'BOLT \u7a33\u5b9a\u533a',
    'toolbox.breathing.stable_bolt_body': '\u4f60\u7684 BOLT \u5728 30-39 \u79d2\uff0c\u5c5e\u4e8e\u7a33\u5b9a\u533a\u95f4\uff0c\u9002\u5408\u5c1d\u8bd5\u5e26\u5c4f\u606f\u7684\u547c\u5438\u6a21\u5f0f\u3002',
    'toolbox.breathing.stable_bolt_next': '\u53ef\u4ee5\u5b89\u5168\u5c1d\u8bd5\u65b9\u5757\u547c\u5438\u30014-7-8 \u7b49\u5e26\u5c4f\u606f\u7684\u6a21\u5f0f\u3002',
    'toolbox.breathing.advanced_bolt': 'BOLT \u8fdb\u9636\u533a',
    'toolbox.breathing.advanced_bolt_body': '\u4f60\u7684 BOLT \u8d85\u8fc7 40 \u79d2\uff0c\u547c\u5438\u6548\u7387\u5f88\u597d\uff0c\u53ef\u4ee5\u6311\u6218\u9ad8\u6d77\u62d4\u6a21\u62df\u548c\u8fdb\u9636\u5c4f\u606f\u8bad\u7ec3\u3002',
    'toolbox.breathing.advanced_bolt_next': '\u53ef\u4ee5\u5c1d\u8bd5\u9ad8\u6d77\u62d4\u6a21\u62df\u548c\u66f4\u957f\u7684\u5c4f\u606f\u8bad\u7ec3\u3002\u7ee7\u7eed\u4fdd\u6301\u5b9a\u671f\u7ec3\u4e60\u3002',
    'toolbox.breathing.next_step_prefix': '\u4e0b\u4e00\u6b65\uff1a',

    // --- Daily decision / Daily choice (daily_choice_*.dart) ---
    'toolbox.daily_choice.page_title': '\u6bcf\u65e5\u6289\u62e9',
    'toolbox.daily_choice.page_subtitle': '\u4ece\u5403\u4ec0\u4e48\u3001\u7a7f\u4ec0\u4e48\u3001\u53bb\u54ea\u513f\u5230\u884c\u52a8\u9009\u62e9\u548c\u8f7b\u91cf\u51b3\u7b56\u8ba1\u7b97\uff0c\u628a\u65e5\u5e38\u5c0f\u7ea0\u7ed3\u53d8\u6210\u53ef\u968f\u673a\u3001\u53ef\u7f16\u8f91\u3001\u53ef\u56de\u770b\u7684\u8f7b\u91cf\u9009\u62e9\u3002',
    ...
    'toolbox.daily_choice.context_influences': '\u60c5\u5883\u4f1a\u5f71\u54cd\u4f60\u66f4\u8be5\u5148\u770b\u968f\u673a\u3001\u52a0\u6743\u3001\u60c5\u666f\u5206\u6790\u8fd8\u662f\u5b89\u5168\u7ebf\u4f18\u5148\u3002',
    'toolbox.daily_choice.high_stakes_guardrail': '\u9ad8\u98ce\u9669\u573a\u666f\u5148\u770b\u5b89\u5168\u95e8\u69db\uff0c\u518d\u8c08\u6536\u76ca\u3002\u5b8c\u6574\u6e05\u5355\u5df2\u4e0b\u6c89\u5230\u5f39\u7a97\u3002',
    'toolbox.daily_choice.pre_commit_scan': '\u6700\u7ec8\u62cd\u677f\u524d\uff0c\u5feb\u901f\u626b\u4e00\u904d\u504f\u5dee\u3001\u566a\u58f0\u548c\u590d\u76d8\u6761\u4ef6\u3002',
    ...
    'toolbox.daily_choice.check_guardrails_first': '\u5148\u68c0\u67e5\u5b89\u5168\u95e8\u69db\uff0c\u518d\u8c08\u6536\u76ca\u3002',
    'toolbox.daily_choice.guardrail_best_for': '\u9002\u7528\uff1a\u9ad8\u98ce\u9669\u3001\u96be\u56de\u5934\u3001\u65f6\u95f4\u7d27\u6216\u9700\u8981\u5148\u5b88\u4f4f\u57fa\u672c\u76d8\u3002',
    'toolbox.daily_choice.six_modules': '\u516d\u6a21\u5757\u57fa\u7840\u7248',
    'toolbox.daily_choice.local_custom': '\u672c\u5730\u81ea\u5b9a\u4e49',
    'toolbox.daily_choice.let_choice_move': '\u5148\u8ba9\u9009\u62e9\u52a8\u8d77\u6765',
    'toolbox.daily_choice.uniform_random': '\u5747\u5300\u968f\u673a',
    'toolbox.daily_choice.uniform_random_subtitle': '\u9002\u5408\u4f4e\u98ce\u9669\u3001\u53ef\u56de\u9000\u3001\u5dee\u522b\u4e0d\u5927\u7684\u65e5\u5e38\u9009\u62e9\u3002',
    'toolbox.daily_choice.uniform_random_formula': '\u6bcf\u4e2a\u9009\u9879\u6982\u7387\u76f8\u540c\uff0c\u76ee\u7684\u662f\u5c3d\u5feb\u7ed3\u675f\u72b9\u8c6b\u3002',
    'toolbox.daily_choice.uniform_random_caution': '\u4e0d\u8981\u628a\u968f\u673a\u5f53\u6210\u9ad8\u98ce\u9669\u51b3\u7b56\u7684\u4f9d\u636e\u3002',
    'toolbox.daily_choice.weighted_factors': '\u52a0\u6743\u56e0\u7d20',
    'toolbox.daily_choice.weighted_factors_subtitle': '\u628a\u4ef7\u503c\u3001\u6210\u529f\u7387\u3001\u53ef\u56de\u9000\u6027\u3001\u98ce\u9669\u548c\u4fe1\u606f\u5dee\u653e\u5230\u540c\u4e00\u628a\u5c3a\u5b50\u4e0a\u6bd4\u8f83\u3002',
    'toolbox.daily_choice.weighted_factors_formula': '\u6b63\u5411\u9879\u52a0\u6743 - \u98ce\u9669/\u6295\u5165/\u540e\u6094/\u4fe1\u606f\u5dee\u60e9\u7f5a\u3002',
    'toolbox.daily_choice.weighted_factors_caution': '\u5b83\u9002\u5408\u6392\u5e8f\uff0c\u4e0d\u4ee3\u8868\u7edd\u5bf9\u6b63\u786e\u3002',
    'toolbox.daily_choice.expected_value': '\u671f\u671b\u6536\u76ca',
    'toolbox.daily_choice.expected_value_subtitle': '\u9002\u5408\u7ed3\u679c\u4e0d\u786e\u5b9a\u3001\u4f46\u53ef\u4ee5\u4f30\u4e00\u4e2a\u5927\u81f4\u6210\u529f\u7387\u7684\u9009\u62e9\u3002',
    'toolbox.daily_choice.expected_value_formula': '\u6210\u529f\u6982\u7387 \u00d7 \u6536\u76ca - \u5931\u8d25\u66b4\u9732 - \u6295\u5165\u6210\u672c\u3002',
    'toolbox.daily_choice.expected_value_caution': '\u8f93\u5165\u6982\u7387\u6765\u81ea\u4f60\u7684\u5224\u65ad\uff0c\u5148\u505a\u72ec\u7acb\u4f30\u503c\u518d\u8ba8\u8bba\u3002',
    'toolbox.daily_choice.joint_probability': '\u8054\u5408\u6982\u7387',
    'toolbox.daily_choice.joint_probability_subtitle': '\u5f53\u7ed3\u679c\u9700\u8981\u201c\u5224\u65ad\u5bf9 + \u6267\u884c\u5230\u4f4d + \u6761\u4ef6\u771f\u7684\u6210\u7acb\u201d\u65f6\uff0c\u7528\u66f4\u4fdd\u5b88\u7684\u4e58\u6cd5\u3002',
    'toolbox.daily_choice.joint_probability_formula': '\u6210\u529f\u6982\u7387 \u00d7 \u6267\u884c\u6982\u7387 \u00d7 \u628a\u63e1\u5ea6\uff0c\u518d\u6263\u6389\u4e0b\u884c\u66b4\u9732\u3002',
    'toolbox.daily_choice.joint_probability_caution': '\u9002\u5408\u591a\u6761\u4ef6\u8054\u52a8\uff0c\u4e0d\u9002\u5408\u628a\u5f7c\u6b64\u5f3a\u76f8\u5173\u7684\u4e8b\u4ef6\u786c\u62c6\u5f00\u3002',
    'toolbox.daily_choice.scenario_blend': '\u60c5\u666f\u5206\u6790',
    'toolbox.daily_choice.scenario_blend_subtitle': '\u628a\u4e50\u89c2\u3001\u57fa\u51c6\u3001\u60b2\u89c2\u4e09\u79cd\u60c5\u666f\u540c\u65f6\u6446\u51fa\u6765\uff0c\u907f\u514d\u53ea\u76ef\u7740\u6700\u597d\u7ed3\u679c\u3002',
    'toolbox.daily_choice.scenario_blend_formula': '\u4e50\u89c2 + \u57fa\u51c6 + \u60b2\u89c2\u6309\u4e0d\u786e\u5b9a\u6027\u52a0\u6743\u6c47\u603b\u3002',
    'toolbox.daily_choice.scenario_blend_caution': '\u9ad8\u4e0d\u786e\u5b9a\u65f6\u8981\u8ba9\u60b2\u89c2\u60c5\u666f\u771f\u6b63\u8fdb\u573a\u3002',
    'toolbox.daily_choice.regret_balance': '\u540e\u6094\u4e0e\u673a\u4f1a\u6210\u672c',
    'toolbox.daily_choice.regret_balance_subtitle': '\u9002\u5408\u5bb9\u6613\u4e8b\u540e\u53cd\u590d\u60f3\u201c\u65e9\u77e5\u9053\u5c31\u9009\u53e6\u4e00\u4e2a\u201d\u7684\u9009\u62e9\u3002',
    'toolbox.daily_choice.regret_balance_formula': '\u5df2\u5b9e\u73b0\u6f5c\u529b + \u53ef\u56de\u9000\u8865\u507f - \u540e\u6094\u66b4\u9732 - \u673a\u4f1a\u6210\u672c\u3002',
    'toolbox.daily_choice.regret_balance_caution': '\u5b83\u662f\u5728\u6821\u6b63\u60c5\u7eea\uff0c\u4e0d\u662f\u5728\u9884\u6d4b\u547d\u8fd0\u3002',
    'toolbox.daily_choice.threshold_guardrail': '\u5b89\u5168\u7ebf\u4f18\u5148',
    'toolbox.daily_choice.threshold_guardrail_subtitle': '\u5148\u770b\u662f\u5426\u8fc7\u6700\u4f4e\u95e8\u69db\uff0c\u518d\u5728\u8fc7\u5173\u9009\u9879\u91cc\u6bd4\u8f83\u4f18\u5148\u7ea7\u3002',
    'toolbox.daily_choice.threshold_guardrail_formula': '\u5148\u5224\u5b9a\u4fe1\u5fc3\u3001\u98ce\u9669\u3001\u53ef\u56de\u9000\u6027\u3001\u4fe1\u606f\u5dee\u662f\u5426\u8fc7\u7ebf\uff0c\u518d\u7528\u7efc\u5408\u5206\u505a\u540c\u6863\u6bd4\u8f83\u3002',
    'toolbox.daily_choice.threshold_guardrail_caution': '\u9ad8\u98ce\u9669\u573a\u666f\u5148\u770b\u5b89\u5168\u7ebf\uff0c\u518d\u8c08\u6536\u76ca\u3002',
    'toolbox.daily_choice.calibrated_forecast': '\u6821\u51c6\u9884\u6d4b',
    'toolbox.daily_choice.calibrated_forecast_subtitle': '\u628a\u8fc7\u4e8e\u6781\u7aef\u7684\u671f\u671b\u503c\u5f80\u5747\u503c\u62c9\u56de\uff0c\u51cf\u5c11\u8fc7\u5ea6\u81ea\u4fe1\u3002',
    'toolbox.daily_choice.calibrated_forecast_formula': '\u5e73\u5747\u503c + \u628a\u63e1\u5ea6 \u00d7 (\u539f\u59cb\u9884\u671f - \u5e73\u5747\u503c)\u3002',
    'toolbox.daily_choice.calibrated_forecast_caution': '\u5b83\u4e0d\u662f\u673a\u5668\u5b66\u4e60\uff0c\u53ea\u662f\u628a\u6781\u7aef\u5224\u65ad\u6536\u4e00\u70b9\u3002',
    'toolbox.daily_choice.classify_first': '\u5148\u5206\u578b\u518d\u9009\u6cd5',
    'toolbox.daily_choice.classify_first_subtitle': '\u771f\u6b63\u9ad8\u8d28\u91cf\u7684\u51b3\u7b56\uff0c\u5148\u5224\u65ad\u662f\u4ec0\u4e48\u7c7b\u578b\uff0c\u518d\u51b3\u5b9a\u7528\u54ea\u79cd\u8ba1\u7b97\u955c\u5934\u3002',
    'toolbox.daily_choice.low_stakes_fast': '\u4f4e\u98ce\u9669\u4e14\u53ef\u56de\u9000\uff1a\u76f4\u63a5\u5feb\u51b3',
    'toolbox.daily_choice.low_stakes_fast_body': '\u9910\u5385\u3001\u5468\u672b\u5b89\u6392\u3001\u8f7b\u91cf\u8d2d\u4e70\u8fd9\u7c7b\u95ee\u9898\uff0c\u91cd\u70b9\u4e0d\u662f\u201c\u6700\u4f18\u201d\uff0c\u800c\u662f\u522b\u628a\u7cbe\u529b\u8017\u5728\u72b9\u8c6b\u4e0a\u3002\u968f\u673a\u6216\u52a0\u6743\u56e0\u7d20\u901a\u5e38\u5c31\u591f\u3002',
    'toolbox.daily_choice.high_stakes_guardrail_title': '\u9ad8\u98ce\u9669\u6216\u96be\u56de\u5934\uff1a\u5148\u8bbe\u5b89\u5168\u95e8\u69db',
    'toolbox.daily_choice.high_stakes_guardrail_body': '\u5982\u679c\u4e00\u65e6\u505a\u9519\u5f88\u96be\u8865\u6551\uff0c\u5148\u770b\u98ce\u9669\u3001\u628a\u63e1\u5ea6\u3001\u4fe1\u606f\u5dee\u548c\u53ef\u56de\u9000\u6027\u662f\u5426\u8fc7\u7ebf\uff0c\u518d\u6bd4\u8f83\u6536\u76ca\u3002',
    'toolbox.daily_choice.high_uncertainty_pessimistic': '\u9ad8\u4e0d\u786e\u5b9a\uff1a\u4e00\u5b9a\u8981\u628a\u60b2\u89c2\u60c5\u666f\u62c9\u8fdb\u6765',
    'toolbox.daily_choice.high_uncertainty_pessimistic_body': '\u5f53\u4f60\u77e5\u9053\u81ea\u5df1\u4e0d\u77e5\u9053\u5f88\u591a\u65f6\uff0c\u5355\u4e00\u5206\u6570\u4e0d\u591f\uff0c\u8981\u540c\u65f6\u770b\u8054\u5408\u6982\u7387\u3001\u60c5\u666f\u5206\u6790\u548c\u4fe1\u606f\u4ef7\u503c\u3002',
    'toolbox.daily_choice.six_elements_quality': '\u4f18\u8d28\u51b3\u7b56\u516d\u8981\u7d20',
    'toolbox.daily_choice.six_elements_quality_subtitle': '\u6765\u81ea\u65af\u5766\u798f\u51b3\u7b56\u8d28\u91cf\u6846\u67b6\uff0c\u662f\u8fd9\u4e2a\u5b50\u6a21\u5757\u6700\u91cd\u8981\u7684\u9aa8\u67b6\u3002',
    'toolbox.daily_choice.frame_question_right': '\u5148\u628a\u95ee\u9898\u6846\u51c6',
    'toolbox.daily_choice.frame_question_right_body': '\u5148\u660e\u786e\u4f60\u5728\u51b3\u5b9a\u4ec0\u4e48\u3001\u65f6\u95f4\u8303\u56f4\u662f\u4ec0\u4e48\u3001\u54ea\u4e9b\u7ea6\u675f\u4e0d\u80fd\u7834\u3002\u95ee\u9898\u6846\u9519\u4e86\uff0c\u518d\u7cbe\u7ec6\u8ba1\u7b97\u4e5f\u4f1a\u504f\u3002',
    'toolbox.daily_choice.generate_options': '\u81f3\u5c11\u9020\u51fa 2 \u5230 3 \u4e2a\u53ef\u9009\u9879',
    'toolbox.daily_choice.generate_options_body': '\u5f88\u591a\u7cdf\u7cd5\u51b3\u7b56\u4e0d\u662f\u5728\u574f\u9009\u9879\u91cc\u9009\uff0c\u800c\u662f\u6839\u672c\u6ca1\u6709\u8ba4\u771f\u751f\u6210\u5907\u9009\u3002\u5148\u6269\u5c55\uff0c\u518d\u6536\u53e3\u3002',
    'toolbox.daily_choice.reliable_info': '\u4fe1\u606f\u8981\u76f8\u5173\u4e14\u53ef\u9760',
    'toolbox.daily_choice.values_tradeoffs': '\u628a\u4ef7\u503c\u548c\u6743\u8861\u5199\u51fa\u6765',
    'toolbox.daily_choice.transparent_reasoning': '\u8bba\u8bc1\u8981\u900f\u660e\uff0c\u53ef\u590d\u76d8',
    'toolbox.daily_choice.decision_to_action': '\u51b3\u5b9a\u540e\u5fc5\u987b\u843d\u5230\u52a8\u4f5c',
    'toolbox.daily_choice.probability_uncertainty': '\u6982\u7387\u4e0e\u4e0d\u786e\u5b9a\u6027',
    'toolbox.daily_choice.probability_uncertainty_subtitle': '\u628a\u201c\u786e\u5b9a/\u4e0d\u786e\u5b9a\u201d\u7684\u60c5\u7eea\u8bed\u8a00\uff0c\u8f6c\u6210\u66f4\u53ef\u6bd4\u8f83\u7684\u6982\u7387\u8bed\u8a00\u3002',
    'toolbox.daily_choice.assign_probabilities': '\u5148\u7ed9\u6982\u7387\uff0c\u518d\u8c08\u7ed3\u8bba',
    'toolbox.daily_choice.use_multiplication': '\u591a\u6761\u4ef6\u540c\u65f6\u6210\u7acb\u65f6\uff0c\u7528\u4e58\u6cd5\u66f4\u4fdd\u5b88',
    'toolbox.daily_choice.pull_extremes_back': '\u9ad8\u4e0d\u786e\u5b9a\u65f6\uff0c\u628a\u6781\u7aef\u5224\u65ad\u5f80\u5747\u503c\u62c9\u56de',
    'toolbox.daily_choice.update_evidence': '\u65b0\u8bc1\u636e\u6765\u4e86\uff0c\u5c31\u66f4\u65b0\uff0c\u4e0d\u8981\u786c\u625b',
    'toolbox.daily_choice.bias_noise_control': '\u504f\u5dee\u4e0e\u566a\u58f0\u6821\u6b63',
    'toolbox.daily_choice.bias_noise_control_subtitle': '\u907f\u514d\u88ab\u951a\u70b9\u3001\u6c89\u6ca1\u6210\u672c\u3001\u6545\u4e8b\u611f\u548c\u7fa4\u4f53\u566a\u58f0\u5e26\u8dd1\u3002',
    'toolbox.daily_choice.independent_estimate': '\u5148\u72ec\u7acb\u4f30\uff0c\u518d\u4ea4\u6d41\uff0c\u9632\u951a\u5b9a',
    'toolbox.daily_choice.sunk_cost': '\u6c89\u6ca1\u6210\u672c\u4e0d\u662f\u7ee7\u7eed\u6295\u5165\u7684\u7406\u7531',
    'toolbox.daily_choice.common_scale': '\u7528\u7edf\u4e00\u5c3a\u5ea6\u9010\u9879\u6bd4\u8f83\uff0c\u964d\u4f4e\u566a\u58f0',
    'toolbox.daily_choice.good_story': '\u6545\u4e8b\u597d\u542c\uff0c\u4e0d\u7b49\u4e8e\u8bc1\u636e\u591f\u5f3a',
    'toolbox.daily_choice.when_to_research': '\u4f55\u65f6\u7ee7\u7eed\u67e5\uff0c\u4f55\u65f6\u76f4\u63a5\u505a',
    'toolbox.daily_choice.when_to_research_subtitle': '\u4fe1\u606f\u4ef7\u503c\u4e0d\u662f\u65e0\u9650\u7684\uff0c\u5206\u6790\u4e5f\u9700\u8981\u505c\u8868\u70b9\u3002',
    'toolbox.daily_choice.most_likely_flip': '\u5982\u679c\u4e00\u6761\u4fe1\u606f\u6700\u53ef\u80fd\u6539\u7ed3\u8bba\uff0c\u5c31\u5148\u53bb\u8865\u5b83',
    'toolbox.daily_choice.stop_rule': '\u8bbe\u505c\u6b62\u89c4\u5219\uff0c\u9632\u6b62\u65e0\u9650\u5206\u6790',
    'toolbox.daily_choice.premortem': '\u9ad8\u98ce\u9669\u5148\u505a\u4e00\u6b21\u9884\u6f14\u5f0f\u5931\u8d25\u590d\u76d8',
    'toolbox.daily_choice.professional_judgment': '\u533b\u7597\u3001\u6cd5\u5f8b\u3001\u91d1\u878d\u4ecd\u9700\u4e13\u4e1a\u5224\u65ad',
    'toolbox.daily_choice.score_independently': '\u5148\u72ec\u7acb\u6253\u5206\uff0c\u518d\u770b\u522b\u4eba\u610f\u89c1',
    'toolbox.daily_choice.no_double_down': '\u4e0d\u8981\u4e3a\u6c89\u6ca1\u6210\u672c\u8ffd\u52a0\u6295\u5165',
    'toolbox.daily_choice.same_fields': '\u7528\u540c\u4e00\u5957\u5b57\u6bb5\u6bd4\u8f83\u6240\u6709\u9009\u9879',
    'toolbox.daily_choice.base_rates_high_uncertainty': '\u9ad8\u4e0d\u786e\u5b9a\u65f6\uff0c\u4f18\u5148\u770b\u57fa\u51c6\u7387\u548c\u5747\u503c\u56de\u5f52',
    'toolbox.daily_choice.research_flip_fact': '\u5148\u8865\u6700\u53ef\u80fd\u6539\u53d8\u7ed3\u8bba\u7684\u90a3\u6761\u4fe1\u606f',
    'toolbox.daily_choice.premortem_high_stakes': '\u9ad8\u98ce\u9669\u51b3\u7b56\u5148\u505a\u4e00\u6b21\u9884\u6f14\u5f0f\u590d\u76d8',
    'toolbox.daily_choice.value_ranking_disagree': '\u8de8\u65b9\u6cd5\u5206\u6b67\u5927\u65f6\uff0c\u56de\u5230\u4ef7\u503c\u6392\u5e8f',
    'toolbox.daily_choice.stop_rule_now': '\u73b0\u5728\u5c31\u8981\u5b9a\u65f6\uff0c\u5148\u5199\u4e0b\u505c\u6b62\u89c4\u5219',
    ...
    'toolbox.daily_choice.hub_subtitle': '\u628a\u65e5\u5e38\u5c0f\u7ea0\u7ed3\u53d8\u6210\u53ef\u968f\u673a\u3001\u53ef\u7f16\u8f91\u3001\u53ef\u56de\u770b\u7684\u8f7b\u91cf\u9009\u62e9\u3002',
    ...
    'toolbox.daily_choice.weather_not_ready': '\u5f53\u524d\u5148\u67e5\u770b\u5168\u90e8\u6c14\u6e29\uff1b\u82e5\u5929\u6c14\u63d0\u9192\u5df2\u8bfb\u53d6\u5929\u6c14\uff0c\u8fd9\u91cc\u4f1a\u81ea\u52a8\u7528\u4e8e\u7a7f\u642d\u5efa\u8bae\u3002',
  };
  ...
  String t(
    ...
    final table = switch (lang) {
      'zh' => {..._zh, ..._focusZh, ..._extraZh, ..._focusEnhancedZh, ..._toolboxEn, ..._toolboxZh},
      'ja' => {..._ja, ..._focusJa, ..._extraJa, ..._focusEnhancedJa, ..._toolboxEn},
      'de' => {..._de, ..._focusDe, ..._extraDe, ..._focusEnhancedDe, ..._toolboxEn},
      'fr' => {..._fr, ..._focusFr, ..._extraFr, ..._focusEnhancedFr, ..._toolboxEn},
      'es' => {..._es, ..._focusEs, ..._extraEs, ..._focusEnhancedEs, ..._toolboxEn},
      'ru' => {
        ..._en,
        ..._focusEn,
        ..._extraEn,
      ...
      _ => {..._en, ..._focusEn, ..._extraEn, ..._focusEnhancedEn, ..._toolboxEn},
    };
    var value =
        table[key] ??
        _extraEn[key] ??
