class AppI18n {
  ...
  static const Map<String, String> _zhExtra = <String, String>{
    ...
    'appearanceBackgroundHint': '调整页面背景和纹理效果',
    'appearanceBackgroundTitle': '背景',
    'appearanceColorsHint': '调整主色与强调色',
  ...
  static const Map<String, String> _fr = <String, String>{
    'appTitle': 'Lecteur de vocabulaire',
  ...
  static const Map<String, String> _es = <String, String>{
    'appTitle': 'Reproductor de vocabulario',
    ...
    'themeOcean': 'Océano',
    'themeMono': 'Mononucleosis infecciosa',
