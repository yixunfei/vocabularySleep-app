...
AppExperienceMode experienceModeFromAppearance(AppearanceConfig appearance) {
  return switch (appearance.normalizedTheme) {
    'dark' || 'ocean' => AppExperienceMode.sleep,
  ...
  factory AppThemeTokens.fromAppearance(AppearanceConfig appearance) {
    ...
    return switch (appearance.normalizedTheme) {
      'ocean' => AppThemeTokens(
        ...
        isDark: true,
        canvas: const Color(0xFF04111B),
        surface: const Color(0xFF0A2233),
        surfaceMuted: const Color(0xFF102C42),
        surfaceStrong: const Color(0xFF153A55),
        surfaceOverlay: const Color(0xFF091C2C).withValues(alpha: 0.9),
        outline: const Color(0xFF285775),
        outlineStrong: const Color(0xFF7AD7E8),
        textPrimary: const Color(0xFFF3FCFF),
        textSecondary: const Color(0xFFA8D4DE),
        accent: accent,
        accentSoft: Color.lerp(accent, Colors.white, 0.62)!,
        success: const Color(0xFF63D7C5),
        warning: const Color(0xFFF5C46B),
        danger: const Color(0xFFFF8F9D),
        glow: accent.withValues(alpha: 0.38),
      ),
      'mono' => AppThemeTokens(
        mode: AppExperienceMode.focus,
        isDark: false,
        canvas: const Color(0xFFF7F7F4),
        surface: const Color(0xFFFFFFFF),
        surfaceMuted: const Color(0xFFF1F1EE),
        surfaceStrong: const Color(0xFFE8E7E3),
        surfaceOverlay: const Color(0xFFFDFDFC).withValues(alpha: 0.96),
        outline: const Color(0xFFD7D6D1),
        outlineStrong: const Color(0xFF5E5E61),
        textPrimary: const Color(0xFF171717),
        textSecondary: const Color(0xFF5F5F63),
        accent: accent,
        accentSoft: Color.lerp(accent, Colors.white, 0.9)!,
        success: const Color(0xFF3F6F55),
        warning: const Color(0xFF9A7332),
        danger: const Color(0xFF8B4A4A),
        glow: accent.withValues(alpha: 0.06),
      ),
      _ => switch (mode) {
