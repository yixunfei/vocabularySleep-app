  ...
  Widget build(BuildContext context) {
    return Consumer<AppState>(
      builder: (context, state, _) {
        ...
        for (final item in OnlineAmbientCatalogService.options) {
          grouped
              .putIfAbsent(item.categoryKey, () => <OnlineAmbientSoundOption>[])
              .add(item);
        }
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          pickUiText(
                            i18n,
                            zh: '基于 Moodist 开源声音资源，可直接在线播放或下载到本地。',
                            en: 'Curated from Moodist open-source sounds. Stream directly or download locally.',
                          ),
