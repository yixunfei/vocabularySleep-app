...
part 'follow_along_page_scoring.dart';

class FollowAlongPage extends ConsumerStatefulWidget {
  const FollowAlongPage({super.key, required this.word});

  final WordEntry word;

  @override
  ConsumerState<FollowAlongPage> createState() => _FollowAlongPageState();
}

class _FollowAlongPageState extends ConsumerState<FollowAlongPage> {
  ...
  void initState() {
    super.initState();
    _state = ref.read(appStateProvider);
