...
class _DynamicVisionCardState extends State<_DynamicVisionCard>
    ...
    try {
      final result = await showDialog<bool>(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text(
              pickUiText(i18n, zh: '确认修改设置？', en: 'Change settings?'),
            ),
            ...
            actions: <Widget>[
              ...
              FilledButton(
                ...
                child: Text(
                  pickUiText(i18n, zh: '确认并重置', en: 'Confirm and reset'),
                ),
              ),
            ],
          );
  ...
  String symbolSetLabel(AppI18n i18n, _DynamicSymbolSet set) {
    return switch (set) {
      _DynamicSymbolSet.mixed => pickUiText(i18n, zh: '混合', en: 'Mixed'),
      _DynamicSymbolSet.digits => pickUiText(i18n, zh: '数字', en: 'Digits'),
      _DynamicSymbolSet.letters => pickUiText(i18n, zh: '字母', en: 'Letters'),
      _DynamicSymbolSet.confusable => pickUiText(
        i18n,
        zh: '易混淆',
        en: 'Confusable',
      ),
      _DynamicSymbolSet.custom => pickUiText(i18n, zh: '自定义', en: 'Custom'),
    };
  }

  String symbolPathLabel(AppI18n i18n, _DynamicSymbolPath path) {
    return switch (path) {
      _DynamicSymbolPath.wave => pickUiText(i18n, zh: '波浪', en: 'Wave'),
      _DynamicSymbolPath.horizontal => pickUiText(
        i18n,
        zh: '水平',
        en: 'Horizontal',
      ),
      _DynamicSymbolPath.diagonal => pickUiText(i18n, zh: '斜线', en: 'Diagonal'),
      _DynamicSymbolPath.bounce => pickUiText(i18n, zh: '弹跳', en: 'Bounce'),
    };
  }
